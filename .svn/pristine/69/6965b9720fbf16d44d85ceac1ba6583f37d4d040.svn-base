    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FAMD0330");
                this.set_titletext("손익계산서 조회");
                this.set_scrollbars("none");
                this._setFormPosition(0,0,1041,834);
            }
            ...
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"GRPKEY\" size=\"10\" prop=\"default\" type=\"STRING\"/><Column id=\"ACCT_BFNM\" size=\"64\" prop=\"default\" type=\"STRING\"/><Column id=\"ACCT_INTL\" size=\"10\" prop=\"default\" type=\"STRING\"/><Column id=\"PRNT_LEVL\" size=\"5\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"BASE_AMNT\" size=\"22\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"BASE_BALA\" size=\"22\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"PREV_AMNT\" size=\"22\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"PREV_BALA\" size=\"22\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"CURR_BASE_AMNT\" size=\"22\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"CURR_BASE_BALA\" size=\"22\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"CURR_PREV_AMNT\" size=\"22\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"CURR_PREV_BALA\" size=\"22\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"BASE_SUMX\" size=\"22\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"PREV_SUMX\" size=\"22\" prop=\"default\" type=\"BIGDECIMAL\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_text("재무관리>결산관리>재무제표관리>손익계산서 조회");
            obj.style.set_align("right middle");
            obj.set_cssclass("styFormLocation");
            this.addChild(obj.name, obj);

            obj = new Static("stInformation", "absolute", "9", "123", "400", "20", null, null, this);
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"200\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"23\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"20\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" displaytype=\"text\" text=\"계정과목\" taborder=\"undefined\"/><Cell col=\"1\" colspan=\"4\" displaytype=\"text\" text=\"당기\" taborder=\"undefined\"/><Cell col=\"5\" colspan=\"4\" displaytype=\"text\" text=\"전기\" taborder=\"undefined\"/><Cell row=\"1\" col=\"1\" colspan=\"2\" text=\"당월\" taborder=\"undefined\"/><Cell row=\"1\" col=\"3\" colspan=\"2\" text=\"누계\" taborder=\"undefined\"/><Cell row=\"1\" col=\"5\" colspan=\"2\" text=\"당월\" taborder=\"undefined\"/><Cell row=\"1\" col=\"7\" colspan=\"2\" text=\"누계\" taborder=\"undefined\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" style=\"background: EXPR(gfn_Decode(PRNT_LEVL, 6 ,'#d7f1eeff','default'));align: left;\" text=\"bind:ACCT_BFNM\"/><Cell col=\"1\" displaytype=\"number\" style=\"background: EXPR(gfn_Decode(PRNT_LEVL, 6 ,'#d7f1eeff','default'));align: right;\" text=\"bind:CURR_BASE_AMNT\" mask=\"#,###\"/><Cell col=\"2\" displaytype=\"number\" style=\"background: EXPR(gfn_Decode(PRNT_LEVL, 6 ,'#d7f1eeff','default'));align: right;\" text=\"bind:CURR_BASE_BALA\" mask=\"#,###\"/><Cell col=\"3\" displaytype=\"number\" style=\"background: EXPR(gfn_Decode(PRNT_LEVL, 6 ,'#d7f1eeff','default'));align: right;\" text=\"bind:BASE_AMNT\" mask=\"#,###\"/><Cell col=\"4\" displaytype=\"number\" style=\"background: EXPR(gfn_Decode(PRNT_LEVL, 6 ,'#d7f1eeff','default'));align: right;\" text=\"bind:BASE_BALA\" mask=\"#,###\"/><Cell col=\"5\" displaytype=\"number\" style=\"background: EXPR(gfn_Decode(PRNT_LEVL, 6 ,'#d7f1eeff','default'));align: right;\" text=\"bind:CURR_PREV_AMNT\" mask=\"#,###\"/><Cell col=\"6\" displaytype=\"number\" style=\"background: EXPR(gfn_Decode(PRNT_LEVL, 6 ,'#d7f1eeff','default'));align: right;\" text=\"bind:CURR_PREV_BALA\" mask=\"#,###\"/><Cell col=\"7\" displaytype=\"number\" style=\"background: EXPR(gfn_Decode(PRNT_LEVL, 6 ,'#d7f1eeff','default'));align: right;\" text=\"bind:PREV_AMNT\" mask=\"#,###\"/><Cell col=\"8\" displaytype=\"number\" style=\"background: EXPR(gfn_Decode(PRNT_LEVL, 6 ,'#d7f1eeff','default'));align: right;\" text=\"bind:PREV_BALA\" mask=\"#,###\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static9", "absolute", "396", "68", "60", "22", null, null, this);
            obj.set_text("당기기간");
            obj.style.set_align("left");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Calendar("calSHRBASE_YYMM_FR", "absolute", "458", "68", "80", "22", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static0", "absolute", "639", "68", "65", "22", null, null, this);
            obj.set_text("전기기간");
            obj.style.set_align("left");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Calendar("calSHRPREV_YYMM_FR", "absolute", "705", "68", "80", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_dateformat("yyyy-MM");
            obj.set_taborder("4");
            obj.set_editformat("yyyy-MM");
            ...
            obj = new Static("Static3", "absolute", "887", "68", "60", "22", null, null, this);
            obj.set_text("조회레벨");
            obj.style.set_align("left");
            ...
            obj = new Edit("edtSHRPRNT_LEVL_FR", "absolute", "939", "122", "19", "22", null, null, this);
            ...
            obj = new Calendar("calSHRBASE_YYMM_TO", "absolute", "555", "68", "80", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_dateformat("yyyy-MM");
            obj.set_taborder("3");
            obj.set_editformat("yyyy-MM");
            ...
            obj = new Calendar("calSHRPREV_YYMM_TO", "absolute", "801", "68", "80", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_dateformat("yyyy-MM");
            obj.set_taborder("5");
            obj.set_editformat("yyyy-MM");
            ...
            obj = new Static("Static2", "absolute", "16", "68", "63", "22", null, null, this);
            obj.set_text("회계단위");
            obj.style.set_align("left");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRACCT_GUB1", "absolute", "80", "68", "120", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("0");
            ...
            obj = new Static("Static1", "absolute", "206", "68", "50", "22", null, null, this);
            obj.set_text("사업장");
            obj.style.set_align("left");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Static("Static04", "absolute", "542", "68", "13", "22", null, null, this);
            obj.set_text("~");
            obj.style.set_align("middle left");
            obj.set_cssclass("styFormSearchInfo");
            this.addChild(obj.name, obj);

            obj = new Static("Static05", "absolute", "788", "68", "13", "22", null, null, this);
            obj.set_text("~");
            obj.style.set_align("middle left");
            obj.set_cssclass("styFormSearchInfo");
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("cmbACCT_GUBN", "absolute", "258", "68", "131", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("1");
            ...
            obj = new Combo("cmbSHRPRNT_LEVL_TO", "absolute", "948", "68", "40", "22", null, null, this);
            this.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 1041, 834, this,
            	//-- Layout function
            	function(p) {
            		p.set_titletext("손익계산서 조회");
        ...
        // User Script
        this.addIncludeScript("FAMD0330.xfdl", "script::lib_script_common.xjs");
        this.registerScript("FAMD0330.xfdl", function() {
        ...
        // include "script::lib_Grid_Resize.xjs";
        ...
        this.sPACKAGENAME = 'erp.u.fam.d.ab.FAMD0330AB'; //해당 Form에서 사용 할 Package 명

        // expr:DECODE(PRNT_LEVL, 0, "#CCCCFF", 1, "#D6D6FF", 2, "#E0E0FF", 3, "#EAEAFF", 4, "#F4F4FF", 5, "#FFFFFF")
        /**************************************************************************************************
         *                                         공통 Event 처리 부분                                    *
         ***************************************************************************************************/
        /*----------------------------------+
        ...
        this.fn_Print = function (obj,e)
        {
        	...
        	application.GBL_RPTFILENAME = "famd0330r1.jrf"; //Report File Name
        	...
        	toDay1f = this.fnc_SubStr(this.calSHRBASE_YYMM_FR.value, 0, 4) + '년 ' + this.fnc_SubStr(this.calSHRBASE_YYMM_FR.value, 4, 2) + '월 01일 ~ ';
        	toDay1t = this.fnc_SubStr(this.calSHRBASE_YYMM_TO.value, 0, 4) + '년 ' + this.fnc_SubStr(this.calSHRBASE_YYMM_TO.value, 4, 2) + '월 ' + this.fnc_SubStr(this.fnc_LastDate(this.calSHRBASE_YYMM_TO.value), 6, 2) + '일';

        	toDay2f = this.fnc_SubStr(this.calSHRPREV_YYMM_FR.value, 0, 4) + '년 ' + this.fnc_SubStr(this.calSHRPREV_YYMM_FR.value, 4, 2) + '월 01일 ~ ';
        	toDay2t = this.fnc_SubStr(this.calSHRPREV_YYMM_TO.value, 0, 4) + '년 ' + this.fnc_SubStr(this.calSHRPREV_YYMM_TO.value, 4, 2) + '월 ' + this.fnc_SubStr(this.fnc_LastDate(this.calSHRPREV_YYMM_TO.value), 6, 2) + '일';
        	// toDay = "당기: "+ toDay1f + " ~ " + toDay1t +"     전기: " + toDay2f  + " ~ " + toDay2t;
        	...
        	// Parameter
        	application.GBL_RPTARGUMENT = 'sArg001,' + toDay1f + toDay1t + '^';
        	application.GBL_RPTARGUMENT = application.GBL_RPTARGUMENT + 'sArg002,' + pleaceBusiness + '^';
        	application.GBL_RPTARGUMENT = application.GBL_RPTARGUMENT + 'sArg003,' + toDay2f + toDay2t;
        	...
        	application.dialog("손익계산서", "popup::comReportViewer.xfdl", this, "", strOpenStyle);
        }
        ...
        this.fn_FormLoadSetting = function (obj,e)
        {
        	...
        	for (var i=0; i < this.grdTA_MAMNTM.getCellCount("body"); i++) 
        	{
        		...
        		styleObj.background = "expr:GRPKEY == '1' && fnc_Length(ACCT_BFNM) > 0 ? '#d7f1eeff' : 'white'";
        		styleObj.background2 = "expr:GRPKEY == '1' && fnc_Length(ACCT_BFNM) > 0 ? '#d7f1eeff' : 'white'";
        	}
        	...
        	this.calSHRPREV_YYMM_FR.set_value(((nexacro.toNumber(this.fnc_SubStr(this.fnc_GetServerDateTime("DATE"), 0, 4)) - 1) + "01"));
        	this.calSHRPREV_YYMM_TO.set_value(((nexacro.toNumber(this.fnc_SubStr(this.fnc_GetServerDateTime("DATE"), 0, 4)) - 1) + this.fnc_SubStr(this.fnc_GetServerDateTime("DATE"), 4, 2)));
        }
        ...
        this.fn_SearchItemCheck = function ()
        {
        	...
        	{
        		this.fnc_Message("M1046", "당기기간의 연도는 동일한 연도 이어야 합니다.."); //인쇄자료 없음
        		this.calSHRBASE_YYMM_TO.setFocus(); //해당 항목으로 Focus
        		return false;
        	}

        	// 조회 시 검색 조건이 반드시 있어야 하는 경우 해당 조건을 나열하여 체크 한다.
        	if (this.fnc_Length(this.fnc_Trim(this.calSHRPREV_YYMM_FR.value)) < 1) 
        	{
        		this.fnc_Message("M1005", "전기기준월"); //Message 처리
        		this.calSHRPREV_YYMM_FR.setFocus(); //해당 항목으로 Focus
        		return false;
        	}
        	// 조회 시 검색 조건이 반드시 있어야 하는 경우 해당 조건을 나열하여 체크 한다.
        	if (this.fnc_Length(this.fnc_Trim(this.calSHRPREV_YYMM_TO.value)) < 1) 
        	{
        		this.fnc_Message("M1005", "전기기준월"); //Message 처리
        		this.calSHRPREV_YYMM_TO.setFocus(); //해당 항목으로 Focus
        		return false;
        	}

        	if (this.fnc_SubStr(this.fnc_Trim(this.calSHRPREV_YYMM_FR.value), 0, 4) != this.fnc_SubStr(this.fnc_Trim(this.calSHRPREV_YYMM_TO.value), 0, 4)) 
        	{
        		this.fnc_Message("M1046", "전기기간의 연도는 동일한 연도 이어야 합니다.."); //인쇄자료 없음
        		this.calSHRPREV_YYMM_TO.setFocus(); //해당 항목으로 Focus
        		return false;
        	}

        	if (this.fnc_SubStr(this.fnc_Trim(this.calSHRBASE_YYMM_FR.value), 0, 4) == this.fnc_SubStr(this.fnc_Trim(this.calSHRPREV_YYMM_FR.value), 0, 4)) 
        	{
        ...
        this.fn_CreateArgument = function (sKind)
        {
        	...
        	if (sKind == 'SEARCH00') 
        	{
        		...
        		sReturnString += " PREV_YYMM_FR=" + this.fnc_Quote(this.fnc_Trim(this.fnc_SubStr(this.calSHRPREV_YYMM_FR.value, 0, 6))); //전송 할 인자 값
        		sReturnString += " PREV_YYMM_TO=" + this.fnc_Quote(this.fnc_Trim(this.fnc_SubStr(this.calSHRPREV_YYMM_TO.value, 0, 6))); //전송 할 인자 값
        ...
        this.on_initEvent = function()
        {
            ...
            this.calSHRPREV_YYMM_FR.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            ...
            this.calSHRPREV_YYMM_TO.addEventHandler("onsetfocus", this.fn_EditFocus, this);
        ...
        this.loadIncludeScript("FAMD0330.xfdl");
