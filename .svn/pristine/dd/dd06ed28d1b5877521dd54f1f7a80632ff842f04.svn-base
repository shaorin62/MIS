    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FAMG0020");
                this.set_scrollbars("none");
                this.set_titletext("연결매출내역 관리");
        ...
        // User Script
        this.addIncludeScript("FAMG0020.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("FAMG0020.xfdl", "script::lib_gfn.xjs");
        this.addIncludeScript("FAMG0020.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("FAMG0020.xfdl", function() {
        /***************************************************************************************************
         * # Program:	FAMG0020 연결매출내역 관리
         * 
        ...
        this.loadIncludeScript("FAMG0020.xfdl");
