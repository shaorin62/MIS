(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("FAMG0020_99.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("FAMG0020_99.xfdl", "script::lib_gfn.xjs");
        this.addIncludeScript("FAMG0020_99.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("FAMG0020_99.xfdl", function() {
        /***************************************************************************************************
        ...
        this.loadIncludeScript("FAMG0020_99.xfdl");
