 ...
 */
@Service("TXMD0040Service")
public class TXMD0040ServiceImpl extends EgovAbstractServiceImpl implements TXMD0040Service {

	private static final Logger logger = LoggerFactory.getLogger(TXMD0040ServiceImpl.class);

	@Resource(name="TXMD0040Dao")
	private TXMD0040Dao tXMD0040Dao;
	...
	public Object processSEARCH00(Map searchVo) throws Exception {
		...
		returnMap.put("dsCOMP_MED1", tXMD0040Dao.processSEARCH00(searchVo));
		return returnMap;
	}
	@SuppressWarnings("rawtypes")
	public Object processSEARCH01(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsCOMP_MED2", tXMD0040Dao.processSEARCH01(searchVo));
		return returnMap;
	}
	@SuppressWarnings("rawtypes")
	public Object processSEARCH02(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsCOMP_MED3", tXMD0040Dao.processSEARCH02(searchVo));
		return returnMap;
	}
	@SuppressWarnings("rawtypes")
	public Object processSEARCH04(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsCOMP_MEDI", tXMD0040Dao.processSEARCH04(searchVo));
		return returnMap;
	}
	...
	public String processSAVE00(Map searchVo, Map saveData) throws Exception{
		...
		fileName 	= "F" + BSNS_NUMB.substring(0, 7) + "." + BSNS_NUMB.substring(7);
