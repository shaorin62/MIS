(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsMonCal2", this);
            obj._setContents("<ColumnInfo><Column id=\"TEXT_DATA\" type=\"STRING\" size=\"256\"/><Column id=\"a\" type=\"STRING\" size=\"256\"/><Column id=\"Column4\" type=\"STRING\" size=\"256\"/><Column id=\"Column3\" type=\"STRING\" size=\"256\"/><Column id=\"Column2\" type=\"STRING\" size=\"256\"/><Column id=\"Column1\" type=\"STRING\" size=\"256\"/><Column id=\"MNTH_DATA\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"TEXT_DATA\">1</Col><Col id=\"a\">201601</Col><Col id=\"MNTH_DATA\">201601</Col></Row><Row><Col id=\"TEXT_DATA\">2</Col><Col id=\"a\">201512</Col><Col id=\"MNTH_DATA\">201512</Col></Row><Row><Col id=\"MNTH_DATA\">201308</Col></Row><Row><Col id=\"TEXT_DATA\">3</Col><Col id=\"a\">201308</Col><Col id=\"MNTH_DATA\">201609</Col></Row><Row><Col id=\"TEXT_DATA\">4</Col><Col id=\"a\">201609</Col></Row><Row><Col id=\"TEXT_DATA\">5</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("Div00", "absolute", "10", "310", "104", "37", null, null, this);
            obj.set_taborder("12");
            obj.set_text("Div00");
            obj.set_url("common::comMonthCalendar.xfdl");
            this.addChild(obj.name, obj);

            obj = new Button("AddEvent", "absolute", "127", "310", "120", "37", null, null, this);
            obj.set_taborder("13");
            obj.set_text("Event 등록하기.");
            this.addChild(obj.name, obj);

            obj = new Grid("grdMonCal2", "absolute", "212", "438", "580", "162", null, null, this);
            obj.set_taborder("14");
            obj.set_binddataset("dsMonCal2");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"TEXT_DATA\"/><Cell col=\"1\" text=\"a\"/><Cell col=\"2\" text=\"Column4\"/><Cell col=\"3\" text=\"Column3\"/><Cell col=\"4\" text=\"Column2\"/><Cell col=\"5\" text=\"Column1\"/><Cell col=\"6\" text=\"MNTH_DATA\"/></Band><Band id=\"body\"><Cell text=\"bind:TEXT_DATA\"/><Cell col=\"1\" text=\"bind:a\"/><Cell col=\"2\" text=\"bind:Column4\"/><Cell col=\"3\" text=\"bind:Column3\"/><Cell col=\"4\" text=\"bind:Column2\"/><Cell col=\"5\" text=\"bind:Column1\"/><Cell col=\"6\" edittype=\"mask\" text=\"bind:MNTH_DATA\" mask=\"####-##\" expandshow=\"show\" expandsize=\"20\" expandimage=\"URL('theme://images\\btn_CalDrop_N.png')\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static00", "absolute", "416", "108", "374", "60", null, null, this);
            obj.set_taborder("15");
            obj.set_text("그리드 월달력 샘플 ExpandUp 이벤트 사용");
            obj.style.set_font("12 Dotum");
            this.addChild(obj.name, obj);

            obj = new Grid("grdMonCal00", "absolute", "0", "438", "113", "162", null, null, this);
            obj.set_taborder("16");
            obj.set_binddataset("dsMonCal2");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"MNTH_DATA\"/></Band><Band id=\"body\"><Cell edittype=\"mask\" text=\"bind:MNTH_DATA\" mask=\"####-##\" expandshow=\"show\" expandsize=\"20\" expandimage=\"URL('theme://images\\btn_CalDrop_N.png')\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Tab("Tab00", "absolute", "608", "155", "188", "221", null, null, this);
            obj.set_taborder("17");
            obj.set_tabindex("0");
            ...
            obj = new Grid("grdMonCal00", "absolute", "70", "2", "113", "162", null, null, this.Tab00.tabpage1);
            obj.set_taborder("0");
            obj.set_binddataset("dsMonCal2");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"MNTH_DATA\"/></Band><Band id=\"body\"><Cell edittype=\"mask\" text=\"bind:MNTH_DATA\" mask=\"####-##\" expandshow=\"show\" expandsize=\"20\" expandimage=\"URL('theme://images\\btn_CalDrop_N.png')\"/></Band></Format></Formats>");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 217, 133, this.Tab00.tabpage1,
            	//-- Layout function
            	function(p) {
            		p.set_text("tabpage1");
        ...
        // User Script
        this.addIncludeScript("sample_guide_calmonth.xfdl", "script::lib_script_common.xjs");
        this.registerScript("sample_guide_calmonth.xfdl", function() {
         /***************************************************************************************************
        ...
        this.fnc_customEvent = function (obj,e){
        	alert(obj.name);
        ...
        this.addEvent = function(obj,e) {
        		this.Div00.fn_CalendarCustomEvent(this, "fnc_customEvent");
        }

        this.MonthCalExpandUp = function(obj,e) {
        ...
        this.on_initEvent = function()
        {
            ...
            this.AddEvent.addEventHandler("onclick", this.addEvent, this);
            this.grdMonCal2.addEventHandler("onexpandup", this.MonthCalExpandUp, this);
            this.Static00.addEventHandler("onclick", this.Static00_onclick, this);
            this.grdMonCal00.addEventHandler("onexpandup", this.MonthCalExpandUp, this);
            this.Tab00.tabpage1.addEventHandler("onclick", this.Tab00_tabpage1_onclick, this);
            this.Tab00.tabpage1.grdMonCal00.addEventHandler("onexpandup", this.MonthCalExpandUp, this);

        };

        this.loadIncludeScript("sample_guide_calmonth.xfdl");
