    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("WFMG0010");
                this.set_titletext("연수지원신청 및 내역");
            ...
            obj.set_tabstop("false");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"25\"/><Column size=\"120\"/><Column size=\"92\"/><Column size=\"92\"/><Column size=\"264\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"100\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"신청일\"/><Cell col=\"2\" text=\"신청자\"/><Cell col=\"3\" text=\"사원번호\"/><Cell col=\"4\" text=\"제목\"/><Cell col=\"5\" text=\"승인상태\"/><Cell col=\"6\" text=\"결재일자\"/><Cell col=\"7\" text=\"처리\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"expr:APPR_STAT == &quot;N&quot; ? &quot;checkbox&quot; : &quot;&quot;\" text=\"bind:CHK_BOX\"/><Cell col=\"1\" displaytype=\"date\" text=\"bind:APPR_DATE\"/><Cell col=\"2\" text=\"bind:APPR_EMPL_NAME\"/><Cell col=\"3\" text=\"bind:APPR_EMPL_NUMB\"/><Cell col=\"4\" style=\"align:left;font:underline 9 arial;cursor:hand;\" text=\"bind:SUBJ_NAME\"/><Cell col=\"5\" text=\"bind:APPR_STAT_STR\"/><Cell col=\"6\" displaytype=\"date\" text=\"bind:ENDX_DATE\" calendardisplaynulltype=\"none\"/><Cell col=\"7\" displaytype=\"expr:APPR_STAT == &quot;&quot; ? &quot;none&quot; : &quot;button&quot;\" edittype=\"expr:APPR_STAT == &quot;&quot; ? &quot;none&quot; : &quot;button&quot;\" style=\"cursor:hand;\" text=\"bind:APPR_STAT_PROC\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("WFMG0010.xfdl", "script::lib_script_common.xjs");
        this.registerScript("WFMG0010.xfdl", function() {
        /****************************************************************************************************
         * @explanation		연수지원 신청 및 내역을 관리한다.
         * @category	 	복리후생>연수관리>연수지원 신청 및 내역
         * @author	   		김혜림
         * @cdate	  		2016.09.21
         * @version 1.0		최초 작성
         * WFMG0010.xml - <Created by Code Template generator>
         *
         *Form Common Script                                                                             *
        ...
        this.fn_FormLoadSetting = function (obj,e) {
            ...
            this.calSHRAPPR_DATE1.set_value(this.fnc_SubStr(iNowDate, 0, 6) + '01');
        	...
        	//this.sUSERLAVEL = 1;
                ...
                this.fn_Cancel = function (obj) {
        			...
        			/*this.cmbSHRAPPR_STAT.set_index(0);
        			this.cmbSHRDOCU_IDXX.set_index(0);
                ...
                this.fn_SearchItemCheck = function () {
                	...
                	if (this.fnc_Length(this.fnc_Trim(this.edtSHREMPL_NUMB.value)) < 1) {
        				return this.fnc_SearchCheckPostAction("TMM072", "사원번호", this.edtSHREMPL_NAME);
        			}
                ...
                this.fn_PostProcess = function (sMethodName) {
                	...
                	if (sMethodName == 'SEARCH00') {
                		...
                		arrParam[0] = "COMBO,cmbSHRDOCU_IDXX,dsSHRDOCU_IDXX,GWAP_DOCT"; //SHR 신청서 종류SHR 
                		arrParam[1] = "COMBO,cmbSHRAPPR_STAT,dsSHRAPPR_STAT,GWAP_STAT";//SHR 결재상태SHR
                		
                		/*연수신청서만 나오게 필터처리*/
                		//this.dsSHRDOCU_IDXX.filter("COMD_CODE == 'KHR143' || COMD_CDNM == '전체'");
                		this.dsSHRDOCU_IDXX.filter("COMD_CODE == 'KHR143'");
                ...
                {  
                	...
                	if(sApprStat == "N") sGubn = "createDoc"; // 임시저장
                	else if(sApprStat == "T") sGubn = "del"; // 기안대기
                	else sGubn = "show"; //결재상세보기
                		
                	if(e.col == 4){//결재문서 제목 클릭했을 때
        ...
        this.on_initEvent = function()
        {
            ...
            this.cmbSHRDOCU_IDXX.addEventHandler("onitemchanged", this.cmbSHRDOCU_IDXX_onitemchanged, this);
        ...
        this.loadIncludeScript("WFMG0010.xfdl");
