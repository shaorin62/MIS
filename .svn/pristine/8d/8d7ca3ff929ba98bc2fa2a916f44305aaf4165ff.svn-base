(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("MCMA0070P01.xfdl", "script::lib_script_common.xjs");
        this.registerScript("MCMA0070P01.xfdl", function() {
        /***************************************************************************************************
         * # Program:	MCMA0070P01 카테고리조회팝업
         * 
        ...
        this.fn_Confirm = function (obj,e) {
        	...
        	this.opener.fn_CallBackP01(cust_code, cust_name, cate_code, cate_name, key);
        ...
        this.loadIncludeScript("MCMA0070P01.xfdl");
