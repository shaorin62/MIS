(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text(">회계관리>코스트센터그룹관리");
            obj.style.set_align("right middle");
            obj.set_cssclass("styFormLocation");
            this.addChild(obj.name, obj);

            obj = new Div("div_ButtonList", "absolute", null, "31", "455", "29", "8", null, this);
            obj.set_taborder("23");
            obj.set_url("common::comButtonType01.xfdl");
            obj.set_scrollbars("none");
            this.addChild(obj.name, obj);

            obj = new Static("Static0", "absolute", "680", "68", "60", "22", null, null, this);
            obj.set_text("부서명");
            obj.style.set_align("left");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRDEPT_NAME", "absolute", "730", "68", "210", "22", null, null, this);
            ...
            obj = new Static("Static2", "absolute", "946", "68", "60", "22", null, null, this);
            obj.set_text("부서구분");
            obj.style.set_align("left");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRDEPT_GUBN", "absolute", "1008", "68", "112", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("1");
            ...
            obj = new Static("staSHRSTDX_DATE", "absolute", "16", "68", "61", "22", null, null, this);
            obj.set_text("기준일자");
            obj.style.set_align("left");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Calendar("calSHRSTDX_DATE", "absolute", "79", "68", "100", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("2");
        ...
        // User Script
        this.addIncludeScript("FAMA0920.xfdl", "script::lib_script_common.xjs");
        this.registerScript("FAMA0920.xfdl", function() {
        /***************************************************************************************************
         *   Form Common Script                                                                             *
        ...
        this.fn_Delete = function (obj,e)
        {
        	...
        	if (this.dsTA_DEPTXM.getRowCount() > 0) 
        	{
        		...
        		{
        			this.dsTA_DEPTXM.deleteMultiRows(this.dsTA_DEPTXM.getSelectedDatasetRows());
        		}
        		// 삭제 여부 확인
        	}
        	else 
        ...
        this.fn_SaveItemCheck = function ()
        {
        	...
        	for (var i = 0; i < this.dsTA_DEPTXM.getRowCount(); i++) 
        	{
        		...
        		if (this.fnc_ToUpper(this.dsTA_DEPTXM.getRowType(i)) != Dataset.ROWTYPE_NORMAL)
        		{
        			if (this.fnc_Length(this.fnc_Trim(this.dsTA_DEPTXM.getColumn(i, 'DEPT_CODE'))) < 1) 
        			{
        				return this.fnc_CheckPostAction("TMM072", "부서코드", this.dsTA_DEPTXM, i, this.grdTA_DEPTXM, 'DEPT_CODE');
        			}

        			// if (fnc_Length(fnc_Trim(dsTA_DEPTXM.getColumn(i, 'DEPT_NAME')))< 1 ) {
        			// return fnc_CheckPostAction("TMM072", "부서명", dsTA_DEPTXM, i, grdTA_DEPTXM, 'DEPT_NAME');
        			// }
        			// 
        		}
        	}
        ...
        this.fn_PostProcess = function (sMethodName)
        {
        	if (sMethodName == 'SEARCH00') 
        	{
        		...
        		this.fnc_Message("TMM018", this.dsTA_DEPTXM.rowcount); //정상 종료 메세지
        	}
        	else if (sMethodName == 'SAVE00') 
        	{
        		this.fnc_Information(this.stInformation, 0, "SAVE"); //저장 결과 Display
        		this.fnc_Message("TMM103"); //fn_KeyFieldDisible(dsTA_DEPTXM,0,dsTA_DEPTXM.rowposition);
        ...
        this.loadIncludeScript("FAMA0920.xfdl");
