(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Calendar("calToMonth", "absolute", "77", "0", "80", "21", null, null, this);
            ...
            obj = new Static("Static00", "absolute", "64", "0", "11", "21", null, null, this);
            obj.set_taborder("3");
            obj.set_text("~");
            obj.getSetter("class").set("sta_WF_txt");
            this.addChild(obj.name, obj);

            obj = new Button("btnCal", "absolute", "132", "0", "24", "21", null, null, this);
            obj.set_taborder("2");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 157, 21, this,
            	//-- Layout function
            	function(p) {
        ...
        // User Script
        this.addIncludeScript("com_periodCalendar_month.xfdl", "lib::commonloader.xjs");
        this.registerScript("com_periodCalendar_month.xfdl", function() {
        /*=================================================================================================
         * 01. 업무구분	: Common
        ...
        this.loadIncludeScript("com_periodCalendar_month.xfdl");
