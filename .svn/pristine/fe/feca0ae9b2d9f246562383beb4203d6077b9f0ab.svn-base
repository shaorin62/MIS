/**
 * core.erp.pay.service.impl.PAYC0040ServiceImpl.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	PAYC0040ServiceImpl - 비과세조회 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	고민주
 * @since	2016.07.11
 * @version	1.0
 * @see		{@link PAYC0040Service}
 *
 * <pre>
...
@Service("PAYC0040Service")
public class PAYC0040ServiceImpl extends EgovAbstractServiceImpl implements PAYC0040Service {

	/**
	 * 비과세조회 DAO class inject.
	 */
	@Resource(name = "PAYC0040Dao")
	private PAYC0040Dao dao;
