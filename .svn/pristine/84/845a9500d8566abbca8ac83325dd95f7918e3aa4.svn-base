    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("Temp00000M");
                this.set_titletext("(1280)업무화면샘플");
        ...
        // User Script
        this.addIncludeScript("Temp00000M.xfdl", "script::lib_script_common.xjs");
        this.registerScript("Temp00000M.xfdl", function() {
         /***************************************************************************************************
         * # Program : 업무화면 템플릿 #1
         * 
        ...
        this.loadIncludeScript("Temp00000M.xfdl");
