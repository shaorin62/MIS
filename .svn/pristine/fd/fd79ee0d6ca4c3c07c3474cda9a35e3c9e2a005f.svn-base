...
/**
 * <pre>
 *	FAMG0040ServiceImpl - 연결시산표 관리 ServiceImpl 클래스 
 * </pre>
 *
 * @author	김기환
 * @since	2016.09.23
 * @version	1.0
 * @see		{@link FAMG0040Service}
 *
 * <pre>
...
@Service("FAMG0040Service")
public class FAMG0040ServiceImpl extends EgovAbstractServiceImpl implements FAMG0040Service {

	private static final Logger LOGGER = LoggerFactory.getLogger(FAMG0040ServiceImpl.class);

	@Resource(name = "FAMG0040Dao")
	private FAMG0040Dao FAMG0040Dao;
	...
	public Object processSEARCH00(Map<String, Object> searchVo) throws Exception {
		...
		returnMap.put("dsNS_CFS_DATA_M", FAMG0040Dao.processSEARCH00(searchVo));
		return returnMap;
	}
	...
	public Object processSEARCH01(Map<String, Object> searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsNS_CFS_DATA_D", FAMG0040Dao.processSEARCH01(searchVo));
		return returnMap;
	}
	...
	public Object processSEARCH02(Map<String, Object> searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("sRetValue", FAMG0040Dao.processSEARCH02(searchVo));
		return returnMap;
	}
	...
	public Object processCREATE_DATA(Map<String, Object> searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsNS_CFS_DATA_D", FAMG0040Dao.processCREATE_DATA(searchVo));
		return returnMap;
	}
	...
	public Object processSAVE_DATA(Map<String, Object> searchVo, Map<String, Object> saveData) throws Exception {
		...
		//저장데이터 존재여부 확인
		Integer iCnt =  (Integer) FAMG0040Dao.processSEARCH03(searchVo);
		
		Object oTranSeq = "";

		if( iCnt > 0 ){
			//자료생성 년월 "전송대기" 상태 삭제
			FAMG0040Dao.processDELETE01(searchVo); //상세
			FAMG0040Dao.processDELETE00(searchVo); //마스터
			
			//연결재무제표 IF 마스터 저장
			oTranSeq = FAMG0040Dao.processSAVE00(searchVo);
			...
			if( !"".equals(oTranSeq) && oTranSeq != null ) 
			{
				...
				for (Map<String, Object> data : ds)
				{
					...
					FAMG0040Dao.processSAVE01(data);
				}
			}
		}
	...
	public Object processTRAN_DATA(Map<String, Object> searchVo, Map<String, Object> saveData) throws Exception {
		...
		//자료전송
		Object retInsert = FAMG0040Dao.processSAVE02(searchVo);
		
		if(retInsert == null){
			//상태 업데이트
			FAMG0040Dao.processUPDATE00(searchVo);
		}
