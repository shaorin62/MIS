    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FAMD0060");
                this.set_titletext("세금공과금명세현황");
            ...
            obj._setContents("<ColumnInfo><Column id=\"ACCT_UNIT\" size=\"4\" prop=\"default\" type=\"STRING\"/><Column id=\"ACCT_INTL\" size=\"10\" prop=\"default\" type=\"STRING\"/><Column id=\"ACCT_NAME\" size=\"200\" prop=\"default\" type=\"STRING\"/><Column id=\"ACCT_DATE\" size=\"8\" prop=\"default\" type=\"STRING\"/><Column id=\"REMK_NAME\" size=\"400\" prop=\"default\" type=\"STRING\"/><Column id=\"CUST_NAME\" size=\"100\" prop=\"default\" type=\"STRING\"/><Column id=\"SLIP_AMNT\" size=\"17\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"DISP_SLIP\" type=\"STRING\" size=\"256\"/><Column id=\"SLIP_NUMB\" type=\"STRING\" size=\"256\"/><Column id=\"SLIP_LINE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"150\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"200\"/><Column size=\"250\"/><Column size=\"142\"/><Column size=\"186\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/><Row size=\"26\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"전표번호\"/><Cell col=\"1\" displaytype=\"text\" text=\"회계일자\"/><Cell col=\"2\" displaytype=\"text\" text=\"계정과목\"/><Cell col=\"3\" displaytype=\"text\" text=\"계정명\"/><Cell col=\"4\" displaytype=\"text\" text=\"적요\"/><Cell col=\"5\" displaytype=\"text\" text=\"지급처\"/><Cell col=\"6\" displaytype=\"text\" text=\"금액\"/></Band><Band id=\"body\"><Cell text=\"bind:DISP_SLIP\"/><Cell col=\"1\" displaytype=\"date\" style=\"align:center;\" text=\"bind:ACCT_DATE\" calendardisplaynulltype=\"none\"/><Cell col=\"2\" displaytype=\"text\" style=\"align:center;\" text=\"bind:ACCT_INTL\"/><Cell col=\"3\" displaytype=\"text\" style=\"align:left;\" text=\"bind:ACCT_NAME\"/><Cell col=\"4\" displaytype=\"text\" style=\"align:left;\" text=\"bind:REMK_NAME\"/><Cell col=\"5\" displaytype=\"text\" style=\"align:left;\" text=\"bind:CUST_NAME\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SLIP_AMNT\"/></Band><Band id=\"summary\"><Cell colspan=\"6\" style=\"align:center;\" text=\"합   계\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:dataset.getSum(&quot;SLIP_AMNT&quot;)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static02", "absolute", "225", "71", "76", "21", null, null, this);
            obj.set_taborder("8");
            obj.set_text("회계기간");
            ...
            obj = new Calendar("calSHRACCT_DATE2", "absolute", "414", "71", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("2");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormSearchItemCalendar");

            obj = new Calendar("calSHRACCT_DATE1", "absolute", "295", "71", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("1");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormSearchItemCalendar");

            obj = new Static("Static36", "absolute", "400", "71", "16", "21", null, null, this);
            obj.set_taborder("10");
            obj.set_text("~");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("11");
            obj.set_text("세금공과금명세현황");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("12");
            obj.set_text("홈 > 자금관리 > 세금공과금명세현황");
            ...
            obj = new Static("stInformation00", "absolute", null, "107", "553", "21", "25", null, this);
            obj.set_taborder("26");
            obj.set_text("[계정과목등록]메뉴에서 계정종류가 <세금과공과>로 설정된 계정과목의 전표 자료가 조회 됩니다.");
            obj.set_cssclass("sta_WF_Info");
            obj.style.set_background("transparent URL('theme://images/sta_WF_Info.png') left middle");
            obj.style.set_align("left middle");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRACCT_INT1", "absolute", "614", "71", "80", "21", null, null, this);
            obj.set_taborder("27");
            obj.set_tabstop("false");
            ...
            obj = new Static("imgHelpSHRACCT_INT1", "absolute", "696", "71", "21", "21", null, null, this);
            obj.set_taborder("28");
            obj.set_cssclass("sytHelpPopup");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRACCT_NAM1", "absolute", "719", "71", "144", "21", null, null, this);
            obj.set_taborder("3");
            ...
            obj = new Static("Static10", "absolute", "865", "71", "14", "21", null, null, this);
            obj.set_taborder("29");
            obj.set_text("~");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRACCT_INT2", "absolute", "881", "71", "80", "21", null, null, this);
            obj.set_taborder("30");
            obj.set_tabstop("false");
            obj.set_readonly("true");
            obj.set_autoselect("true");
            ...
            obj = new Static("imgHelpSHRACCT_INT2", "absolute", "963", "71", "21", "21", null, null, this);
            obj.set_taborder("31");
            obj.set_cssclass("sytHelpPopup");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRACCT_NAM2", "absolute", "986", "71", "144", "21", null, null, this);
            obj.set_taborder("4");
            obj.set_imemode("hangul");
            obj.set_maxlength("200");
            obj.set_autoselect("true");
            ...
            obj = new Static("Static15", "absolute", "543", "71", "64", "21", null, null, this);
            obj.set_taborder("32");
            obj.set_text("계정과목");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Static("Static11", "absolute", "514", "61", "40", "41", null, null, this);
            obj.set_taborder("33");
            obj.set_text("w 40");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
        ...
        // User Script
        this.addIncludeScript("FAMD0060.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("FAMD0060.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("FAMD0060.xfdl", function() {
        /***************************************************************************************************
        ...
        this.loadIncludeScript("FAMD0060.xfdl");
