...
import core.erp.yea.service.YEAA0110_2015Service;
import core.erp.yea.web.YEAA0110_2015Controller;
...
/**
 * <pre>
 *	YEAA0110_2015ServiceImpl - 연말정산전산매체 메뉴 서비스 인터페이스 구현 클래스
 * <p><b>NOTE : </b></p>
 * </pre>
 * 
 * @author	김석영
 ...
 */
@Service("YEAA0110_2015Service")
public class YEAA0110_2015ServiceImpl extends EgovAbstractServiceImpl implements YEAA0110_2015Service {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(YEAA0110_2015Controller.class);

	/**
	 * 연말정산전산매체 DAO class inject.
	 */
	@Resource(name = "YEAA0110_2015Dao")
	private YEAA0110_2015Dao dao;
