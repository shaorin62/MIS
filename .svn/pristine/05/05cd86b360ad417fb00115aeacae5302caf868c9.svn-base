    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FAMG0060");
                this.set_scrollbars("none");
                this.set_titletext("연결채권잔고내역 관리");
        ...
        // User Script
        this.addIncludeScript("FAMG0060.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("FAMG0060.xfdl", "script::lib_gfn.xjs");
        this.addIncludeScript("FAMG0060.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("FAMG0060.xfdl", function() {
        /***************************************************************************************************
         * # Program:	FAMG0060 연결채권잔고내역 관리
         * 
        ...
        this.loadIncludeScript("FAMG0060.xfdl");
