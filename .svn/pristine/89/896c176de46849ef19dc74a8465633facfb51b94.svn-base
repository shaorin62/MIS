(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("FAMG0040_99.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("FAMG0040_99.xfdl", "script::lib_gfn.xjs");
        this.addIncludeScript("FAMG0040_99.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("FAMG0040_99.xfdl", function() {
        /***************************************************************************************************
        ...
        this.loadIncludeScript("FAMG0040_99.xfdl");
