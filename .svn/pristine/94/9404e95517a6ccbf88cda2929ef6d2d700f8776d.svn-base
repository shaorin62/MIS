/**
 * core.erp.mdm.service.impl.MDMD0020ServiceImpl.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	MDMD0020ServiceImpl - 인터넷 거래명세서 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.10.17
 * @version	1.0
 * @see		{@link MDMD0020Service}
 *
 * <pre>
...
@Service("MDMD0020Service")
public class MDMD0020ServiceImpl extends EgovAbstractServiceImpl implements MDMD0020Service {

	/**
	 * 인터넷 거래명세서 DAO class inject.
	 */
	@Resource(name = "MDMD0020Dao")
	private MDMD0020Dao dao;
	 ...
	 * @param param - 검색조건 정보가 담긴 Map 객체
	 * @return 조회한 인터넷 거래명세서(헤더) 목록
	 * @exception Exception
	 */
	@SuppressWarnings("rawtypes")
	public Object processSEARCH01(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsMD_ITTRXH", dao.processSEARCH01(searchVo));
		return returnMap;
	 ...
	 * @param param - 검색조건 정보가 담긴 Map 객체
	 * @return 조회한 인터넷 거래명세서(상세) 목록
	 * @exception Exception
	 */
	@SuppressWarnings("rawtypes")
	public Object processSEARCH02(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsMD_ITTRXD", dao.processSEARCH02(searchVo));
		return returnMap;
	...
	public int processSAVE03(Map saveData) throws Exception{
		...
		List dsMD_ITTRXH = (List) saveData.get("dsMD_ITTRXH");
		//DataSet의 Delete Row Count만큼 돌면서 Delete
       for (int i = 0; i < dsMD_ITTRXH.size(); i++) {
       	rowVo = (Map) dsMD_ITTRXH.get(i);
	...
	public int processUPDATE10(Map saveData) throws Exception{
		...
		List dsMD_ITTRXD = (List) saveData.get("dsMD_ITTRXD");
		//DataSet의 Delete Row Count만큼 돌면서 Delete
       for (int i = 0; i < dsMD_ITTRXD.size(); i++) {
       	rowVo = (Map) dsMD_ITTRXD.get(i);
       		//거래명세서 디테일 수정
