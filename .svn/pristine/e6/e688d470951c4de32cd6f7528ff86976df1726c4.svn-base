...
/**
 * <pre>
 *	YEAA0090_2016Controller - 연말정산전산매체 프로그램 컨트롤러 클래스
 * <p><b>NOTE : </b></p>
 * </pre>
 * 
 * @author	김석영
 ...
 */
@Controller
public class YEAA0090_2016Controller {
	 ...
	 * 연말정산전산매체 메뉴 서비스 클래스
	 */
	@Resource(name="YEAA0090_2016Service")
	private YEAA0090_2016Service service;

    /**
	 * 연말정산전산매체 자료를 조회한다.
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/YEAA0090_2016/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0090_2016_SEARCH00.do")
	...
	@RequestMapping(value = "/core/erp/yea/YEAA0090_2016_SAVE00.do")
