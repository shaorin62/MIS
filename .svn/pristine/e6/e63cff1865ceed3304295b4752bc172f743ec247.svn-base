(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_url("main::worktiles_custom.xfdl");
        ...
        this.loadPreloadList = function()
        {
            ...
            this._addPreloadList("fdl", "main::worktiles_custom.xfdl");
        };
        
        // User Script
        this.addIncludeScript("dashboard_custom.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("dashboard_custom.xfdl", "script::lib_script_theme.xjs");
        this.registerScript("dashboard_custom.xfdl", function() {
         /***************************************************************************************************
         * # Program : 공통 메인 대시보드
         * 
        ...
        this.loadIncludeScript("dashboard_custom.xfdl");
