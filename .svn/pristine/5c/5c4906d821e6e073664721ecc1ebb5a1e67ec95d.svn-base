/**
 * core.erp.mdm.service.impl.MDME0010P01ServiceImpl.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	MDME0010P01ServiceImpl - 옥외 개별청약 전체복사(신규) 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.10.14
 * @version	1.0
 * @see		{@link MDME0010P01Service}
 *
 * <pre>
...
@Service("MDME0010P01Service")
public class MDME0010P01ServiceImpl extends EgovAbstractServiceImpl implements MDME0010P01Service {

	/**
	 * 옥외 개별청약 전체복사(신규) DAO class inject.
	 */
	@Resource(name = "MDME0010P01Dao")
	private MDME0010P01Dao dao;

	/**
	 * MDME0010P01 옥외 개별청약 저장한다.
