...
/**
 * <pre>
 *	YEAA0070_2016Controller - 연말정산처리 프로그램 컨트롤러 클래스
 * <p><b>NOTE : </b></p>
 * </pre>
 * 
 * @author	김석영
 ...
 */
@Controller
public class YEAA0070_2016Controller {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(YEAA0070_2016Controller.class);

	/**
	 * 연말정산처리 메뉴 서비스 클래스
	 */
	@Resource(name="YEAA0070_2016Service")
	private YEAA0070_2016Service service;

    /**
	 * 연말정산처리 목록을 조회한다.
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/YEAA0070_2016/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_SEARCH00.do")
	 ...
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_SEARCH01.do")
	@SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_REPORT00.do")
	@SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_REPORT01.do")
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public ModelAndView processREPORT01(CoreRequest coreRequest, ModelMap model) throws Exception {
		...
		try {
			...
			coreResultData.setReturnDataMap((Map<String, Object>) service.processREPORT01(coreRequest.getSaveDataSetAll()));
			coreResultData.setResultMessageSuccessSelect();
	 ...
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_REPORT02.do")
	@SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_REPORT03.do")
	@SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_REPORT04.do")
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public ModelAndView processREPORT04(CoreRequest coreRequest, ModelMap model) throws Exception {
		...
		try {
			...
			coreResultData.setReturnDataMap((Map<String, Object>) service.processREPORT04(coreRequest.getSaveDataSetAll()));
			coreResultData.setResultMessageSuccessSelect();
	...
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_SAVE00.do")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_PROC00.do")
	@SuppressWarnings({ "rawtypes" })
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_PROC01.do")
	@SuppressWarnings({ "rawtypes" })
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_PROC02.do")
	@SuppressWarnings({ "rawtypes" })
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_PROC03.do")
	@SuppressWarnings({ "rawtypes" })
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_PROC04.do")
	@SuppressWarnings({ "rawtypes" })
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/yea/YEAA0070_2016_PROC07.do")
	@SuppressWarnings({ "rawtypes" })
