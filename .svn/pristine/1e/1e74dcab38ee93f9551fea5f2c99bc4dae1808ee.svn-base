 ...
 */
@Repository("TMMB0120Dao")
public class TMMB0120Dao extends CmmBaseDAO  {
	...
	public Object processSEARCH00(Map searchVo) throws Exception {
		return list("TMMB0120.SEARCH00", searchVo);
	}
	...
	public int processDELETE00(Map dataVo) throws Exception {
		return delete("TMMB0120.DELETE00", dataVo);
	}
}
