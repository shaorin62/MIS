/**
 * core.erp.mdm.service.impl.MDMA0011ServiceImpl.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	MDMA0011ServiceImpl - 전파 일괄청약(신규) 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.11.01
...
@Service("MDMA0011Service")
public class MDMA0011ServiceImpl extends EgovAbstractServiceImpl implements MDMA0011Service {

	/**
	 * 전파 일괄청약(신규) DAO class inject.
	 */
	@Resource(name = "MDMA0011Dao")
	private MDMA0011Dao dao;
