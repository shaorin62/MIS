    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FAMB0110");
                this.set_titletext("관계사자료조회(매출/매입)");
            ...
            obj = new Static("Static00", "absolute", "192", "68", "67", "22", null, null, this);
            ...
            obj = new Calendar("calSHRAPPT_TODT", "absolute", "567", "68", "100", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("45");
            ...
            obj = new Static("Static36", "absolute", "548", "68", "16", "22", null, null, this);
        ...
        // User Script
        this.addIncludeScript("FAMB0110.xfdl", "script::lib_script_common.xjs");
        this.registerScript("FAMB0110.xfdl", function() {
        ...
        this.sPACKAGENAME = 'erp.u.fam.b.ab.FAMB0110AB'; //해당 Form에서 사용 할 Package 명*/
        this.sBUTTONLIST = 'TTFFFFTT'; //Button 사용여부 순서(종료, 조회, 입력, 삭제, 취소, 저장, 엑셀, 인쇄)
        this.sPACKAGENAME = 'FAMB0110'; //해당 Form에서 사용 할 Package 명
        ...
        this.fn_Print = function (obj,e)
        {
        	...
        	application.GBL_RPTFILENAME = "famb0110.jrf"; //Report File Name
        	...
        	{
        		application.GBL_RPTARGUMENT = application.GBL_RPTARGUMENT + 'sArg004,' + this.edtSHRACCT_INTL.value + "^";
        		application.GBL_RPTARGUMENT = application.GBL_RPTARGUMENT + 'sArg005,' + this.edtSHRACCT_NAME.value + "^";
        	}

        	application.GBL_RPTARGUMENT = application.GBL_RPTARGUMENT + 'sArg006,' + this.cmbSHRRELT_GUBN.text + "^";
        ...
        this.fn_FormLoadSetting = function (obj,e)
        {
        	...
        	if (this.sLoadForm == 'SHR') 
        	{
        		...
        		this.calSHRAPPT_TODT.set_value(this.sApprToDt);
        ...
        this.fn_CreateArgument = function (sKind)
        {
        	...
        	if (sKind == 'SEARCH00') 
        	{
        		...
        		sReturnString += " CUST_CODE=" + this.fnc_Quote(this.fnc_Trim(this.edtSHRCUST_CODE.value)); //거래처(관계사)
        	}
        ...
        this.fn_SetPopupArgument = function ()
        {
        	...
        	try 
        	{
        		...
        		// 
        		if (this.pApprToDt != null) 
        		{
        			this.sApprToDt = this.pApprToDt;
        		}
        		// 
        ...
        this.loadIncludeScript("FAMB0110.xfdl");
