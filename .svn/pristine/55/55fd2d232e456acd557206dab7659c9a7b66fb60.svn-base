/**
 * core.erp.hrm.service.impl.HRMD0100ServiceImpl.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	HRMD0100ServiceImpl - 근속현황(직급별/성별) 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	박철영
 * @since	2016.08.03
 * @version	1.0
 * @see		{@link HRMD0100Service}
 *
 * <pre>
...
@Service("HRMD0100Service")
public class HRMD0100ServiceImpl extends EgovAbstractServiceImpl implements HRMD0100Service {

	/**
	 * 근속현황(직급별/성별) DAO class inject.
	 */
	@Resource(name = "HRMD0100Dao")
	private HRMD0100Dao dao;
