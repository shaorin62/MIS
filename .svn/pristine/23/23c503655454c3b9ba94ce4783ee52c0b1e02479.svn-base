(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("BDMD0030.xfdl", "script::lib_script_common.xjs");
        this.registerScript("BDMD0030.xfdl", function() {
        /***************************************************************************************************
        ...
        this.loadIncludeScript("BDMD0030.xfdl");
