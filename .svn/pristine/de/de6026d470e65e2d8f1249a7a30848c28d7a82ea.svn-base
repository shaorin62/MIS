(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"164\"/><Column size=\"80\"/><Column size=\"164\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"23\" band=\"head\"/><Row size=\"20\"/><Row size=\"23\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"부서코드\"/><Cell col=\"1\" text=\"부서명\"/><Cell col=\"2\" text=\"계정과목\"/><Cell col=\"3\" text=\"계정명\"/><Cell col=\"4\" text=\"예산금액\"/><Cell col=\"5\" text=\"실적금액\"/><Cell col=\"6\" text=\"잔액\"/></Band><Band id=\"body\"><Cell edittype=\"none\" style=\"align:center;\" text=\"bind:DEPT_CODE\"/><Cell col=\"1\" edittype=\"none\" style=\"align:left;\" text=\"bind:DEPT_NAME\" expandshow=\"expr:dataset.getRowType(currow) == Dataset.ROWTYPE_INSERT? 'show' : 'hide'\" expandsize=\"20\" expandimage=\"URL('theme://imagesInbus\\imgHelpPopup.gif')\"/><Cell col=\"2\" edittype=\"none\" style=\"align:center;\" text=\"bind:ACCT_INTL\" expandshow=\"hide\"/><Cell col=\"3\" edittype=\"none\" style=\"align:left;\" text=\"bind:ACCT_BFNM\" expandshow=\"expr:dataset.getRowType(currow) == Dataset.ROWTYPE_INSERT? 'show' : 'hide'\" expandsize=\"20\" expandimage=\"URL('theme://imagesInbus\\imgHelpPopup.gif')\"/><Cell col=\"4\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:BUDG_AMNT\" mask=\"#,###\"/><Cell col=\"5\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:SLIP_AMNT\" mask=\"#,###\"/><Cell col=\"6\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:REMA_AMNT\" mask=\"#,###\"/></Band><Band id=\"summary\"><Cell colspan=\"4\" style=\"align:center;\" text=\"합계\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('BUDG_AMNT'), 0)\" mask=\"#,###\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('SLIP_AMNT'), 0)\" mask=\"#,###\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('REMA_AMNT'), 0)\" mask=\"#,###\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("BDMC0220.xfdl", "script::lib_script_common.xjs");
        this.registerScript("BDMC0220.xfdl", function() {
        ...
        this.sUSERLAVEL = '';
        this.sPACKAGENAME = 'BDMC0220'; //해당 Form에서 사용 할 Package 명
        ...
        this.fn_DeleteCheck = function ()
        {
        	...
        	else 
        	{
        		...
        		sQuestionText += ' 계정과목 (' + this.grdTB_CPLREQ.getCellText(0, this.fnc_GridColumnIndex(this.grdTB_CPLREQ, "ACCT_INTL")) + ')';
        		sQuestionText += ' 예산유형 (' + this.grdTB_CPLREQ.getCellText(0, this.fnc_GridColumnIndex(this.grdTB_CPLREQ, "BUDG_TYPE")) + ')';
        		sQuestionText += ' 순번 (' + this.grdTB_CPLREQ.getCellText(0, this.fnc_GridColumnIndex(this.grdTB_CPLREQ, "CPLT_SEQN")) + ')';
        ...
        this.fn_PostProcess = function (sMethodName)
        {
        	...
        	{
        		this.fnc_Information(this.stInformation2, this.dsTB_CPLREQ_DETAIL.rowcount, "SHR"); //fnc_Message("M1007", dsTA_SLIPNT.rowcount);                  //정상 종료 메세지
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdTB_CPLREQ_DETAIL.addEventHandler("onheadclick", this.fn_GridSort, this);
        ...
        this.loadIncludeScript("BDMC0220.xfdl");
