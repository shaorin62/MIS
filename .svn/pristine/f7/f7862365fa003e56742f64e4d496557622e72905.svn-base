/**
 * core.erp.tmm.web.PRPA0050Controller.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	PRPA0050Controller - 제작 결산관리  실적집계표 (팀별)
 * </pre>
 *
 * @author	오세훈
 * @since	2016.10.26
...
@Controller
public class PRPA0050Controller {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(PRPA0050Controller.class);

	/**
	 * 제작명세서  메뉴 서비스 클래스
	 */
	@Resource(name="PRPA0050Service")
	private PRPA0050Service service;

    /**
     * *********************************************************************************
	 * 제작 결산관리 실적집계표 (기획팀별)
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/PRPA0050/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/prp/PRPA0050_SEARCH00.do")
	 ...
	 * 제작 결산관리 실적집계표 (제작팀별)
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/PRPA0050/SEARCH01"
	 * @exception Exception - 조회시 발생한 예외
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/prp/PRPA0050_SEARCH01.do")
	@SuppressWarnings("rawtypes")
	...
	/**
     * *********************************************************************************
	 * 제작 결산관리 실적집계표 (제작팀별) 유비리포트
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/PRPA0050/PRINT00"
	 * @exception Exception - 조회시 발생한 예외
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/prp/PRPA0050_PRINT00.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/prp/PRPA0050_PRINT01.do")
	@SuppressWarnings("rawtypes")
