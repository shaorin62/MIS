/**
 * core.erp.mdm.web.MDME0020Controller.java - <Created by Code Template generator>
 */
...
import core.erp.mdm.service.MDME0020Service;
...
/**
 * <pre>
 *	MDME0020Controller - 옥외 거래명세서 프로그램 컨트롤러 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.10.20
...
@Controller
public class MDME0020Controller {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(MDME0020Controller.class);

	/**
	 * 옥외 개별청약(신규) 메뉴 서비스 클래스
	 */
	@Resource(name="MDME0020Service")
	private MDME0020Service service;

    /**
	 * 옥외 개별청약 목록을 조회한다.
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/MDME0020/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDME0020_SEARCH00.do")
	 ...
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/MDME0020/SEARCH01"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDME0020_SEARCH01.do")
	@SuppressWarnings("rawtypes")
	public ModelAndView processSEARCH01(CoreRequest coreRequest, ModelMap model) throws Exception {
	 ...
	 /**
		 ...
		 * @param param - 조회할 정보가 담긴 Map 객체
		 * @return "/MDME0020/SEARCH02"
		 * @exception Exception - 조회시 발생한 예외
		 */
		@RequestMapping(value = "/core/erp/mdm/MDME0020_SEARCH02.do")
		@SuppressWarnings("rawtypes")
		 ...
		 * @exception Exception - 조회시 발생한 예외
		 */
		@RequestMapping(value = "/core/erp/mdm/MDME0020_SEARCH03.do")
		@SuppressWarnings("rawtypes")
	 ...
	 */
	@RequestMapping(value = "/core/erp/mdm/MDME0020_SAVE00.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDME0020_SAVE01.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDME0020_SAVE02.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDME0020_SAVE03.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDME0020_UPDATE10.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/mdm/MDME0020_PRINT00.do")
	@SuppressWarnings("rawtypes")
