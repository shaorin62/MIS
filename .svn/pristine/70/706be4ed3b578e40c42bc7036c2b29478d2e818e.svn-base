    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FAMB0115");
                this.set_titletext("특수관계자거래내역");
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"170\"/><Column size=\"140\"/><Column size=\"140\"/><Column size=\"140\"/><Column size=\"140\"/></Columns><Rows><Row size=\"23\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"20\"/><Row size=\"23\" band=\"summ\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" displaytype=\"text\" text=\"관계사\" taborder=\"undefined\"/><Cell col=\"1\" colspan=\"2\" displaytype=\"text\" text=\"당   기\" taborder=\"undefined\"/><Cell col=\"3\" colspan=\"2\" displaytype=\"text\" text=\"전   기\" taborder=\"undefined\"/><Cell row=\"1\" col=\"1\" text=\"매출\"/><Cell row=\"1\" col=\"2\" text=\"매입 등\"/><Cell row=\"1\" col=\"3\" text=\"매출\"/><Cell row=\"1\" col=\"4\" text=\"매입 등\"/></Band><Band id=\"body\"><Cell displaytype=\"combo\" style=\"align:left;\" text=\"bind:RELT_GUBN\" combodataset=\"dsRELT_GUBN\" combocodecol=\"SUBCODE\" combodatacol=\"SUBNAME\"/><Cell col=\"1\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SLIP_AMNT\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SLIP_AMNT2\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SLIP_AMNT3\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SLIP_AMNT4\"/></Band><Band id=\"summary\"><Cell displaytype=\"text\" style=\"align:center;\" text=\"합계\"/><Cell col=\"1\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getCaseSum(&quot;getRowLevel(currow)==0&quot;, &quot;SLIP_AMNT&quot;, 0)\"/><Cell col=\"2\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getCaseSum(&quot;getRowLevel(currow)==0&quot;, &quot;SLIP_AMNT2&quot;, 0)\"/><Cell col=\"3\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getCaseSum(&quot;getRowLevel(currow)==0&quot;, &quot;SLIP_AMNT3&quot;, 0)\"/><Cell col=\"4\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getCaseSum(&quot;getRowLevel(currow)==0&quot;, &quot;SLIP_AMNT4&quot;, 0)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormTitle", "absolute", "8", "0", null, "29", "8", null, this);
            obj.set_text("특수관계자거래내역");
            ...
            obj = new Calendar("calSHRAPPT_TODT", "absolute", "385", "68", "94", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("25");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormSearchItemCalendar");

            obj = new Static("Static36", "absolute", "366", "68", "16", "22", null, null, this);
            ...
            obj = new Calendar("calSHRAPPR_FRDT", "absolute", "269", "68", "94", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("27");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormSearchItemCalendar");

            obj = new Static("Static02", "absolute", "207", "68", "60", "22", null, null, this);
            ...
            obj = new Static("Static00", "absolute", "392", "112", "60", "22", null, null, this);
            ...
            obj = new Edit("edtSHRACCT_NAME", "absolute", "752", "68", "135", "22", null, null, this);
            obj.set_taborder("34");
            ...
            obj = new ImageViewer("imgHelpSHRACCT_INTL", "absolute", "729", "68", "22", "22", null, null, this);
            obj.set_taborder("35");
            ...
            obj = new Edit("edtSHRACCT_INTL", "absolute", "648", "68", "80", "22", null, null, this);
            obj.set_taborder("36");
            obj.set_autoselect("true");
            obj.set_cssclass("styFormSearchItem");
        ...
        // User Script
        this.addIncludeScript("FAMB0115.xfdl", "script::lib_script_common.xjs");
        this.registerScript("FAMB0115.xfdl", function() {
        ...
        // this.sPACKAGENAME = 'erp.u.fam.b.ab.FAMB0115AB'; //해당 Form에서 사용 할 Package 명
        this.sBUTTONLIST = 'TTFFFFTT'; //Button 사용여부 순서(종료, 조회, 입력, 삭제, 취소, 저장, 엑셀, 인쇄)
        this.sPACKAGENAME = 'FAMB0115'; //해당 Form에서 사용 할 Package 명
        ...
        this.fn_Print = function (obj,e)
        {
        	...
        	application.GBL_RPTFILENAME = "famb0115.jrf"; //Report File Name
        	...
        	application.dialog("특수관계자거래내역", "popup::comReportViewer.xfdl", this, "", strOpenStyle);
        }
        ...
        this.fn_CreateArgument = function (sKind)
        {
        	...
        	if (sKind == 'SEARCH00') 
        	{
        		...
        		sReturnString += " ACCT_NAME=" + this.fnc_Quote(this.fnc_Trim(this.edtSHRACCT_NAME.value)); //차입금명
        	}
        ...
        this.fn_PostProcess = function (sMethodName)
        {
        	if (sMethodName == 'SEARCH00') 
        	{
        		...
        		trace(this.dsTA_SLIPNT.saveXML());
        	}
        ...
        this.grd_OnCellDBLClick = function (obj,e)
        {
        	...
        	else if (this.fnc_GridColumnIndex(obj, "SLIP_AMNT3") == e.cell) 
        	{
        		...
        		sApprToDt = (this.fnc_Left(this.calSHRAPPT_TODT.value, 4) - 1) + this.fnc_SubStr(this.calSHRAPPT_TODT.value, 4, 4);
        	}
        ...
        this.loadIncludeScript("FAMB0115.xfdl");
