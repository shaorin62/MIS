    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("BDMC0040");
                this.set_titletext("프로젝트실적상세현황");
            ...
            obj = new Grid("grdTB_PJBGXM", "absolute", "8", "180", null, "249", "8", null, this);
            ...
            obj.getSetter("autofitminwidth").set("970");
            obj.set_cssclass("styGrid01");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\" band=\"left\"/><Column size=\"159\" band=\"left\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"60\"/><Column size=\"100\"/><Column size=\"60\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"23\" band=\"head\"/><Row size=\"20\"/><Row size=\"23\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"프로젝트코드\"/><Cell col=\"1\" text=\"프로젝트명\"/><Cell col=\"2\" text=\"예산시작일\"/><Cell col=\"3\" text=\"예산종료일\"/><Cell col=\"4\" text=\"부서코드\"/><Cell col=\"5\" text=\"부서명\"/><Cell col=\"6\" text=\"계정과목\"/><Cell col=\"7\" text=\"계정명\"/><Cell col=\"8\" text=\"기본예산\"/><Cell col=\"9\" text=\"추가예산\"/><Cell col=\"10\" text=\"예산합계\"/><Cell col=\"11\" text=\"실적금액\"/><Cell col=\"12\" text=\"잔액\"/></Band><Band id=\"body\"><Cell edittype=\"none\" style=\"align:center;\" text=\"bind:PROJ_CODE\"/><Cell col=\"1\" edittype=\"none\" style=\"align:left;\" text=\"bind:PROJ_NAME\" expandshow=\"expr:dataset.getRowType(currow) == Dataset.ROWTYPE_INSERT? 'show' : 'hide'\" expandsize=\"20\" expandimage=\"URL('theme://imagesInbus\\imgHelpPopup.gif')\"/><Cell col=\"2\" displaytype=\"date\" edittype=\"none\" text=\"bind:CONT_STDT\" combodataset=\"dsBUDG_TYPE\" combocodecol=\"SUBCODE\" combodatacol=\"SUBNAME\" calendardisplaynulltype=\"none\"/><Cell col=\"3\" displaytype=\"date\" edittype=\"none\" text=\"bind:CONT_EDDT\" combodataset=\"dsBUDG_TYPE\" combocodecol=\"SUBCODE\" combodatacol=\"SUBNAME\" calendardisplaynulltype=\"none\"/><Cell col=\"4\" edittype=\"none\" style=\"align:center;\" text=\"bind:DEPT_CODE\"/><Cell col=\"5\" edittype=\"none\" style=\"align:left;\" text=\"bind:DEPT_NAME\" expandshow=\"expr:dataset.getRowType(currow) == Dataset.ROWTYPE_INSERT? 'show' : 'hide'\" expandsize=\"20\" expandimage=\"URL('theme://imagesInbus\\imgHelpPopup.gif')\"/><Cell col=\"6\" edittype=\"none\" style=\"align:center;\" text=\"bind:ACCT_INTL\"/><Cell col=\"7\" edittype=\"none\" style=\"align:left;\" text=\"bind:ACCT_BFNM\" expandshow=\"expr:dataset.getRowType(currow) == Dataset.ROWTYPE_INSERT? 'show' : 'hide'\" expandsize=\"20\" expandimage=\"URL('theme://imagesInbus\\imgHelpPopup.gif')\"/><Cell col=\"8\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:BUDG_AMNT\" mask=\"#,###\"/><Cell col=\"9\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:ADDX_AMNT\" mask=\"#,###\"/><Cell col=\"10\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:TOTA_AMNT\" mask=\"#,###\"/><Cell col=\"11\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:SLIP_AMNT\" mask=\"#,###\"/><Cell col=\"12\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:REMA_AMNT\" mask=\"#,###\"/></Band><Band id=\"summary\"><Cell colspan=\"2\" style=\"align:center;\" text=\"합계\"/><Cell col=\"2\" style=\"align:center;\"/><Cell col=\"3\" style=\"align:center;\"/><Cell col=\"4\" style=\"align:center;\"/><Cell col=\"5\" style=\"align:center;\"/><Cell col=\"6\" style=\"align:center;\"/><Cell col=\"7\" style=\"align:center;\"/><Cell col=\"8\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('BUDG_AMNT'), 0)\"/><Cell col=\"9\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('ADDX_AMNT'), 0)\"/><Cell col=\"10\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('TOTA_AMNT'), 0)\"/><Cell col=\"11\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('SLIP_AMNT'), 0)\"/><Cell col=\"12\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('REMA_AMNT'), 0)\"/><Cell col=\"13\" displaytype=\"number\" style=\"align:center;\" expr=\"expr:nexacro.toNumber(dataset.getSum('BUDG_AMNT'), 0)\"/><Cell col=\"14\" style=\"align:center;\"/><Cell col=\"15\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('BUDG_AMNT'), 0)\" mask=\"#,###\"/><Cell col=\"16\" colspan=\"3\" style=\"align:center;\" text=\"합계\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stInformation2", "absolute", "8", "433", "240", "20", null, null, this);
            obj.set_text("* 00건이 조회 되었습니다.");
            obj.style.set_align("middle left");
            obj.set_cssclass("styFormSearchInfo");
            this.addChild(obj.name, obj);

            obj = new Grid("grdTA_SLIPNT", "absolute", "8", "456", null, null, "8", "8", this);
            obj.set_taborder("9");
            obj.set_tabstop("true");
            ...
            obj = new Edit("edtSHRDEPT_CODE", "absolute", "520", "92", "108", "22", null, null, this);
            obj.set_taborder("29");
            obj.set_autoselect("true");
            ...
            obj = new Edit("edtSHRDEPT_NAME", "absolute", "652", "92", "188", "22", null, null, this);
            obj.set_taborder("30");
            ...
            obj = new Static("Static0", "absolute", "470", "92", "50", "22", null, null, this);
            obj.set_taborder("31");
            obj.set_text("부서");
            ...
            obj = new Static("Static01", "absolute", "16", "116", "75", "22", null, null, this);
            obj.set_taborder("32");
            obj.set_text("계정과목");
            obj.set_cssclass("styFormSearchCap");
            obj.style.set_align("left");
            ...
            obj = new Edit("edtSHRACCT_INTL", "absolute", "93", "116", "112", "22", null, null, this);
            obj.set_taborder("33");
            obj.set_autoselect("true");
            obj.set_cssclass("styFormItemText");
            obj.set_enable("false");
            ...
            obj = new Edit("edtSHRACCT_BFNM", "absolute", "229", "116", "202", "22", null, null, this);
            obj.set_taborder("34");
            obj.set_imemode("hangul");
            ...
            obj = new Static("Static03", "absolute", "275", "68", null, "22", "701", null, this);
            obj.set_taborder("35");
            obj.set_text("예산기간");
            obj.set_cssclass("styFormSearchCap");
            obj.style.set_align("left");
            ...
            obj = new Calendar("calSHRCOND_FROM", "absolute", "347", "68", "105", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("36");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormItemCalendar");

            obj = new Static("Static15", "absolute", "450", "68", "15", "22", null, null, this);
            obj.set_taborder("37");
            obj.set_text("~");
            obj.style.set_align("center middle");
            this.addChild(obj.name, obj);

            obj = new Calendar("calSHRCOND_TOXX", "absolute", "468", "68", "105", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("38");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormItemCalendar");

            obj = new Static("Static04", "absolute", "16", "92", "75", "22", null, null, this);
            obj.set_taborder("39");
            obj.set_text("프로젝트");
            obj.set_cssclass("styFormSearchCap");
            obj.style.set_align("left");
            ...
            obj = new Edit("edtSHRPROJ_CODE", "absolute", "93", "92", "112", "22", null, null, this);
            obj.set_taborder("40");
            obj.set_autoselect("true");
            obj.set_cssclass("styFormItemText");
            obj.set_enable("false");
            ...
            obj = new Edit("edtSHRPROJ_NAME", "absolute", "229", "92", "202", "22", null, null, this);
            obj.set_taborder("41");
            obj.set_imemode("hangul");
            obj.set_maxlength("100");
            obj.set_autoselect("true");
            ...
            obj = new Static("Static02", "absolute", "598", "68", "75", "22", null, null, this);
            obj.set_taborder("42");
            obj.set_text("기준일자");
            obj.set_cssclass("styFormSearchCap");
            obj.style.set_align("left");
            ...
            obj = new Calendar("calSHRSLIP_DATE", "absolute", "676", "68", "105", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("43");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormItemCalendar");

            obj = new Static("Static2", "absolute", "804", "68", "75", "22", null, null, this);
            obj.set_taborder("44");
            obj.set_text("승인여부");
            obj.set_cssclass("styFormSearchCap");
            obj.style.set_align("left");
            ...
            obj = new Combo("cmbSHRAPPR_YSNO", "absolute", "878", "68", "100", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("45");
            ...
            obj = new Static("imgHelpSHRPROJ_NAME", "absolute", "206", "92", "22", "22", null, null, this);
            obj.set_taborder("46");
            obj.set_cssclass("sytHelpPopup");
            obj.style.set_border("0 none #808080ff");
            this.addChild(obj.name, obj);

            obj = new Static("imgHelpSHRACCT_BFNM", "absolute", "206", "116", "22", "22", null, null, this);
            obj.set_taborder("47");
            obj.set_cssclass("sytHelpPopup");
            obj.style.set_border("0 none #808080ff");
            this.addChild(obj.name, obj);

            obj = new Static("imgHelpSHRDEPT_NAME", "absolute", "629", "92", "22", "22", null, null, this);
            obj.set_taborder("48");
            obj.set_cssclass("sytHelpPopup");
            obj.style.set_border("0 none #808080ff");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stInformation", "absolute", "8", "157", "241", "23", null, null, this);
            obj.set_taborder("51");
            obj.set_text("* 00건이 조회 되었습니다.");
            obj.set_cssclass("styFormSearchInfo");
            obj.style.set_align("middle left");
            ...
            obj = new Static("Image0", "absolute", "8", "146", null, "3", "8", null, this);
            obj.set_taborder("52");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","edtSHRPROJ_CODE","value","dsTM_PROJXM","COND_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","edtSHRPROJ_NAME","value","dsTM_PROJXM","DEPT_NAME");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("BDMC0040.xfdl", "script::lib_script_common.xjs");
        this.registerScript("BDMC0040.xfdl", function() {
        ...
        ************************/
        ...
        this.sUSERLAVEL = '';
        this.sPACKAGENAME = 'BDMC0040'; //해당 Form에서 사용 할 Package 명
        ...
        this.fn_FormLoadSetting = function (obj,e)
        {
        	...
        	//this.fnc_GridKeyFieldDisable(this.grdTB_PJBGXM, "PROJ_NAME", "edittype", "normal");
        	//this.fnc_GridKeyFieldDisable(this.grdTB_PJBGXM, "PROJ_NAME", "expandshow", "show");
        	//this.fnc_GridKeyFieldDisable(this.grdTB_PJBGXM, "ACCT_BFNM", "edittype", "normal");
        	//this.fnc_GridKeyFieldDisable(this.grdTB_PJBGXM, "ACCT_BFNM", "expandshow", "show");
        	//this.fnc_GridKeyFieldDisable(this.grdTB_PJBGXM, "DEPT_NAME", "edittype", "normal");
        	//this.fnc_GridKeyFieldDisable(this.grdTB_PJBGXM, "DEPT_NAME", "expandshow", "show");

        	// fnc_GridKeyFieldDisable(grdTB_PJBGXM, "BUDG_STYM", "edittype", "mask");
        	// fnc_GridKeyFieldDisable(grdTB_PJBGXM, "BUDG_ENYM", "edittype", "mask");

        	this.calSHRCOND_FROM.set_value((this.fnc_SubStr(this.fnc_GetServerDateTime("date"), 0, 4) + '0101')); //조회 초기값
        	this.calSHRCOND_TOXX.set_value(this.fnc_SubStr(this.fnc_GetServerDateTime("date"), 0, 8)); //조회 초기값

        	this.calSHRSLIP_DATE.set_value(this.fnc_SubStr(this.fnc_GetServerDateTime("date"), 0, 8)); //조회 초기값
        ...
        this.fn_Search = function (obj,e)
        {
        	...
        	var sInDataSet = "";
        	var sOutDataSet = "dsTB_PJBGXM=dsTB_PJBGXM";
        	var sArgument = this.fn_CreateArgument(sMethodName);
        	this.fnc_TransactionCall(this, this.sPACKAGENAME, sMethodName, sInDataSet, sOutDataSet, sArgument, "fn_CallBack");

        	// grdTB_PJBGXM.setFocus();                                   //재 클릭 방지를 위해 Focus 이동
        ...
        {
        	var nRow = this.dsTB_PJBGXM.addRow();
        	// dsTB_PJBGXM.setColumn(nRow, 'REQU_DATE', gfn_SubStr(gfn_Today(), 0, 8));
        	// dsTB_PJBGXM.setColumn(nRow, 'BUDG_STYM', gfn_SubStr(gfn_Today(), 0, 6));
        	// dsTB_PJBGXM.setColumn(nRow, 'BUDG_ENYM', gfn_SubStr(gfn_Today(), 0, 6));

        
        	this.grdTB_PJBGXM.setFocus(); //재 클릭 방지를 위해 Focus 이동
        	this.grdTB_PJBGXM.setCellPos(this.fnc_GridColumnIndex(this.grdTB_PJBGXM, "PROJ_NAME"));
        }
        ...
        {
        	// 삭제 할 자료가 있는지 여부를 체크
        	if (this.dsTB_PJBGXM.getRowCount() > 0) 
        	{
        		if (this.fn_DeleteCheck()) 
        		{
        			this.dsTB_PJBGXM.deleteRow(this.dsTB_PJBGXM.rowposition);
        		}
        		// 삭제 여부 확인
        	}
        	else 
        	...
        	this.grdTB_PJBGXM.setFocus(); //Record 삭제 후 Grid로 Focus
        }
        ...
        {
        	this.fnc_DataSetCancel("dsTB_PJBGXM"); //취소 할 DataSet의 이름을 입력한다.
        	this.grdTB_PJBGXM.setFocus(); //취소 후 Grid로 Focus
        }
        ...
        this.fn_Save = function (obj,e)
        {
        	...
        	var sInDataSet = "dsTB_PJBGXM=dsTB_PJBGXM:U";
        	var sOutDataSet = "";
        	var sArgument = this.fn_CreateArgument(sMethodName);
        	this.fnc_TransactionCall(this, this.sPACKAGENAME, sMethodName, sInDataSet, sOutDataSet, sArgument, "fn_CallBack");
        ...
        this.fn_FormUnloadCheckProcess = function (obj,e)
        {
        	...
        	var sMessage = this.fnc_FormUnloadCheck("dsTB_PJBGXM", this);
        ...
        this.fn_SearchItemCheck = function ()
        {
        	...
        	/*if (this.fnc_Length(this.fnc_Trim(this.calSHRCOND_FROM.value)) < 1) 
        	{
        		this.fnc_Message("M1005", '예산기간');
        		this.calSHRCOND_FROM.setFocus();
        		return false;
        	}

        	if (this.fnc_Length(this.fnc_Trim(this.calSHRCOND_TOXX.value)) < 1) 
        	{
        		this.fnc_Message("M1005", '예산기간');
        		this.calSHRCOND_TOXX.setFocus();
        		return false;
        	}

        	if (this.calSHRCOND_TOXX.value < this.calSHRCOND_FROM.value) 
        	{
        		this.fnc_Message("M1046", '예산기간 시작일은 종료일 이전이어야 합니다.');
        		this.calSHRCOND_FROM.setFocus();
        		return false;
        	}*/
        ...
        {
        	// 선택된 Row Count
        	var iSelectRowCount = this.fnc_SelectRowCount("dsTB_PJBGXM");
        	...
        	else 
        	{
        		...
        		var sQuestionText = '프로젝트코드 (' + this.fnc_Trim(this.dsTB_PJBGXM.getColumn(this.dsTB_PJBGXM.rowposition, "PROJ_CODE")) + ')';
        		sQuestionText += '부서코드 (' + this.fnc_Trim(this.dsTB_PJBGXM.getColumn(this.dsTB_PJBGXM.rowposition, "DEPT_CODE")) + ')';
        		sQuestionText += ' 계정과목 (' + this.grdTB_PJBGXM.getCellText(0, this.fnc_GridColumnIndex(this.grdTB_PJBGXM, "ACCT_INTL")) + ')';
        ...
        {
        	// 변경된 자료가 있는지 체크
        	if (!this.fnc_DatasetChangeCheck("dsTB_PJBGXM")) 
        	{
        		// 저장 할 자료가 없음
        	...
        	// 필수 입력 항목 체크
        	for (var i = 0; i < this.dsTB_PJBGXM.getRowCount(); i++) 
        	{
        		// if (gfn_ToUpper(GetRowType(dsTB_PJBGXM,i)) == "NORMAL") continue;
        		if (this.fnc_ToUpper(this.dsTB_PJBGXM.getRowType(this.dsTB_PJBGXM, i)) != "NORMAL") 
        		{
        			if (this.fnc_Length(this.fnc_Trim(this.dsTB_PJBGXM.getColumn(i, 'PROJ_NAME'))) < 1) 
        			{
        				return this.fnc_CheckPostAction("M1005", "프로젝트명", this.dsTB_PJBGXM, i, this.grdTB_PJBGXM, 'PROJ_NAME');
        			}

        			if (this.fnc_Length(this.fnc_Trim(this.dsTB_PJBGXM.getColumn(i, 'PROJ_CODE'))) < 1) 
        			{
        				return this.fnc_CheckPostAction("M1005", "프로젝트코드", this.dsTB_PJBGXM, i, this.grdTB_PJBGXM, 'PROJ_CODE');
        			}

        			if (this.fnc_Length(this.fnc_Trim(this.dsTB_PJBGXM.getColumn(i, 'DEPT_NAME'))) < 1) 
        			{
        				return this.fnc_CheckPostAction("M1005", "부서명", this.dsTB_PJBGXM, i, this.grdTB_PJBGXM, 'DEPT_NAME');
        			}

        			if (this.fnc_Length(this.fnc_Trim(this.dsTB_PJBGXM.getColumn(i, 'DEPT_CODE'))) < 1) 
        			{
        				return this.fnc_CheckPostAction("M1005", "부서코드", this.dsTB_PJBGXM, i, this.grdTB_PJBGXM, 'DEPT_CODE');
        			}

        			if (this.fnc_Length(this.fnc_Trim(this.dsTB_PJBGXM.getColumn(i, 'ACCT_BFNM'))) < 1) 
        			{
        				return this.fnc_CheckPostAction("M1005", "계정과목명", this.dsTB_PJBGXM, i, this.grdTB_PJBGXM, 'ACCT_BFNM');
        			}

        			if (this.fnc_Length(this.fnc_Trim(this.dsTB_PJBGXM.getColumn(i, 'ACCT_INTL'))) < 1) 
        			{
        				return this.fnc_CheckPostAction("M1005", "계정과목", this.dsTB_PJBGXM, i, this.grdTB_PJBGXM, 'ACCT_INTL');
        			}

        			if (nexacro.toNumber(this.fnc_Trim(this.dsTB_PJBGXM.getColumn(i, 'BUDG_AMNT')), 0) == 0) 
        			{
        				return this.fnc_CheckPostAction("M1005", "예산금액", this.dsTB_PJBGXM, i, this.grdTB_PJBGXM, 'BUDG_AMNT');
        			}

        			if (this.fnc_Length(this.fnc_Trim(this.dsTB_PJBGXM.getColumn(i, 'REMK_NOTE'))) < 1) 
        			{
        				return this.fnc_CheckPostAction("M1005", "비고", this.dsTB_PJBGXM, i, this.grdTB_PJBGXM, 'REMK_NOTE');
        			}
        		}
        	}
        	return true;
        ...
        {
        	var sReturnString;
        	var COND_FROM = this.fnc_SubStr(this.calSHRCOND_FROM.value, 0, 8);
        	var COND_TOXX = this.fnc_SubStr(this.calSHRCOND_TOXX.value, 0, 8);
        	...
        	if (sKind == 'SEARCH00') 
        	{
        		...
        		sReturnString += " COND_FROM=" + this.fnc_Quote(COND_FROM); //예산연월 시작
        		sReturnString += " COND_TOXX=" + this.fnc_Quote(COND_TOXX); //예산연월 종료
        		...
        		sReturnString += " PROJ_CODE=" + this.fnc_Quote(this.edtSHRPROJ_CODE.value); //프로젝트코드
        		sReturnString += " APPR_YSNO=" + this.fnc_Quote(this.cmbSHRAPPR_YSNO.value); //계정과목
        		sReturnString += " SLIP_DATE=" + this.fnc_Quote(this.calSHRSLIP_DATE.value); //프로젝트코드
        	...
        	{
        		var PROJ_CODE = this.dsTB_PJBGXM.getColumn(this.dsTB_PJBGXM.rowposition, 'PROJ_CODE');
        		var DEPT_CODE = this.dsTB_PJBGXM.getColumn(this.dsTB_PJBGXM.rowposition, 'DEPT_CODE');
        		var ACCT_INTL = this.dsTB_PJBGXM.getColumn(this.dsTB_PJBGXM.rowposition, 'ACCT_INTL');
        		...
        		sReturnString += " ACCT_INTL=" + this.fnc_Quote(ACCT_INTL); //계정과목
        		sReturnString += " PROJ_CODE=" + this.fnc_Quote(PROJ_CODE); //프로젝트코드
        		sReturnString += " APPR_YSNO=" + this.fnc_Quote(this.cmbSHRAPPR_YSNO.value); //계정과목
        		sReturnString += " SLIP_DATE=" + this.fnc_Quote(this.calSHRSLIP_DATE.value); //프로젝트코드
        ...
        this.fn_PostProcess = function (sMethodName)
        {
        	...
        	{
        		this.fnc_Information(this.stInformation, this.dsTB_PJBGXM.rowcount, "SHR"); //조회 결과 Display
        		this.fnc_Message("M1007", this.dsTB_PJBGXM.rowcount); //정상 종료 메세지
        	}
        	...
        	else if (sMethodName == 'SAVE00') 
        	{
        		...
        		this.fnc_Message("M1008"); //fn_KeyFieldDisible(dsTB_PJBGXM,0,dsTB_PJBGXM.rowposition);
        ...
        this.fn_HelpDialoge = function (obj)
        {
        	...
        	switch (obj.name) 
        	{
        		case "imgHelpSHRPROJ_NAME":
        			// 프로젝트

        			sSearchKind = "BUDG01"; //프로젝트 POPUP
        			sInputValue = this.fnc_Trim(this.edtSHRPROJ_NAME.value); //검색 조건 Text
        			sCommonGubn = this.cmbSHRACCT_GUB1.value;
        			sResponse = this._HelpDialoge(sSearchKind, sInputValue, sCommonGubn, this.edtSHRPROJ_NAME); //Popup Open

        			if (this.fnc_Length(this.fnc_Trim(sResponse)) != 0) 
        			{
        				this.edtSHRPROJ_CODE.set_value(sResponse[0]); //프로젝트코드
        				this.edtSHRPROJ_NAME.set_value(sResponse[1]); //프로젝트명
        			}
        			break;
        		...
        		case "imgHelpSHRACCT_BFNM":
        			...
        			var sACCT_YEAR = this.fnc_SubStr(this.fnc_Trim(this.calSHRCOND_FROM.value), 0, 4);

        			sSearchKind = "ACCT11"; //계정과목 POPUP
        		...
        		case "grdTB_PJBGXM":
        			...
        			var sACCT_YEAR = this.fnc_SubStr(dsObj.getColumn(nRow, 'CONT_STDT'), 0, 4);

        			trace('currentcell columnID ---- ' + columnID);

        			if (columnID == 'PROJ_NAME') 
        			{
        				sSearchKind = "BUDG01"; //사용자 코드 조회 POPUP
        				sCommonGubn = this.cmbSHRACCT_GUB1.value;
        				sInputValue = dsObj.getColumn(nRow, 'PROJ_NAME');
        				sResponse = this._HelpDialoge(sSearchKind, sInputValue, sCommonGubn, obj); //Popup Open

        				if (this.fnc_Length(this.fnc_Trim(sResponse)) != 0) 
        				{
        					dsObj.setColumn(nRow, 'PROJ_CODE', sResponse[0]);
        					dsObj.setColumn(nRow, 'PROJ_NAME', sResponse[1]);
        					dsObj.setColumn(nRow, 'CONT_STDT', sResponse[2]);
        					dsObj.setColumn(nRow, 'CONT_EDDT', sResponse[3]);
        				}
        			}

        			else if (columnID == 'DEPT_NAME') 
        			{
        			...
        			{
        				sSearchKind = "ACCT11"; //사용자 코드 조회 POPUP
        				sCommonGubn = sACCT_YEAR; //공통 구분 코드(공통코드 조회가 아니면 null)
        ...
        this.fn_CodeNameDisplay = function (obj)
        {
        	...
        	switch (obj.name) 
        	{
        		case "grdTB_PJBGXM":
        			...
        			if (columnID == 'PROJ_NAME') 
        			{
        				sSearchKind = "BUDG01"; //팝업ID
        				sCommonGubn = this.cmbSHRACCT_GUB1.value;
        				sInputValue = dsObj.getColumn(nRow, 'PROJ_NAME');
        				application.GBL_REVOBJ1 = "PROJ_CODE"; //프로젝트코드
        				application.GBL_REVOBJ2 = "PROJ_NAME"; //프로젝트명
        				application.GBL_REVOBJ3 = "CONT_STDT"; //계약시작일
        				application.GBL_REVOBJ4 = "CONT_EDDT"; //계약종료일
        			}
        			else if (columnID == 'DEPT_NAME') 
        			{
        			...
        			break;
        		case "edtSHRPROJ_NAME":
        			// 
        			sSearchKind = "BUDG01";
        			sCommonGubn = this.cmbSHRACCT_GUB1.value;
        			application.GBL_REVOBJ1 = "edtSHRPROJ_CODE"; //프로젝트코드
        			application.GBL_REVOBJ2 = "edtSHRPROJ_NAME"; //프로젝트코드명
        			break;
        ...
        this.fn_ColumnChanged = function (obj,e)
        {
        	...
        	// var nRow = e.row;
        	// 
        	// if (strColumnID =='PROJ_NAME')
        	// {
        	// fn_CodeNameDisplay(grdTB_PJBGXM);
        	// return;
        	// }
        	// else if (strColumnID =='DEPT_NAME')
        	// {
        	// fn_CodeNameDisplay(grdTB_PJBGXM);
        	// return;
        	// }
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdTB_PJBGXM.addEventHandler("onheadclick", this.fn_GridSort, this);
            this.grdTB_PJBGXM.addEventHandler("onexpanddown", this.fn_HelpDialoge, this);
            ...
            this.edtSHRPROJ_CODE.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            this.edtSHRPROJ_NAME.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            this.edtSHRPROJ_NAME.addEventHandler("onkillfocus", this.fn_CodeNameDisplay, this);
            this.cmbSHRAPPR_YSNO.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            this.imgHelpSHRPROJ_NAME.addEventHandler("onclick", this.fn_HelpDialoge, this);
        ...
        this.loadIncludeScript("BDMC0040.xfdl");
