/**
 * core.erp.mdm.service.impl.MDMA0011Dao.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	MDMA0011Dao - 전파 일괄청약(신규) 프로그램 데이터처리 DAO 클래스
 * </pre>
 * 
 * @author	최제현
 * @since	2016.11.01
...
@Repository("MDMA0011Dao")
public class MDMA0011Dao extends CmmBaseDAO {
	...
	public Object processSEARCH00(Map searchVo) throws Exception {
		...
		return list("MDMA0011.SEARCH00", searchVo);
	}
	...
	public Object processSEARCH01(Map searchVo) throws Exception {
		...
		return list("MDMA0011.SEARCH01", searchVo);
	}
	...
	public Object processSAVE00(Map dataVo) throws Exception {
		return insert("MDMA0011.SAVE00", dataVo);
	}
	...
	public Object processSAVE01(Map dataVo) throws Exception {
		return insert("MDMA0011.SAVE01", dataVo);
	}
	...
	public Object processSAVE02(Map dataVo) throws Exception {
		return insert("MDMA0011.SAVE02", dataVo);
	}
	...
	public int processUPDATE10(Map dataVo) throws Exception {
		...
		return update("MDMA0011.UPDATE10", dataVo);
	...
	public int processUPDATE11(Map dataVo) throws Exception {
		...
		return update("MDMA0011.UPDATE11", dataVo);
	...
	public int processDELETE10() throws Exception {
		...
		return delete("MDMA0011.DELETE10");
	...
	public int processDELETE11() throws Exception {
		...
		return delete("MDMA0011.DELETE11");
	...
	public int processDELETE12(Map dataVo) throws Exception {
		...
		return delete("MDMA0011.DELETE12",dataVo);
	...
	public int processDELETE13(Map dataVo) throws Exception {
		...
		return delete("MDMA0011.DELETE13",dataVo);
	...
	public String processNEW_SEQX_FILD(Map searchVo) throws Exception {
		...
		return (String)selectByPk("MDMA0011.NEW_SEQX_FILD", searchVo);
	...
	public int processGET_MTTP_COUNT() throws Exception{
		...
		return (int)select("MDMA0011.GET_MTTP_COUNT");
	}	
	...
	public int processDELETE00(Map searchVo) throws Exception {
		//개별청약서의 데이터를 지운다.
		delete("MDMA0011.DELETE01",searchVo);
		//광고신탁집계표데이터삭제
		delete("MDMA0011.DELETE13");
		//소재별운행현황데이터삭제
		return delete("MDMA0011.DELETE00");
	...
	public int COUNT_MD_MATRXM() throws Exception{
		// TODO Auto-generated method stub
		return (int)select("MDMA0011.COUNT_MD_MATRXM");
	}	
	...
	public int COUNT_SBTPXM() throws Exception{
		// TODO Auto-generated method stub
		return (int)select("MDMA0011.COUNT_SBTPXM");
	}	
	...
	public int COUNT_ETMDXM(String YEAR_MNTH) throws Exception{
		// TODO Auto-generated method stub
		return (int)select("MDMA0011.COUNT_ETMDXM",YEAR_MNTH);
	}	
}
