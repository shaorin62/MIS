(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("HATC0010D01.xfdl", "script::lib_script_common.xjs");
        this.registerScript("HATC0010D01.xfdl", function() {
        /****************************************************************************************************
        /*
        ...
        this.sPACKAGENAME = "HATC0010D01"; //해당 Form에서 사용 할 Package 명 
        ...
        this.fn_FormLoadSetting = function (obj,e) {
        	...
        	*/
        	...
        	{		
        		...
        		case "KHR110":			
        			this.sAPPRGUBN = "show";
        			this.Div_Main.set_url("hat::HATC0020.xfdl");			
        			break;
        		//연차/휴가 신청서
        		case "KHR111":
        			this.sAPPRGUBN = "show";
        			this.Div_Main.set_url("hat::HATC0030.xfdl");
        			break;
        		//연차/휴가 취소신청서
        		case "KHR112":
        			this.sAPPRGUBN = "show";
        			this.Div_Main.set_url("hat::HATC0040.xfdl");
        			break;
        		default: 
        			this.sAPPRGUBN = "list";
        			this.Div_Main.set_url("hat::HATC0010.xfdl");
        			break;
        	}
        }
        ...
        this.fn_Input = function (obj) {  
        	...
        	if(lv_strDoc == "")
        	{
        		...
        		*/
        		...
        		this.Div_Main.cmbSHRDOCU_IDXX.setFocus();
        		return;
        	}
        ...
        this.loadIncludeScript("HATC0010D01.xfdl");
