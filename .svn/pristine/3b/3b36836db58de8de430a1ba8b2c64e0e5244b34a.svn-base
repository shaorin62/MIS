(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 1187, 717, this.Div_Main,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("0");
            		p.set_text("Div_Main");
        ...
        // User Script
        this.addIncludeScript("WFMB0020D01.xfdl", "script::lib_script_common.xjs");
        this.registerScript("WFMB0020D01.xfdl", function() {
        /****************************************************************************************************
        /*
        ...
        this.loadIncludeScript("WFMB0020D01.xfdl");
