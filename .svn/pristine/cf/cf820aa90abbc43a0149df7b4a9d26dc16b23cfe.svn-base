/**
 * core.erp.hrm.service.impl.HRMB0030ServiceImpl.java - <Created by Code Template generator>
 */
...
import core.erp.hrm.service.HRMB0030Service;
import egovframework.rte.fdl.cmmn.EgovAbstractServiceImpl;


/**
 * <pre>
 *	HRMB0030ServiceImpl - 가족사항변경요청 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	박철영
 * @since	2016.07.04
 * @version	1.0
 * @see		{@link HRMB0030Service}
 *
 * <pre>
...
@Service("HRMB0030Service")
public class HRMB0030ServiceImpl extends EgovAbstractServiceImpl implements HRMB0030Service {

	/**
	 * 가족사항변경요청 DAO class inject.
	 */
	@Resource(name = "HRMB0030Dao")
	private HRMB0030Dao dao;
	...
	public Object processSEARCH01(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsHR_FAMILY", dao.processSEARCH01(searchVo));
		return returnMap;
	...
	public Object processSEARCH02(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsHR_FMLYRQ", dao.processSEARCH02(searchVo));
		return returnMap;
	...
	public int processSAVE00(Map saveData, Map searchVo) throws Exception{
		...
		List dsHR_FMLYRQ     = (List) saveData.get("dsHR_FMLYRQ");  
		List dsHR_FMLYRQ_Del = (List) saveData.get("dsHR_FMLYRQ_DELETE");

		//DataSet의 Delete Row Count만큼 돌면서 Delete
        for (int i = 0; i < dsHR_FMLYRQ_Del.size(); i++) {

        	rowVo = (Map) dsHR_FMLYRQ_Del.get(i);
        ...
        //DataSet의 Row Count만큼 돌면서 Insert Or Update
		for (int i = 0; i < dsHR_FMLYRQ.size(); i++) {

			rowVo = (Map) dsHR_FMLYRQ.get(i);
			rowType = (Integer) rowVo.get("ROW_TYPE");
