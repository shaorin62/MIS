...
if (!nexacro.GroupBox) {
	...
	_pGroupBox.on_apply_style_rtlimagemirroring = function (rtlimagemirroring) {
		...
		if (this.mainStatic) {
			this.mainStatic.on_apply_style_rtlimagemirroring(rtlimagemirroring);
		}
		var titleButton = this.titleButton;
		if (titleButton) {
			titleButton.on_apply_style_rtlimagemirroring(rtlimagemirroring);
			var img_elem = titleButton._img_elem;
			if (img_elem) {
