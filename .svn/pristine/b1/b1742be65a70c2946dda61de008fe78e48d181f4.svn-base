(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnClose", "absolute", null, null, "62", "24", "15", "12", this);
            obj.set_taborder("37");
            obj.set_text("종료");
            obj.set_cssclass("btn_POP_CRUD");
            this.addChild(obj.name, obj);

            obj = new UbiReport("UbiViewer00", "absolute", "15", "15", null, null, "15", "44", this);
            obj.set_taborder("38");
            ...
            obj = new Static("Static07", "absolute", "736", "556", "64", "8", null, null, this);
            obj.set_taborder("42");
            obj.set_text("h 8");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static05", "absolute", "736", "588", "64", "12", null, null, this);
            obj.set_taborder("44");
            obj.set_text("h 12");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
        ...
        // User Script
        this.addIncludeScript("comUbiReportView.xfdl", "script::lib_script_common.xjs");
        this.registerScript("comUbiReportView.xfdl", function() {
        /***************************************************************************************************
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onkeydown", this.comUbiReportView_onkeydown, this);
            this.btnClose.addEventHandler("onclick", this.btnClose_onclick, this);

        };

        this.loadIncludeScript("comUbiReportView.xfdl");
