(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("MDME0010P01.xfdl", "script::lib_script_common.xjs");
        this.registerScript("MDME0010P01.xfdl", function() {
         /***************************************************************************************************
         * # Program : MDME0010P01 전체복사팝업
         * 
        ...
        this.loadIncludeScript("MDME0010P01.xfdl");
