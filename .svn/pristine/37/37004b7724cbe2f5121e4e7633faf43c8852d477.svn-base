    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("Temp00007M");
                this.set_titletext("그리드(세로3)");
            ...
            obj = new Static("Static95", "absolute", "8", "117", "205", "21", null, null, this);
            ...
            obj = new Static("Static10", "absolute", "393", "117", "215", "21", null, null, this);
            obj.set_taborder("123");
            obj.set_text("중분류");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00", "absolute", "393", "138", "375", null, null, "15", this);
            ...
            obj = new Static("Static11", "absolute", "788", "117", "215", "21", null, null, this);
            obj.set_taborder("127");
            obj.set_text("소분류");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid01", "absolute", "788", "138", null, null, "25", "15", this);
        ...
        this.loadIncludeScript("Temp00007M.xfdl");
