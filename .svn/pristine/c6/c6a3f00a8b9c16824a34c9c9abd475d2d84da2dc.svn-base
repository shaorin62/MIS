(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsEXPD_NAME1", this);
            ...
            obj = new Dataset("dsEXPD_NAME2", this);
            obj._setContents("<ColumnInfo><Column id=\"EXPD_NAME1\" size=\"100\" prop=\"default\" type=\"STRING\"/><Column id=\"EXPD_NAME2\" size=\"100\" prop=\"default\" type=\"STRING\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdPY_PAYEXP_D", "absolute", "201", "128", null, null, "312", "185", this);
            obj.set_autoenter("TRUE");
            obj.set_autofittype("col");
            ...
            obj.set_wheelscrollrow("1");
            obj.set_cssclass("styGrid01");
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"0\"/><Column size=\"100\"/><Column size=\"460\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell celltype=\"head\" displaytype=\"text\"/><Cell col=\"1\" displaytype=\"text\" text=\"공제항목\"/><Cell col=\"2\" displaytype=\"text\" text=\"계산식\"/></Band><Band id=\"body\"><Cell celltype=\"head\" displaytype=\"text\" style=\"align:left;\"/><Cell col=\"1\" displaytype=\"text\" style=\"align:left;background: ;\" text=\"bind:EXPD_NAME\" autosizerow=\"limitmax\"/><Cell col=\"2\" displaytype=\"text\" style=\"align:left;background: ;\" text=\"bind:APLY_MODN\" wordwrap=\"true\" autosizerow=\"limitmax\" autosizecol=\"default\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("grdEXPD_NAME1", "absolute", null, "128", "267", "160", "25", null, this);
            obj.set_autoenter("TRUE");
            obj.set_autofittype("col");
            obj.set_binddataset("dsEXPD_NAME1");
            ...
            obj.set_wheelscrollrow("1");
            obj.set_cssclass("styGrid01");
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"140\"/><Column size=\"140\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell celltype=\"head\" displaytype=\"text\" text=\"지급항목\"/><Cell col=\"1\" displaytype=\"text\"/></Band><Band id=\"body\"><Cell displaytype=\"button\" edittype=\"button\" style=\"align:center middle;color:#4d4d4dff;font:9 dotum;\" text=\"bind:EXPD_NAME1\"/><Cell col=\"1\" displaytype=\"button\" edittype=\"button\" style=\"align:center middle;color:#4d4d4dff;font:9 dotum;\" text=\"bind:EXPD_NAME2\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("grdFUNC_NAME", "absolute", null, "478", "267", null, "25", "15", this);
            obj.set_autoenter("TRUE");
            obj.set_autofittype("col");
            ...
            obj.set_wheelscrollrow("1");
            obj.set_cssclass("styGrid01");
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"140\"/><Column size=\"140\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell celltype=\"head\" displaytype=\"text\" text=\"정의함수\"/><Cell col=\"1\" displaytype=\"text\"/></Band><Band id=\"body\"><Cell displaytype=\"button\" edittype=\"button\" style=\"align:center middle;color:#4d4d4dff;font:9 dotum;\" text=\"bind:FUNC_NAME1\"/><Cell col=\"1\" displaytype=\"button\" edittype=\"button\" style=\"align:center middle;color:#4d4d4dff;font:9 dotum;\" text=\"bind:FUNC_NAME2\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdEXPD_NAME2", "absolute", null, "303", "267", "160", "25", null, this);
            obj.set_cssclass("styGrid01");
            obj.set_taborder("5");
            obj.set_tabstop("false");
            obj.set_binddataset("dsEXPD_NAME2");
            obj.set_wheelscrollrow("1");
            ...
            obj.getSetter("autofitminwidth").set("200");
            obj.set_tooltiptype("inplace");
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"140\"/><Column size=\"140\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell celltype=\"head\" displaytype=\"text\" text=\"공제항목\"/><Cell col=\"1\" displaytype=\"text\"/></Band><Band id=\"body\"><Cell displaytype=\"button\" edittype=\"button\" style=\"align:center middle;color:#4d4d4dff;font:9 dotum;\" text=\"bind:EXPD_NAME1\"/><Cell col=\"1\" displaytype=\"button\" edittype=\"button\" style=\"align:center middle;color:#4d4d4dff;font:9 dotum;\" text=\"bind:EXPD_NAME2\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static10", "absolute", "573", "532", "80", "15", null, null, this);
            obj.set_taborder("22");
            obj.set_text("h15");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static04", "absolute", "1022", "288", "80", "15", null, null, this);
            obj.set_taborder("28");
            obj.set_text("h15");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static05", "absolute", "1022", "463", "80", "15", null, null, this);
            obj.set_taborder("29");
            obj.set_text("h15");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new BindItem("txtAPLY_MODN_value","txtAPLY_MODN","value","dsPY_PAYEXP_D","APLY_MODN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("PAYA0100.xfdl", "script::lib_script_common.xjs");
        this.registerScript("PAYA0100.xfdl", function() {
        /***************************************************************************************************
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdEXPD_NAME1.addEventHandler("oncellclick", this.fn_SetExpression, this);
            ...
            this.grdEXPD_NAME2.addEventHandler("oncellclick", this.fn_SetExpression, this);
            this.btn_favorite.addEventHandler("onclick", this.btn_favorite_onclick, this);

        };

        this.loadIncludeScript("PAYA0100.xfdl");
