    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("PAYB0105");
                this.set_titletext("학자금대출상환관리");
            ...
            obj = new Dataset("dsPY_SISCXD_2", this);
            ...
            obj = new Grid("grdPY_SISCXM", "absolute", "8", "128", "772", null, null, "123", this);
            obj.set_autoenter("TRUE");
            obj.set_binddataset("dsPY_SISCXM");
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"0\"/><Column size=\"70\"/><Column size=\"60\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"85\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"130\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell celltype=\"head\" displaytype=\"text\"/><Cell col=\"1\" displaytype=\"text\" text=\"사원번호\"/><Cell col=\"2\" displaytype=\"text\" text=\"성명\"/><Cell col=\"3\" text=\"공제시작일\"/><Cell col=\"4\" text=\"공제종료일\"/><Cell col=\"5\" text=\"의무상환액\"/><Cell col=\"6\" text=\"월상환액\"/><Cell col=\"7\" text=\"상환금액\"/><Cell col=\"8\" displaytype=\"text\" text=\"잔액\"/><Cell col=\"9\" text=\"중도해지일\"/><Cell col=\"10\" text=\"완납여부\"/><Cell col=\"11\" text=\"비고\"/></Band><Band id=\"body\"><Cell celltype=\"head\" displaytype=\"normal\" style=\", 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));align:left;\"/><Cell col=\"1\" displaytype=\"text\" style=\"align:center;, 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:EMPL_NUMB\"/><Cell col=\"2\" displaytype=\"text\" style=\"align:center;, 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:EMPL_NAME\" editimemode=\"native\"/><Cell col=\"3\" displaytype=\"date\" text=\"bind:SIZR_DATE\" calendardisplaynulltype=\"none\"/><Cell col=\"4\" displaytype=\"date\" text=\"bind:CNAP_DATE\"/><Cell col=\"5\" displaytype=\"number\" style=\"align: ;\" text=\"bind:DMND_AMOT\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" text=\"bind:RPAY_AMOT\"/><Cell col=\"7\" displaytype=\"number\" style=\"align:right;\" text=\"bind:RPAY_AMO2\"/><Cell col=\"8\" displaytype=\"number\" style=\"align:right;\" text=\"bind:CHAG_AMOT\"/><Cell col=\"9\" displaytype=\"date\" text=\"bind:MWCN_DATE\" calendardisplaynulltype=\"none\"/><Cell col=\"10\" displaytype=\"checkbox\" style=\"align: ;\" text=\"bind:CMPL_YSNO\"/><Cell col=\"11\" style=\"align:left;\" text=\"bind:REMK_200X\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("cmbSHRCMPL_YSNO", "absolute", "688", "71", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("20");
            ...
            obj = new Grid("grdPY_SISCXD_1", "absolute", "800", "128", null, "218", "25", null, this);
            obj.set_autoenter("TRUE");
            obj.set_autofittype("col");
            obj.set_binddataset("dsPY_SISCXD_1");
            obj.set_cellsizingtype("both");
            obj.set_enable("true");
            ...
            obj = new Static("stGROP_LIST", "absolute", "800", "107", "93", "21", null, null, this);
            obj.set_taborder("29");
            obj.set_text("급여상환");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("stGROP_LIST00", "absolute", "800", "360", "93", "21", null, null, this);
            obj.set_taborder("30");
            obj.set_text("기타상환");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Shape01", "absolute", "8", null, "772", "93", null, "15", this);
            obj.set_taborder("33");
            obj.set_cssclass("styFormItemBoxOut");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "28", null, "96", "21", null, "50", this);
            obj.set_taborder("35");
            obj.set_text("의무상환액");
            obj.set_cssclass("styFormItemCap");
            this.addChild(obj.name, obj);

            obj = new Static("Static05", "absolute", "28", null, "96", "21", null, "78", this);
            obj.set_taborder("37");
            obj.set_text("사원번호");
            obj.set_cssclass("styFormItemCapBE");
            this.addChild(obj.name, obj);

            obj = new Edit("edtEMPL_NUMB", "absolute", "109", null, "80", "21", null, "78", this);
            obj.set_taborder("0");
            ...
            obj.getSetter("binddataset").set("dsPY_SISCXM");
            this.addChild(obj.name, obj);

            obj = new Static("Static21", "absolute", "342", null, "96", "21", null, "50", this);
            obj.set_taborder("39");
            obj.set_text("월상환액");
            obj.set_cssclass("styFormItemCap");
            this.addChild(obj.name, obj);

            obj = new Static("Static23", "absolute", "551", null, "96", "21", null, "78", this);
            obj.set_taborder("43");
            obj.set_text("공제종료일");
            obj.set_cssclass("styFormItemCapBE");
            this.addChild(obj.name, obj);

            obj = new Static("Static24", "absolute", "551", null, "96", "21", null, "50", this);
            obj.set_taborder("44");
            obj.set_text("중도해지일");
            obj.set_cssclass("styFormItemCap");
            this.addChild(obj.name, obj);

            obj = new Static("Static33", "absolute", "28", null, "96", "21", null, "24", this);
            obj.set_taborder("54");
            obj.set_text("완납여부");
            obj.set_cssclass("styFormItemCap");
            this.addChild(obj.name, obj);

            obj = new Edit("edtREMK_200X", "absolute", "423", null, "325", "21", null, "24", this);
            obj.set_taborder("9");
            obj.set_lengthunit("ascii");
            ...
            obj = new CheckBox("chkCMPL_YSNO", "absolute", "116", null, "14", "21", null, "24", this);
            obj.set_taborder("8");
            obj.set_value("0");
            obj.set_truevalue("1");
            ...
            obj = new Static("imgHelpEMPL_NUMB", "absolute", "191", null, "22", "21", null, "78", this);
            obj.set_taborder("1");
            obj.set_cssclass("sytHelpPopupInput");
            this.addChild(obj.name, obj);

            obj = new Edit("edtEMPL_NAME", "absolute", "214", null, "100", "21", null, "78", this);
            obj.set_taborder("2");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("10");
            obj.set_autoselect("true");
            ...
            obj = new Static("Static06", "absolute", "342", null, "96", "21", null, "78", this);
            obj.set_taborder("102");
            obj.set_text("공제시작일");
            obj.set_cssclass("styFormItemCapBE");
            this.addChild(obj.name, obj);

            obj = new Static("Static07", "absolute", "342", null, "96", "21", null, "24", this);
            obj.set_taborder("103");
            obj.set_text("비고");
            obj.set_cssclass("styFormItemCap");
            this.addChild(obj.name, obj);

            obj = new Calendar("calSIZR_DATE", "absolute", "423", null, "100", "21", null, "78", this);
            this.addChild(obj.name, obj);
            obj.set_taborder("3");
            obj.set_dateformat("yyyy-MM-dd");
            ...
            obj = new Calendar("calCNAP_DATE", "absolute", "648", null, "100", "21", null, "78", this);
            this.addChild(obj.name, obj);
            obj.set_taborder("4");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormItemCalendar");
            ...
            obj = new Calendar("calMWCN_DATE", "absolute", "648", null, "100", "21", null, "50", this);
            this.addChild(obj.name, obj);
            obj.set_taborder("7");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormItemCalendar");
            ...
            obj = new Static("stGROP_LIST01", "absolute", "800", "613", "93", "21", null, null, this);
            ...
            obj = new MaskEdit("medDMND_AMOT", "absolute", "109", null, "103", "21", null, "50", this);
            obj.set_taborder("5");
            obj.set_type("number");
            obj.set_cssclass("styFormSearchItem");
            obj.set_mask("#,###.##");
            ...
            obj = new MaskEdit("medRPAY_AMOT", "absolute", "423", null, "100", "21", null, "50", this);
            obj.set_taborder("6");
            obj.set_cssclass("styFormSearchItem");
            obj.set_mask("#,###.##");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static18", "absolute", "357", "594", "80", "15", null, null, this);
            ...
            obj = new Static("Static03", "absolute", "9", "615", "30", "41", null, null, this);
            ...
            obj = new BindItem("item0","edtEMPL_NUMB","value","dsPY_SISCXM","EMPL_NUMB");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","edtEMPL_NAME","value","dsPY_SISCXM","EMPL_NAME");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","calSIZR_DATE","value","dsPY_SISCXM","SIZR_DATE");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","calCNAP_DATE","value","dsPY_SISCXM","CNAP_DATE");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item6","calMWCN_DATE","value","dsPY_SISCXM","MWCN_DATE");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item7","chkCMPL_YSNO","value","dsPY_SISCXM","CMPL_YSNO");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item8","edtREMK_200X","value","dsPY_SISCXM","REMK_200X");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","medRPAY_AMOT","value","dsPY_SISCXM","RPAY_AMOT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item5","medDMND_AMOT","value","dsPY_SISCXM","DMND_AMOT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("PAYB0105.xfdl", "script::lib_script_common.xjs");
        this.registerScript("PAYB0105.xfdl", function() {
        ...
        this.dsPY_SISCXD_2_onrowposchanged = function(obj,e)
        {
        	if (this.fnc_ToUpper(obj.getRowType(obj.rowposition)) == Dataset.ROWTYPE_INSERT) {
        ...
        {
            this.dsPY_SISCXM.addEventHandler("onrowposchanged", this.fn_KeyFieldDisible, this);
            this.dsPY_SISCXD_2.addEventHandler("onrowposchanged", this.dsPY_SISCXD_2_onrowposchanged, this);
            ...
            this.medRPAY_AMOT.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            this.btn_favorite.addEventHandler("onclick", this.btn_favorite_onclick, this);

        };

        this.loadIncludeScript("PAYB0105.xfdl");
