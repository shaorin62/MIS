...
/**
 * <pre>
 *	EVMB0010Controller - 목표설정서 프로그램 컨트롤러 클래스
 * </pre>
 *
 * @author	김석영
 * @since	2016.10.05
...
@Controller
public class EVMB0010Controller {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(EVMB0010Controller.class);

	/**
	 * 목표설정서 메뉴 서비스 클래스
	 */
	@Resource(name="EVMB0010Service")
	private EVMB0010Service service;

	/**
	 * 목표설정서/평가대상자관리 목록을 조회한다.
	 * @param argDoc - 조회할 정보가 담긴 Document 객체
	 * @return "/EVMB0010/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/evm/EVMB0010_SEARCH00.do")
	 ...
	 */
	@RequestMapping(value = "/core/erp/evm/EVMB0010_SAVE00.do")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/evm/EVMB0010_PROC00.do")
	@SuppressWarnings({ "rawtypes", "unchecked" })
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/evm/EVMB0010_PROC01.do")
	@SuppressWarnings({ "rawtypes", "unchecked" })
