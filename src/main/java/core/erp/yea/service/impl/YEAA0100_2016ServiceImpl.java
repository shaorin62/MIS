...
import core.erp.yea.service.YEAA0100_2016Service;
import core.erp.yea.web.YEAA0100_2016Controller;
...
/**
 * <pre>
 *	YEAA0100_2016ServiceImpl - 연말정산전산매체 메뉴 서비스 인터페이스 구현 클래스
 * <p><b>NOTE : </b></p>
 * </pre>
 * 
 * @author	김석영
 ...
 */
@Service("YEAA0100_2016Service")
public class YEAA0100_2016ServiceImpl extends EgovAbstractServiceImpl implements YEAA0100_2016Service {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(YEAA0100_2016Controller.class);

	/**
	 * 연말정산전산매체 DAO class inject.
	 */
	@Resource(name = "YEAA0100_2016Dao")
	private YEAA0100_2016Dao dao;
