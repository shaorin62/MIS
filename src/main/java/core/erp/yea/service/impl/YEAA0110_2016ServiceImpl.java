...
import core.erp.yea.service.YEAA0110_2016Service;
import core.erp.yea.web.YEAA0110_2016Controller;
...
/**
 * <pre>
 *	YEAA0110_2016ServiceImpl - 연말정산전산매체 메뉴 서비스 인터페이스 구현 클래스
 * <p><b>NOTE : </b></p>
 * </pre>
 * 
 * @author	김석영
 ...
 */
@Service("YEAA0110_2016Service")
public class YEAA0110_2016ServiceImpl extends EgovAbstractServiceImpl implements YEAA0110_2016Service {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(YEAA0110_2016Controller.class);

	/**
	 * 연말정산전산매체 DAO class inject.
	 */
	@Resource(name = "YEAA0110_2016Dao")
	private YEAA0110_2016Dao dao;
	...
	public Object processSEARCH00(Map searchVo) throws Exception {
		...
		returnMap.put("dsYEA_COMP_MED3", dao.processSEARCH03(searchVo));
		return returnMap;
	...
	public String processSAVE00(Map saveData) throws Exception{
		...
		Object dataList = (DataSet) dao.processSEARCH02(saveData);
		...
		*/
		...
		fileName = "H"+YEA_BIZ_NO.substring(0, 7)+"."+YEA_BIZ_NO.substring(7);
