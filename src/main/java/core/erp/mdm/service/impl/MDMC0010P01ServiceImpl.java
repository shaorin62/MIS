/**
 * core.erp.mdm.service.impl.MDMC0010P01ServiceImpl.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	MDMC0010P01ServiceImpl - 인쇄 개별청약 전체복사(신규) 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.10.13
 * @version	1.0
 * @see		{@link MDMC0010P01Service}
 *
 * <pre>
...
@Service("MDMC0010P01Service")
public class MDMC0010P01ServiceImpl extends EgovAbstractServiceImpl implements MDMC0010P01Service {

	/**
	 * 인쇄 개별청약 전체복사(신규) DAO class inject.
	 */
	@Resource(name = "MDMC0010P01Dao")
	private MDMC0010P01Dao dao;

	/**
	 * MDMC0010P01 인쇄 개별청약 저장한다.
