/**
 * core.erp.mdm.service.impl.MDMD0010P01ServiceImpl.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	MDMD0010P01ServiceImpl - 인터넷 개별청약 전체복사(신규) 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.10.13
...
@Service("MDMD0010P01Service")
public class MDMD0010P01ServiceImpl extends EgovAbstractServiceImpl implements MDMD0010P01Service {

	/**
	 * 인터넷 개별청약 전체복사(신규) DAO class inject.
	 */
	@Resource(name = "MDMD0010P01Dao")
	private MDMD0010P01Dao dao;

	/**
	 * MDMD0010P01 인터넷 개별청약 저장한다.
