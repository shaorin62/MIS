/**
 * core.erp.mdm.service.impl.MDME0020ServiceImpl.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	MDME0020ServiceImpl - 옥외 거래명세서 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.10.17
 * @version	1.0
 * @see		{@link MDME0020Service}
 *
 * <pre>
...
@Service("MDME0020Service")
public class MDME0020ServiceImpl extends EgovAbstractServiceImpl implements MDME0020Service {

	/**
	 * 옥외 거래명세서 DAO class inject.
	 */
	@Resource(name = "MDME0020Dao")
	private MDME0020Dao dao;
	 ...
	 * @param param - 검색조건 정보가 담긴 Map 객체
	 * @return 조회한 옥외 거래명세서(헤더) 목록
	 * @exception Exception
	 */
	@SuppressWarnings("rawtypes")
	public Object processSEARCH01(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsMD_ODTRXH", dao.processSEARCH01(searchVo));
		return returnMap;
	 ...
	 * @param param - 검색조건 정보가 담긴 Map 객체
	 * @return 조회한 옥외 거래명세서(상세) 목록
	 * @exception Exception
	 */
	@SuppressWarnings("rawtypes")
	public Object processSEARCH02(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsMD_ODTRXD", dao.processSEARCH02(searchVo));
		return returnMap;
	...
	public int processSAVE03(Map saveData) throws Exception{
		...
		List dsMD_ODTRXH = (List) saveData.get("dsMD_ODTRXH");
		//DataSet의 Delete Row Count만큼 돌면서 Delete
       for (int i = 0; i < dsMD_ODTRXH.size(); i++) {
       	rowVo = (Map) dsMD_ODTRXH.get(i);
	...
	public int processUPDATE10(Map saveData) throws Exception{
		...
		List dsMD_ODTRXD = (List) saveData.get("dsMD_ODTRXD");
		//DataSet의 Delete Row Count만큼 돌면서 Delete
       for (int i = 0; i < dsMD_ODTRXD.size(); i++) {
       	rowVo = (Map) dsMD_ODTRXD.get(i);
       		//거래명세서 디테일 수정
