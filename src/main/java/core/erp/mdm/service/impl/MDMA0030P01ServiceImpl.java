/**
 * core.erp.mdm.service.impl.MDMA0030P01ServiceImpl.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	MDMA0030P01ServiceImpl - 전파 개별청약 전체복사(신규) 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.10.11
 * @version	1.0
 * @see		{@link MDMA0030P01Service}
 *
 * <pre>
...
@Service("MDMA0030P01Service")
public class MDMA0030P01ServiceImpl extends EgovAbstractServiceImpl implements MDMA0030P01Service {

	/**
	 * 전파 개별청약 전체복사(신규) DAO class inject.
	 */
	@Resource(name = "MDMA0030P01Dao")
	private MDMA0030P01Dao dao;

	/**
	 * MDMA0030P01 전파 개별청약 저장한다.
