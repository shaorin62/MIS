/**
 * core.erp.mdm.web.MDMD0020Controller.java - <Created by Code Template generator>
 */
...
import core.erp.mdm.service.MDMD0020Service;
...
/**
 * <pre>
 *	MDMD0020Controller - 인터넷 거래명세서 프로그램 컨트롤러 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.10.19
...
@Controller
public class MDMD0020Controller {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(MDMD0020Controller.class);

	/**
	 * 인터넷 개별청약(신규) 메뉴 서비스 클래스
	 */
	@Resource(name="MDMD0020Service")
	private MDMD0020Service service;

    /**
	 * 인터넷 개별청약 목록을 조회한다.
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/MDMD0020/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMD0020_SEARCH00.do")
    ...
    /**
	 * 인터넷 거래명세서(헤더) 목록을 조회한다.
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/MDMD0020/SEARCH01"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMD0020_SEARCH01.do")
	@SuppressWarnings("rawtypes")
	public ModelAndView processSEARCH01(CoreRequest coreRequest, ModelMap model) throws Exception {
	 ...
	 /**
		 * 인터넷 거래명세서(상세) 목록을 조회한다.
		 * @param param - 조회할 정보가 담긴 Map 객체
		 * @return "/MDMD0020/SEARCH02"
		 * @exception Exception - 조회시 발생한 예외
		 */
		@RequestMapping(value = "/core/erp/mdm/MDMD0020_SEARCH02.do")
		@SuppressWarnings("rawtypes")
		 ...
		 * @exception Exception - 조회시 발생한 예외
		 */
		@RequestMapping(value = "/core/erp/mdm/MDMD0020_SEARCH03.do")
		@SuppressWarnings("rawtypes")
	 ...
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMD0020_SAVE00.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMD0020_SAVE01.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMD0020_SAVE02.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMD0020_SAVE03.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMD0020_UPDATE10.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMD0020_PRINT00.do")
	@SuppressWarnings("rawtypes")
