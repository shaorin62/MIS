/**
 * core.erp.mdm.web.MDMA0040Controller.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	MDMA0040Controller - 전파 거래명세서 프로그램 컨트롤러 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.10.20
...
@Controller
public class MDMA0040Controller {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(MDMA0040Controller.class);

	/**
	 * 전파 개별청약(신규) 메뉴 서비스 클래스
	 */
	@Resource(name="MDMA0040Service")
	private MDMA0040Service service;

    /**
	 * 전파 개별청약 목록을 조회한다.
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/MDMA0040/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0040_SEARCH00.do")
	 ...
	 * 월별 광고주 목록을 조회한다.
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/MDMA0040/SEARCH01"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0040_SEARCH01.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/MDMA0040/SEARCH02"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0040_SEARCH02.do")
	@SuppressWarnings("rawtypes")
	public ModelAndView processSEARCH02(CoreRequest coreRequest, ModelMap model) throws Exception {
	 ...
	 /**
		 ...
		 * @param param - 조회할 정보가 담긴 Map 객체
		 * @return "/MDMA0040/SEARCH03"
		 * @exception Exception - 조회시 발생한 예외
		 */
		@RequestMapping(value = "/core/erp/mdm/MDMA0040_SEARCH03.do")
		@SuppressWarnings("rawtypes")
		 ...
		 * @exception Exception - 조회시 발생한 예외
		 */
		@RequestMapping(value = "/core/erp/mdm/MDMA0040_SEARCH04.do")
		@SuppressWarnings("rawtypes")
	 ...
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0040_SAVE00.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0040_SAVE01.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0040_SAVE02.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0040_SAVE03.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0040_UPDATE10.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0040_PRINT00.do")
	@SuppressWarnings("rawtypes")
