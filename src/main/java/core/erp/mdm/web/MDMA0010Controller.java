/**
 * core.erp.mdm.web.MDMA0010Controller.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	MDMA0010Controller - 전파 일괄청약(신규) 프로그램 컨트롤러 클래스
 * </pre>
 *
 * @author	최제현
 * @since	2016.11.01
...
@Controller
public class MDMA0010Controller {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(MDMA0010Controller.class);

	/**
	 * 전파 일괄청약(신규) 메뉴 서비스 클래스
	 */
	@Resource(name="MDMA0010Service")
	private MDMA0010Service service;
	 ...
	 * @return "/MDMA0010/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0010_SEARCH00.do")
	 ...
	 * 
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/MDMA0010/SEARCH01"
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0010_SEARCH01.do")
	@SuppressWarnings("rawtypes")
	 ...
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0010_SAVE00.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0010_SAVE01.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 처리 시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0010_SAVE02.do")
	@SuppressWarnings("rawtypes")
	 ...
	 * @exception Exception - 조회시 발생한 예외
	 */
	@RequestMapping(value = "/core/erp/mdm/MDMA0010_DELETE00.do")
	@SuppressWarnings("rawtypes")
