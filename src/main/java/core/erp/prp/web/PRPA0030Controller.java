/**
 * core.erp.tmm.web.PRPA0030Controller.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	PRPA0030Controller - 제작 결산관리  실적집계표
 * </pre>
 *
 * @author	오세훈
 * @since	2016.10.24
...
@Controller
public class PRPA0030Controller {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(PRPA0030Controller.class);

	/**
	 * 제작명세서  메뉴 서비스 클래스
	 */
	@Resource(name="PRPA0030Service")
	private PRPA0030Service service;

    /**
     * *********************************************************************************
	 * 제작 결산관리 실적집계표 (실적집계)
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/PRPA0030/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/prp/PRPA0030_SEARCH00.do")
	 ...
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/prp/PRPA0030_PRINT00.do")
	@SuppressWarnings("rawtypes")
