/**
 * core.erp.tmm.web.PRPA0100Controller.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	PRPA0100Controller - 제작 결산관리  실적집계표 (제작건별 실적)
 * </pre>
 *
 * @author	오세훈
 * @since	2016.11.21
...
@Controller
public class PRPA0100Controller {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(PRPA0100Controller.class);

	/**
	 * 제작실적집계표 서비스 클래스
	 */
	@Resource(name="PRPA0100Service")
	private PRPA0100Service service;

    /**
     * *********************************************************************************
	 * 제작 결산관리 실적집계표 (제작건별 실적 집계)
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/PRPA0100/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/prp/PRPA0100_SEARCH00.do")
	 ...
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/prp/PRPA0100_PRINT00.do")
	@SuppressWarnings("rawtypes")
