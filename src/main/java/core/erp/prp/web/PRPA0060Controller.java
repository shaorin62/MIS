/**
 * core.erp.tmm.web.PRPA0060Controller.java - <Created by Code Template generator>
 */
...
/**
 * <pre>
 *	PRPA0060Controller - 제작 결산관리  실적집계표 (제작종류별 분류)
 * </pre>
 *
 * @author	오세훈
 * @since	2016.10.27
...
@Controller
public class PRPA0060Controller {

	/**
	 * Logger init.
	 */
	private static final Logger logger = LoggerFactory.getLogger(PRPA0060Controller.class);

	/**
	 * 제작실적집계표 서비스 클래스
	 */
	@Resource(name="PRPA0060Service")
	private PRPA0060Service service;

    /**
     * *********************************************************************************
	 * 제작 결산관리 실적집계표 (제작종류별)
	 * @param param - 조회할 정보가 담긴 Map 객체
	 * @return "/PRPA0060/SEARCH00"
	 * @exception Exception - 조회시 발생한 예외
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/prp/PRPA0060_SEARCH00.do")
	 ...
	 * *********************************************************************************
	 */
	@RequestMapping(value = "/core/erp/prp/PRPA0060_PRINT00.do")
	@SuppressWarnings("rawtypes")
