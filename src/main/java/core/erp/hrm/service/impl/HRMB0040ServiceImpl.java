...
import core.erp.hrm.service.HRMB0040Service;
import egovframework.rte.fdl.cmmn.EgovAbstractServiceImpl;

/**
 * <pre>
 *	HRMB0040ServiceImpl - 학력사항변경요청 메뉴 서비스 인터페이스 구현 클래스
 * </pre>
 *
 * @author	박철영
 * @since	2016.07.04
 * @version	1.0
 * @see		{@link HRMB0040Service}
 *
 * <pre>
...
@Service("HRMB0040Service")
public class HRMB0040ServiceImpl extends EgovAbstractServiceImpl implements HRMB0040Service {

	/**
	 * 학력사항변경요청 DAO class inject.
	 */
	@Resource(name = "HRMB0040Dao")
	private HRMB0040Dao dao;
	...
	public Object processSEARCH01(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsHR_SCHCRR", dao.processSEARCH01(searchVo));
		return returnMap;
	...
	public Object processSEARCH02(Map searchVo) throws Exception {
		Map<String, Object> returnMap = new HashMap<String, Object>();
		returnMap.put("dsHR_SCHLRQ", dao.processSEARCH02(searchVo));
		return returnMap;
	...
	public int processSAVE00(Map saveData, Map searchVo) throws Exception{
		...
		List dsHR_SCHLRQ     = (List) saveData.get("dsHR_SCHLRQ");  
		List dsHR_SCHLRQ_Del = (List) saveData.get("dsHR_SCHLRQ_DELETE");

		//DataSet의 Delete Row Count만큼 돌면서 Delete
        for (int i = 0; i < dsHR_SCHLRQ_Del.size(); i++) {

        	rowVo = (Map) dsHR_SCHLRQ_Del.get(i);
        ...
        //DataSet의 Row Count만큼 돌면서 Insert Or Update
		for (int i = 0; i < dsHR_SCHLRQ.size(); i++) {

			rowVo = (Map) dsHR_SCHLRQ.get(i);
			rowType = (Integer) rowVo.get("ROW_TYPE");
