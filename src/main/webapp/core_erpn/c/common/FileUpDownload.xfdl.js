    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("File upload and download");
            ...
            obj = new Static("st_helpMessage", "absolute", "54", "236", "455", "198", null, null, this);
            obj.set_taborder("32");
            ...
            obj = new Button("btn_selectFiles", "absolute", "191", "176", "118", "30", null, null, this);
            obj.set_taborder("26");
            ...
            obj = new Button("btn_clearAll", "absolute", "315", "176", "110", "30", null, null, this);
            obj.set_taborder("27");
            ...
            obj = new Button("btn_save", "absolute", "432", "176", "75", "30", null, null, this);
            obj.set_taborder("28");
            obj.set_text("Save");
            ...
            obj = new Layout("default", "", 1024, 582, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("File upload and download");
        ...
        this.fileConfig = {
        		host : "http://localhost:7001/nexacro/",
