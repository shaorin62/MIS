(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("dashboard.xfdl", "script::lib_script_common.xjs");
        ...
        this.fn_FormLoadSetting = function (obj,e) {
        	...
        	if (application._SVCENV == "SOLUTION") {
        		this.divMainBtn.set_visible(true);
        		
        		// 하단 DIV
        		this.divMainBottom.divBottomArea.set_url("main::BC_NDS.xfdl");
        		
        	} else {
        		this.divMainBtn.set_visible(false);
        		
        		// 하단 DIV
        		this.divMainBottom.divBottomArea.set_url("main::BC_COM.xfdl");
        	}
