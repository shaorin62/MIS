(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("worktiles_common.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("worktiles_common.xfdl", "script::lib_script_dashboard.xjs");
        this.registerScript("worktiles_common.xfdl", function() {
        /***************************************************************************************************
        ...
        this.loadIncludeScript("worktiles_common.xfdl");
