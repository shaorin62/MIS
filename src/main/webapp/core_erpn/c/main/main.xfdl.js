(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divMainBtn", "absolute", null, "322", "30", "300", "8", null, this);
            obj.set_taborder("4");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 1156, 383, this.divMainBottom.divBottomArea,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("0");
            		p.set_scrollbars("autoboth");
            		p.set_cssclass("divBottomArea");
            		p.set_url("main::BC_NDS.xfdl");

            	}
            );
            this.divMainBottom.divBottomArea.addLayout(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl", "main::TC_ALL.xfdl");
            this._addPreloadList("fdl", "main::BC_NDS.xfdl");
        };
        
        // User Script
        this.addIncludeScript("main.xfdl", "script::lib_script_common.xjs");
