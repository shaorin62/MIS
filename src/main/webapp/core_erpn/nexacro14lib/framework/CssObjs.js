			...
			if (argcnt == 4 || argcnt == 8 || argcnt == 12 || argcnt == 16) {
				...
				switch (argcnt) {
					case 16:
						...
						this.left_style = (ls && ls != "none") ? ls : "solid";
					...
					case 12:
						...
						this.bottom_style = (bs && bs != "none") ? bs : "solid";
					...
					case 8:
						...
						this.right_style = (rs && rs != "none") ? rs : "solid";
					...
					case 4:
						...
						this.style = this.top_style = (ts && ts != "none") ? ts : "solid";
		...
		if (tag == "expr" || tag == "bind") {
			...
			if (valarr.length >= 3) {
				...
				if (valarr.length > 4 + n) {
					j++;
					for (var i = j, n = valarr.length; i < n - 1; ) {
						valarr[i] = valarr[i].concat(" " + valarr[i + 1]);
						valarr.splice(i + 1, 1);
					}
					var len = valarr[j].length - 2;
