    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("위수탁수정세금계산서팝업");
            ...
            obj = new Static("Static36", "absolute", "135", "36", "8", "41", null, null, this);
            obj.set_taborder("30");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtSHRTAXX_SANB", "absolute", "143", "46", "138", "21", null, null, this);
            obj.set_taborder("40");
            ...
            obj = new Edit("edtSHRCUST_NAME", "absolute", "143", "72", "138", "21", null, null, this);
            obj.set_taborder("41");
            obj.set_imemode("hangul");
            obj.set_maxlength("50");
            obj.set_autoselect("true");
            ...
            obj = new Edit("edtSHRMEMO_FILD", "absolute", "143", "98", "138", "21", null, null, this);
            obj.set_taborder("42");
            obj.set_imemode("hangul");
            obj.set_readonly("true");
            obj.set_maxlength("50");
            ...
            obj = new Static("Static03", "absolute", "311", "72", "103", "21", null, null, this);
            obj.set_taborder("43");
            obj.set_text("세금계산서종류");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "437", "36", "8", "41", null, null, this);
            obj.set_taborder("47");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            this.addChild(obj.name, obj);

            obj = new Static("Static08", "absolute", "311", "98", "103", "21", null, null, this);
            obj.set_taborder("49");
            obj.set_text("영수 구분");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRDTIX_TYPE", "absolute", "445", "72", "128", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("51");
            obj.set_type("search");
            ...
            obj = new Combo("cmbSHRTAXX_DMND", "absolute", "445", "98", "128", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("52");
            obj.set_type("search");
            obj.set_cssclass("styFormItemCombo");
            ...
            obj = new Static("Static06", "absolute", "311", "46", "127", "21", null, null, this);
            obj.set_taborder("53");
            obj.set_text("전자세금계산서번호");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRCONVERSATION_ID", "absolute", "445", "46", "226", "21", null, null, this);
            obj.set_taborder("54");
            obj.set_imemode("hangul");
            obj.set_readonly("true");
            obj.set_maxlength("50");
            ...
            obj = new Static("stInformation", "absolute", "15", "141", "184", "21", null, null, this);
            obj.set_taborder("60");
            ...
            obj = new Static("Static14", "absolute", "22", null, null, "15", "11", "0", this);
            obj.set_taborder("66");
            obj.set_text("h 15");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static16", "absolute", "533", "0", "110", "8", null, null, this);
            obj.set_taborder("67");
            obj.set_text("h8");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
        ...
        // User Script
        this.addIncludeScript("MACA0020P01.xfdl", "script::lib_script_common.xjs");
        this.registerScript("MACA0020P01.xfdl", function() {
        /***************************************************************************************************
         *   Form Common Script                                                                            *
        ...
        this.sPACKAGENAME = "MACA0020P01"; //해당 Form에서 사용 할 Package 명
        this.sALLX_YSNO   = "";
        this.sLoadForm    = "";
        this.sSlipNumb    = "";
        ...
        this.loadIncludeScript("MACA0020P01.xfdl");
