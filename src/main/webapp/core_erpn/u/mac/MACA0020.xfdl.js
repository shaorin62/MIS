    ...
    return function()
    {
        ...
        this.fn_SaveItemCheck = function () {
        	...
        	//미완료
        		...
        		if(this.tabXM.tabindex == 0){
        			if(this.fn_nullChk(this.cmbSHRMEDX_FLAG.value) == "" && this.tabXM.tab0.cmbCRET_FLAG.value != 0 ){
        				this.fnc_Message("TMM300","매체구분 전체상태에서는 선택발행,합산발행 세금계산서를 생성할 수 없습니다.");
        				return false;
        			}
        		}
        		
        		if(this.tabXM.tabindex == 1){
        			if(this.fn_nullChk(this.cmbSHRMEDX_FLAG.value) == "" && this.tabXM.tab1.cmbCRET_FLAG.value != 0 ){
        				this.fnc_Message("TMM300","매체구분 전체상태에서는 선택발행,합산발행 세금계산서를 생성할 수 없습니다.");
        				return false;
        			}
        		}
