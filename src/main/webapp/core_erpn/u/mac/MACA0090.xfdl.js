(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_cellsizingtype("both");
            obj.getSetter("sCommonGubntaborder").set("4");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"25\" band=\"left\"/><Column size=\"100\"/><Column size=\"371\"/><Column size=\"100\"/><Column size=\"0\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/><Row size=\"26\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"0\"/><Cell col=\"1\" text=\"전표일자\"/><Cell col=\"2\" text=\"전표번호\"/><Cell col=\"3\" text=\"금액\"/><Cell col=\"4\" text=\"광고주코드\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:CHEK_FILD\"/><Cell col=\"1\" text=\"bind:SLIP_DATE\"/><Cell col=\"2\" edittype=\"expand\" style=\"cursor:hand;\" text=\"bind:SACH_NUMB\" mask=\"##-########-####\" suppress=\"1\" suppressalign=\"middle,over\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:CSUM_FILD\"/><Cell col=\"4\" text=\"bind:CUST_CODE\"/></Band><Band id=\"summary\"><Cell/><Cell col=\"1\"/><Cell col=\"2\" style=\"align:center;\" text=\"합계\"/><Cell col=\"3\" displaytype=\"number\" expr=\"expr:dataset.getSum(&quot;CSUM_FILD&quot;)\"/><Cell col=\"4\"/></Band></Format></Formats>");
            this.tabXM.tab0.addChild(obj.name, obj);
            ...
            obj.set_cellsizingtype("both");
            obj.getSetter("sCommonGubntaborder").set("4");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"25\" band=\"left\"/><Column size=\"100\"/><Column size=\"371\"/><Column size=\"127\"/><Column size=\"0\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/><Row size=\"26\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"0\"/><Cell col=\"1\" text=\"전표일자\"/><Cell col=\"2\" text=\"전표번호\"/><Cell col=\"3\" text=\"금액\"/><Cell col=\"4\" text=\"광고주코드\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:CHEK_FILD\"/><Cell col=\"1\" text=\"bind:SLIP_DATE\" suppress=\"0\" suppressalign=\"first\"/><Cell col=\"2\" style=\"cursor:hand;\" text=\"bind:SACH_NUMB\" mask=\"##-########-####\" suppress=\"1\" suppressalign=\"middle,over\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:CSUM_FILD\"/><Cell col=\"4\" text=\"bind:CUST_CODE\"/></Band><Band id=\"summary\"><Cell/><Cell col=\"1\"/><Cell col=\"2\" style=\"align:center;\" text=\"합계\"/><Cell col=\"3\" displaytype=\"number\" expr=\"expr:dataset.getSum(&quot;CSUM_FILD&quot;)\"/><Cell col=\"4\"/></Band></Format></Formats>");
            this.tabXM.tab1.addChild(obj.name, obj);
