    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HATF0090");
                this.set_titletext("출장승인신청서 현황");
            ...
            obj = new Calendar("calSHRAPPR_DATE2", "absolute", "215", "71", "99", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static15", "absolute", "342", "97", "65", "21", null, null, this);
            ...
            obj = new Calendar("calSHRBSRP_DATE2", "absolute", "529", "71", "99", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("calSHRSDYT_DATE2", "absolute", "843", "71", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static14", "absolute", "28", "97", "65", "21", null, null, this);
            ...
            obj = new Grid("grdAT_BUTRXM", "absolute", "8", "180", null, null, "25", "15", this);
        ...
        // User Script
        this.addIncludeScript("HATF0090.xfdl", "script::lib_script_common.xjs");
        this.registerScript("HATF0090.xfdl", function() {
        /***************************************************************************************************
         * # Program: 	HATF0090 출장승인신청현황
         *
        ...
        this.sPACKAGENAME = "HATF0090"; //해당 Form에서 사용 할 Package 명
        ...
        this.fn_PostProcess = function (sMethodName) {
        	...
        	if (sMethodName == "SEARCH00") {
        		...
        		arrParam[2] = "GRID,grdAT_BUTRXM,dsDPAY_CODE,BSRP_CODE";
        		arrParam[3] = "GRID,grdAT_BUTRXM,dsBANK_CODE,BANK_CODE";
        ...
        this.loadIncludeScript("HATF0090.xfdl");
