(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("imgSearchSTAT_FLAG", "absolute", "689", "97", "63", "21", null, null, this);
            obj.set_taborder("134");
            obj.set_text("진행상태");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRSTAT_FLAG", "absolute", "757", "97", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("imgSearchMEDA_CODE", "absolute", "148", "97", "70", "21", null, null, this);
            ...
            obj = new Combo("cmbSHRHIGH_LEVL", "absolute", "413", "97", "95", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("imgSearchUSEX_TYPE", "absolute", "505", "97", "62", "21", null, null, this);
            obj.set_taborder("180");
            obj.set_text("제작용도");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRUSEX_TYPE", "absolute", "573", "97", "87", "21", null, null, this);
            this.addChild(obj.name, obj);
        ...
        this.fn_Cancel = function (obj) {
        	this.fnc_DataSetCancel("dsPD_SUJUMD");
        ...
        this.btn_addRow_onclick = function(obj,e)
        {
        	...
        	if(this.fn_nullChk(sCHKval) == ""){
        		this.fnc_Message("TMM300", "상단의 데이터가 존재 하지 않습니다..");
        		return ;
        	}
