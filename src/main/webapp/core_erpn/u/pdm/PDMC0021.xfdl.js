(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdPD_ESTIMD", "absolute", "8", "270", null, null, "25", "15", this);
            ...
            obj = new Static("Static02", "absolute", "777", "205", "65", "21", null, null, this);
            obj.set_taborder("49");
            obj.set_text("청구일");
            obj.set_cssclass("styFormItemCap");
            this.addChild(obj.name, obj);

            obj = new Static("Static03", "absolute", "28", "205", "65", "21", null, null, this);
            obj.set_taborder("51");
            obj.set_text("의뢰일");
            obj.set_cssclass("styFormItemCapBE");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtJOBN_NUMB", "absolute", "353", "153", "144", "21", null, null, this);
            obj.set_taborder("58");
            obj.set_inputmode("upper");
            obj.set_lengthunit("ascii");
            ...
            obj = new Calendar("calREQU_DATE", "absolute", "98", "205", "150", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.getSetter("binddataset").set("dsPD_ESTIMH");
            ...
            obj = new Static("Static30", "absolute", "29", "95", "71", "21", null, null, this);
            obj.set_taborder("131");
            obj.set_text("제작명");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRJOBN_NUMB", "absolute", "96", "95", "80", "21", null, null, this);
            ...
            obj = new Static("imgHelpSHRJOBN_NAME", "absolute", "175", "95", "21", "21", null, null, this);
            obj.set_taborder("140");
            obj.set_cssclass("sytHelpPopup");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRJOBN_NAME", "absolute", "196", "95", "235", "21", null, null, this);
            ...
            obj = new Static("imgHelpSHRCUST_NAME", "absolute", "175", "71", "21", "21", null, null, this);
            obj.set_taborder("148");
            obj.set_cssclass("sytHelpPopup");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRCUST_NAME", "absolute", "196", "71", "140", "21", null, null, this);
            ...
            obj = new Static("imgSearchSTAT_FLAG00", "absolute", "28", "71", "60", "22", null, null, this);
            ...
            obj = new Static("Static21", "absolute", "276", "205", "83", "21", null, null, this);
            obj.set_taborder("160");
            obj.set_text("완료희망일");
            obj.set_cssclass("styFormItemCap");
            this.addChild(obj.name, obj);

            obj = new Calendar("calCOMP_DATE", "absolute", "353", "205", "144", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.getSetter("binddataset").set("dsPD_ESTIMH");
            ...
            obj = new Calendar("calDEND_DATE", "absolute", "848", "205", "150", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.getSetter("binddataset").set("dsPD_ESTIMH");
            ...
            obj = new Combo("cmbHIGH_LEVL", "absolute", "353", "179", "144", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkALL", "absolute", "36.9%", "96", null, "20", "57.88%", null, this);
            obj.set_taborder("219");
            obj.set_text("전체");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "528", "205", "83", "21", null, null, this);
            obj.set_taborder("220");
            obj.set_text("견적일자");
            obj.set_cssclass("styFormItemCapBE");
            this.addChild(obj.name, obj);

            obj = new Calendar("calESTI_DATE", "absolute", "640", "205", "134", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.getSetter("binddataset").set("dsPD_ESTIMH");
            ...
            obj = new Button("btnAddRow00", "absolute", null, "243", "89", "21", "136", null, this);
            ...
            obj = new Edit("edtSHROUTS_CODE", "absolute", null, "243", "79", "21", "379", null, this);
            ...
            obj = new Static("imgHelpSHROUTS_NAME", "absolute", null, "243", "21", "21", "359", null, this);
            obj.set_taborder("224");
            obj.set_cssclass("sytHelpPopup");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHROUTS_NAME", "absolute", null, "243", "130", "21", "229", null, this);
            ...
            obj = new Static("Static3", "absolute", null, "243", "83", "21", "447", null, this);
            ...
            obj = new Static("Static17", "absolute", "1051", "240", "12", "23", null, null, this);
            ...
            obj = new Static("Static13", "absolute", "1064", "240", "12", "23", null, null, this);
            ...
            obj = new Button("btn_addTYPE", "absolute", null, "243", "86", "21", "25", null, this);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item12","calESTI_DATE","value","dsPD_ESTIMH","ESTI_DATE");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item13","calESTI_DATE","binddataset","dsPD_ESTIMH","ESTI_DATE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.fn_HelpDialogeJOBN_NUMB = function(obj,e)
        {
        	...
        	if(this.chkALL.value == true){
        		if(this.fn_nullChk(this.edtSHRCUST_CODE.value) == ''){
        			popID = "PDM0005";                                 //Popup ID
        		}else{
        			popID = "PDM0008";                                 //Popup ID
        		}
        	}else{
        		if(this.fn_nullChk(this.edtSHRCUST_CODE.value) == ''){
        			popID = "PDM0007";                                 //Popup ID
        		}else{
        			popID = "PDM0009";                                 //Popup ID
        		}
        	}
        	...
        	if ((obj.name == 'imgHelpSHRJOBN_NAME') || (obj.name == 'edtSHRJOBN_NAME')) {
        		...
        		if(this.fn_nullChk(this.edtSHRCUST_CODE.value) == ''){
        			...
        			arrParam[1] = this.edtSHRCUST_CODE.value;
        		}
        ...
        //견적일 수정 적용
        this.calESTI_DATE_onchanged = function(obj,e)
        {	
        	for(var i = 0; i < this.dsPD_ESTIMH.rowcount; i ++){
        		this.dsPD_ESTIMH.setColumn(i, "ESTI_DATE", this.calESTI_DATE.value);
        	}
        	
        	for(var i = 0; i < this.dsPD_ESTIMD.rowcount; i ++){
        		this.dsPD_ESTIMD.setColumn(i, "ESTI_DATE", this.calESTI_DATE.value);
        	}
        }

        this.fn_HelpDialogeSHROUTS_CODE = function(obj,e)
        {
        	var arrParam = new Array();

        	// 조회조건 - 제작항목명
        	if ((obj.name == 'imgHelpSHROUTS_NAME') || (obj.name == 'edtSHROUTS_NAME')) {

        		arrParam[0] = 'PDM0006';                                 //Popup ID
        		arrParam[1] = '';                                        //조건구분에 대응되는 조회조건 값
        		arrParam[2] = this.fnc_Trim(this.edtSHRCUST_NAME.value); //콤보조건구분에 대응되는 조회 조건 값
        		arrParam[3] = 'N';                                       //사용 여부 구분 포함 여부 값
        		arrParam[4] = 'edtSHROUTS_NAME';                         //현재 포커스 Componect명
        		arrParam[5] = 'edtSHROUTS_CODE,edtSHROUTS_NAME';         //초기화 및 결과 Mapping Column
        		arrParam[6] = '0,1';                                     //Mapping Column Index
        ...
        this.btnALLSETTING_onclick = function(obj,e)
        {
        	
        	if(this.dsPD_ESTIMD.rowcount ==0){
        		this.fnc_Message("TMM300", "견적세부 내용이 없습니다.")
        		return ;
        	}
        	
        	if(!this.fnc_Message("TMM140", "제작사를 일괄 적용 하시겠습니까?")){return ; };
        	
        	var sOUTS_CODE = this.edtSHROUTS_CODE.value;
        	var sOUTS_NAME = this.edtSHROUTS_NAME.value;
        	
        	for(var i =0; i < this.dsPD_ESTIMD.rowcount; i++){
        		this.dsPD_ESTIMD.setColumn(i, "OUTS_CODE", sOUTS_CODE);
        		this.dsPD_ESTIMD.setColumn(i, "CUST_NAME", sOUTS_NAME);
        	}
        	
        }

        this.fn_SlipDialoge = function(obj,e)
        {
        	
        	if(this.fn_nullChk(this.edtJOBN_NUMB.value) == ""){
        		this.fnc_Message("TMM300", "견적을 입력하려는 제작명을 조회해야 합니다.")
        		return ;
        	}
        ...
        this.fn_SlipDialoge_After = function(sPopupId,Variant){
        	...
        	if (rtn instanceof Array) {
        		...
        		this.fnc_TransactionCall(this, "PDMC0010",sMethodName, sInDataSet, sOutDataSet, sArgument, "fn_CallBack_pop");
        ...
        /*------------------------------------+
         |  Transaction 후 처리 해야 할 내용!  |
         +-------------------------------------*/
        this.fn_CallBack_pop = function (sMethodName,ErrorCode,ErrorMSG) {
        	...
        	if (ErrorCode < 0) {
        		if (application.GBL_SESSONCHK == "E0001") {
        			...
        			for(var i = 0; i < this.dsPD_TYPEXD.rowcount; i++){
        				...
        				this.dsPD_ESTIMD.setColumn(iRow, "JOBN_NUMB", this.edtJOBN_NUMB.value);
        ...
        this.on_initEvent = function()
        {
            ...
            this.calESTI_DATE.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            this.calESTI_DATE.addEventHandler("onchanged", this.calESTI_DATE_onchanged, this);
            this.btnAddRow00.addEventHandler("onclick", this.btnALLSETTING_onclick, this);
            this.edtSHROUTS_CODE.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            this.imgHelpSHROUTS_NAME.addEventHandler("onclick", this.fn_HelpDialogeSHROUTS_CODE, this);
            this.edtSHROUTS_NAME.addEventHandler("onkillfocus", this.fn_HelpDialogeSHROUTS_CODE, this);
