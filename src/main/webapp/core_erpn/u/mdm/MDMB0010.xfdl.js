(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00", "absolute", "173", "71", "9", "21", null, null, this);
            obj.set_taborder("130");
            obj.set_text("~");
            obj.set_cssclass("styFormSearch");
            this.addChild(obj.name, obj);

            obj = new Div("CalSHRYEAR_MNTH00", "absolute", "188", "71", "84", "21", null, null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 84, 21, this.CalSHRYEAR_MNTH,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("127");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item60","edtCOMI_FILD","binddataset","dsMD_CTMDXM","COMI_FILD");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item61","edtCOMI_FILD","value","dsMD_CTMDXM","COMI_FILD");
            this.addChild(obj.name, obj);
            obj.bind();
