    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HRMD0080");
                this.set_titletext("승진기간(직급별)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CPOS_NAME\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"CPOS_NAME2\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"APNT_DIFF\" size=\"256\" prop=\"default\" type=\"STRING\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            
            // UI Components Initialize
            obj = new Static("st_FormLocation", "absolute", "8", "0", null, "29", "8", null, this);
            obj.set_text("승진기간(직급별)");
            ...
            obj = new Grid("grdHR_APPOXD", "absolute", "8", "132", null, null, "8", "8", this);
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"90\"/><Column size=\"90\"/><Column size=\"130\"/></Columns><Rows><Row size=\"23\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"전직급\"/><Cell col=\"1\" text=\"직급\"/><Cell col=\"2\" text=\"기간(평균년수)\"/><Cell col=\"3\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" style=\"align:left;\" text=\"bind:CPOS_NAME2\"/><Cell col=\"1\" displaytype=\"normal\" style=\"align:left;\" text=\"bind:CPOS_NAME\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"bind:APNT_DIFF\"/><Cell col=\"3\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("HRMD0080.xfdl", "script::lib_script_common.xjs");
        this.registerScript("HRMD0080.xfdl", function() {
        ...
        this.loadIncludeScript("HRMD0080.xfdl");
