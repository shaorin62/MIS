(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdHR_REWARD", "absolute", "8", "128", null, null, "25", "15", this);
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"230\"/><Column size=\"250\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell text=\"사원번호\"/><Cell col=\"1\" text=\"성명\"/><Cell col=\"2\" text=\"소속\"/><Cell col=\"3\" text=\"부서\"/><Cell col=\"4\" text=\"직위\"/><Cell col=\"5\" text=\"직급\"/><Cell col=\"6\" text=\"포상일자\"/><Cell col=\"7\" text=\"포상\"/><Cell col=\"8\" text=\"포상내역\"/><Cell col=\"9\" text=\"포상기관\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:EMPL_NUMB\"/><Cell col=\"1\" displaytype=\"text\" text=\"bind:EMPL_NAME\"/><Cell col=\"2\" displaytype=\"text\" style=\"align:left;\" text=\"bind:SECT_NAME\"/><Cell col=\"3\" displaytype=\"text\" style=\"align:left;\" text=\"bind:DEPT_NAME\"/><Cell col=\"4\" displaytype=\"text\" style=\"align:center;\" text=\"bind:OPOS_NAME\"/><Cell col=\"5\" displaytype=\"text\" style=\"align:center;\" text=\"bind:CPOS_NAME\"/><Cell col=\"6\" displaytype=\"date\" style=\"align:center;\" text=\"bind:DCSN_DATE\" calendardisplaynulltype=\"none\"/><Cell col=\"7\" style=\"align:center;\" text=\"bind:RWDN_GUBN\"/><Cell col=\"8\" style=\"align:left;\" text=\"bind:REWD_PROW\"/><Cell col=\"9\" style=\"align:left;\" text=\"bind:REWD_INNM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("HRMC0030.xfdl", "script::lib_script_common.xjs");
        this.registerScript("HRMC0030.xfdl", function() {
        /***************************************************************************************************
        ...
        this.loadIncludeScript("HRMC0030.xfdl");
