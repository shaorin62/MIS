    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FAMG0040");
                this.set_scrollbars("none");
                this.set_titletext("연결수익내역 관리");
        ...
        // User Script
        this.addIncludeScript("FAMG0040.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("FAMG0040.xfdl", "script::lib_gfn.xjs");
        this.addIncludeScript("FAMG0040.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("FAMG0040.xfdl", function() {
        /***************************************************************************************************
         * # Program:	FAMG0040 연결수익내역 관리
         * 
        ...
        this.loadIncludeScript("FAMG0040.xfdl");
