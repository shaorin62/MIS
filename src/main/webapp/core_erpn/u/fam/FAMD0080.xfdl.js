    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FAMD0080");
                this.set_titletext("계정별미결잔액현황");
            ...
            obj._setContents("<ColumnInfo><Column id=\"ACCT_INTL\" size=\"10\" prop=\"default\" type=\"STRING\"/><Column id=\"ACCT_NAME\" size=\"200\" prop=\"default\" type=\"STRING\"/><Column id=\"CUST_CODE\" size=\"30\" prop=\"default\" type=\"STRING\"/><Column id=\"CUST_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"REMK_NAME\" size=\"30\" prop=\"default\" type=\"STRING\"/><Column id=\"BALA_AMNT\" size=\"17\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"REMK_NAM2\" type=\"STRING\" size=\"17\"/><Column id=\"BIZR_NUMB\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_BIZR\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_CUST\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Static("stInformation", "absolute", "8", "107", "288", "21", null, null, this);
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"80\"/><Column size=\"100\"/><Column size=\"180\"/><Column size=\"70\"/><Column size=\"150\"/><Column size=\"250\"/><Column size=\"110\"/><Column size=\"200\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/><Row size=\"26\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"text\" text=\"거래처코드\"/><Cell col=\"1\" text=\"사업자번호\" tooltiptext=\"사업자번호\"/><Cell col=\"2\" displaytype=\"text\" text=\"거래처명\"/><Cell col=\"3\" text=\"계정코드\"/><Cell col=\"4\" displaytype=\"text\" text=\"계정명\"/><Cell col=\"5\" displaytype=\"text\" text=\"적요\"/><Cell col=\"6\" displaytype=\"text\" text=\"금액\"/><Cell col=\"7\" displaytype=\"text\" text=\"비고\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" style=\"align:center;\" text=\"bind:CUST_CODE\" expr=\"expr:Eco.decode(dataset.getRowLevel(currow), 0, CUST_CODE, '소계')\" editdisplay=\"edit\" suppress=\"1\" calendardisplaynulltype=\"none\"/><Cell col=\"1\" text=\"bind:BIZR_NUMB\" mask=\"expr:BIZR_NUMB.toString().length == 10 ? &quot;###-##-#####&quot; : BIZR_NUMB.toString().length == 13 ? &quot;######-#######&quot; : &quot;&quot;\" suppress=\"2\"/><Cell col=\"2\" displaytype=\"text\" style=\"align:left;\" text=\"bind:CUST_NAME\" suppress=\"3\" calendardisplaynulltype=\"none\"/><Cell col=\"3\" text=\"bind:ACCT_INTL\" suppress=\"0\"/><Cell col=\"4\" displaytype=\"text\" style=\"align:left;\" text=\"bind:ACCT_NAME\" suppress=\"0\"/><Cell col=\"5\" displaytype=\"normal\" style=\"align:left;\" text=\"bind:REMK_NAME\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" text=\"bind:BALA_AMNT\"/><Cell col=\"7\" displaytype=\"text\" style=\"align:left;\" text=\"bind:REMK_NAM2\"/></Band><Band id=\"summary\"><Cell style=\"align:center;\"/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\" style=\"align:center;\" text=\"합계\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:dataset.getSum(&quot;BALA_AMNT&quot;)\"/><Cell col=\"7\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtSHRCUST_NAME", "absolute", "608", "71", "166", "21", null, null, this);
            obj.set_taborder("2");
            ...
            obj = new Edit("edtSHRACCT_NAME", "absolute", "976", "71", "166", "21", null, null, this);
            obj.set_taborder("3");
            obj.set_imemode("hangul");
            obj.set_maxlength("200");
            obj.set_autoselect("true");
            ...
            obj = new Edit("edtSHRACCT_INTL", "absolute", "871", "71", "80", "21", null, null, this);
            obj.set_taborder("6");
            obj.set_tabstop("false");
            obj.set_autoselect("true");
            obj.set_cssclass("edt_WF_Readonly");
            ...
            obj = new Static("Static00", "absolute", "803", "71", "68", "21", null, null, this);
            obj.set_taborder("14");
            obj.set_text("계정과목");
            ...
            obj = new Static("imgHelpSHRACCT_INTL", "absolute", "953", "71", "21", "21", null, null, this);
            obj.set_taborder("21");
            ...
            obj = new Static("Static08", "absolute", "8", "122", "216", "6", null, null, this);
            obj.set_taborder("42");
            obj.set_text("h 6");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static03", "absolute", "285", "92", "38", "10", null, null, this);
            obj.set_taborder("48");
            obj.set_text("h10");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
        ...
        // User Script
        this.addIncludeScript("FAMD0080.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("FAMD0080.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("FAMD0080.xfdl", function() {
        /***************************************************************************************************
         * # Program: 	FAMD0080 계정별미결잔액현황
         * 
        ...
        this.fn_Print = function (obj,e) {
        	...
        	var reportfile = "/fam/FAMD0080R01.jrf";
        ...
        this.fn_PostProcess = function (sMethodName) {
        	...
        	if (sMethodName == "SEARCH00") {
        		...
        		this.dsTA_SLIPNT.set_keystring("S:SORT_BIZR+SORT_CUST+CUST_CODE+ACCT_INTL");
        ...
        this.loadIncludeScript("FAMD0080.xfdl");
