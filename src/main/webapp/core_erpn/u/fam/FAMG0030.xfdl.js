    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FAMG0030");
                this.set_scrollbars("none");
                this.set_titletext("연결매입내역 관리");
        ...
        // User Script
        this.addIncludeScript("FAMG0030.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("FAMG0030.xfdl", "script::lib_gfn.xjs");
        this.addIncludeScript("FAMG0030.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("FAMG0030.xfdl", function() {
        /***************************************************************************************************
         * # Program:	FAMG0030 연결매출내역 관리
         * 
         * # Modification Information
         * -------------------------------------------------------------------------------------------------
         *   Date			Modifier	Comment
         * -------------------------------------------------------------------------------------------------
         *   2016.09.26		김기환		Initial Created.
         *   
         * -------------------------------------------------------------------------------------------------
        ...
        this.loadIncludeScript("FAMG0030.xfdl");
