(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CERT_ID\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"CORP_REG_NO\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new WebBrowser("WebBrowser00", "absolute", "15", "16", null, null, "14", "13", this);
            obj.set_taborder("7");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("PACA0022P01.xfdl", "script::lib_script_common.xjs");
        this.registerScript("PACA0022P01.xfdl", function() {
        /*****************************************************************************************************
         2016.12.09 오세훈
        ...
        this.fn_FormLoadSetting = function (obj,e) {
        	...
        	url = url + "/html/SBMS_CERTIFICATE.html";
        ...
        this.loadIncludeScript("PACA0022P01.xfdl");
