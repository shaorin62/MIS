(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("6");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"110\"/><Column size=\"122\"/><Column size=\"86\"/><Column size=\"107\"/><Column size=\"150\"/><Column size=\"120\"/><Column size=\"0\"/><Column size=\"106\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/><Row size=\"26\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"세금계산서년월\"/><Cell col=\"1\" text=\"세금계산서순번\"/><Cell col=\"2\" text=\"세금계산서종류\"/><Cell col=\"3\" text=\"영수구분\"/><Cell col=\"4\" text=\"세금계산서번호\"/><Cell col=\"5\" text=\"수정코드\"/><Cell col=\"6\" text=\"과세종류\"/><Cell col=\"7\" text=\"광고주코드\"/><Cell col=\"8\" text=\"광고주명\"/><Cell col=\"9\" text=\"금액\"/><Cell col=\"10\" text=\"부가세액\"/><Cell col=\"11\" text=\"합계금액\"/><Cell col=\"12\" text=\"청구일자\"/><Cell col=\"13\" text=\"발행일자\"/><Cell col=\"14\" text=\"비고\"/><Cell col=\"15\" text=\"CONVERSATION_ID\"/><Cell col=\"16\" text=\"당초승인번호\"/><Cell col=\"17\" text=\"승인번호\"/><Cell col=\"18\" text=\"원세금계산서번호\"/></Band><Band id=\"body\"><Cell style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:TAXY_MONT\"/><Cell col=\"1\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:TAXX_NUMB\"/><Cell col=\"2\" displaytype=\"combo\" edittype=\"combo\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:DTIX_TYPE\" combodisplay=\"edit\"/><Cell col=\"3\" displaytype=\"combo\" edittype=\"combo\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:TAXX_DMND\" combodisplay=\"edit\"/><Cell col=\"4\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:TAXX_SANB\"/><Cell col=\"5\" displaytype=\"combo\" edittype=\"combo\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:AMEND_CODE\" combodisplay=\"edit\"/><Cell col=\"6\" displaytype=\"combo\" edittype=\"combo\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:TAXX_GUBN\" combodataset=\"dsTAXX_GUBN\" combocodecol=\"CODE\" combodatacol=\"NAME\" combodisplay=\"edit\"/><Cell col=\"7\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:CUST_CODE\"/><Cell col=\"8\" edittype=\"none\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:CUST_NAME\"/><Cell col=\"9\" edittype=\"expr:comp.parent.getEditMode(currow,this.col)\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:TAXX_AMTX\"/><Cell col=\"10\" edittype=\"expr:comp.parent.getEditMode(currow,this.col)\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:TAXX_VATX\"/><Cell col=\"11\" edittype=\"expr:comp.parent.getEditMode(currow,this.col)\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:SUMM_AMTX\"/><Cell col=\"12\" displaytype=\"date\" edittype=\"date\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:DEND_DATE\" calendardisplaynulltype=\"nulltext\"/><Cell col=\"13\" displaytype=\"date\" edittype=\"date\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:PRNT_DATE\" calendardisplaynulltype=\"nulltext\"/><Cell col=\"14\" edittype=\"normal\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:MEMO_FILD\"/><Cell col=\"15\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:CONVERSATION_ID\"/><Cell col=\"16\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:ORI_TAXX_SANB\"/><Cell col=\"17\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:APPROVE_ID\"/><Cell col=\"18\" style=\"background:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');background2:EXPR(ORI_TAXX_SANB == '' ? '#e8fedc':'white');\" text=\"bind:ORI_TAXX_SANB\"/></Band><Band id=\"summary\"><Cell displaytype=\"text\"/><Cell col=\"1\" colspan=\"8\" style=\"align: center;\" text=\"합계\"/><Cell col=\"9\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getSum(&quot;TAXX_AMTX&quot;)\"/><Cell col=\"10\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getSum(&quot;TAXX_VATX&quot;)\"/><Cell col=\"11\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getSum(&quot;SUMM_AMTX&quot;)\"/><Cell col=\"12\"/><Cell col=\"13\"/><Cell col=\"14\"/><Cell col=\"15\"/><Cell col=\"16\"/><Cell col=\"17\"/><Cell col=\"18\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
