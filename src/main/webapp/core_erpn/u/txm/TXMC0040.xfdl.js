    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("TXMC0040");
                this.set_titletext("매입처별 계산서 집계표");
            ...
            obj = new Dataset("dsTA_VAT109_H3", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"BRANCH_CD\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"VAT_YYYY\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"VAT_QUARTER\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"ALL_CCNT\" size=\"256\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"ALL_PCNT\" size=\"256\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"ALL_SAMT\" size=\"256\" prop=\"default\" type=\"BIGDECIMAL\"/><Column id=\"DELAYYN\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"BILL_TYPECD\" size=\"256\" prop=\"default\" type=\"STRING\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdTA_VAT109_D", "absolute", "8", "128", null, null, "25", "154", this);
            obj.set_selecttype("row");
            obj.set_autofittype("col");
            obj.set_binddataset("dsTA_VAT109_D");
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"95\"/><Column size=\"275\"/><Column size=\"50\"/><Column size=\"120\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/><Row size=\"26\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"text\" text=\"사업자번호\"/><Cell col=\"1\" displaytype=\"text\" text=\"상대처명\"/><Cell col=\"2\" displaytype=\"text\" text=\"매수\"/><Cell col=\"3\" displaytype=\"text\" text=\"공급가액\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" style=\"align:center;background: ;\" text=\"bind:CUST_NO\" expr=\"expr:dataset.getRowLevel(currow)==1?dataset.getColumn(currow-1,&quot;BILL_TYPENM&quot;):CUST_NO\" mask=\"expr:CUST_DIV == &quot;1&quot; ? &quot;###-##-#####&quot; : (CUST_DIV == &quot;2&quot; ? &quot;######-#######&quot; : &quot;&quot;)\" suppress=\"1\"/><Cell col=\"1\" displaytype=\"text\" style=\"align:left;background: ;\" text=\"bind:CUST_NM\" suppress=\"2\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:center;background: ;\" text=\"bind:OFF_BILL_CCNT\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;background: ;\" text=\"bind:OFF_SAMT\"/></Band><Band id=\"summary\"><Cell displaytype=\"text\" style=\"align: left;\"/><Cell col=\"1\" displaytype=\"text\" style=\"align: center;\" text=\"계\"/><Cell col=\"2\" displaytype=\"number\" style=\"align: center;\" expr=\"expr:dataset.getSum(&quot;OFF_BILL_CCNT&quot;)\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:dataset.getSum(&quot;OFF_SAMT&quot;)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("grdTA_VAT109_H1", "absolute", "8", null, "480", "110", null, "15", this);
            obj.set_selecttype("multirow");
            obj.set_autofittype("col");
            obj.set_binddataset("dsTA_VAT109_H1");
            ...
            obj.set_wheelscrollrow("1");
            obj.set_cssclass("styGrid01");
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"104\"/><Column size=\"61\"/><Column size=\"40\"/><Column size=\"109\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell displaytype=\"text\" text=\"구분\"/><Cell col=\"1\" displaytype=\"text\" text=\"거래처수\"/><Cell col=\"2\" displaytype=\"text\" text=\"매수\"/><Cell col=\"3\" displaytype=\"text\" text=\"공급가액\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" style=\"align: center;background: EXPR(gfn_Decode(getRowLevel(currow), 0, gfn_Decode(expr_GetRowType(),&quot;insert&quot;,&quot;#c3d5fdff&quot;,&quot;update&quot;,&quot;#fdd9c3ff&quot;,&quot;default&quot;), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"합       계       분\" suppress=\"1\"/><Cell col=\"1\" displaytype=\"number\" style=\"align: right;\" text=\"bind:ALL_CCNT\" suppress=\"2\"/><Cell col=\"2\" displaytype=\"number\" style=\"align: right;\" text=\"bind:ALL_PCNT\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:ALL_SAMT\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("grdTA_VAT109_H2", "absolute", "502", null, null, "110", "25", "15", this);
            obj.set_selecttype("multirow");
            obj.set_autofittype("col");
            obj.set_binddataset("dsTA_VAT109_H2");
            obj.set_cellsizingtype("both");
            obj.set_enable("true");
            obj.getSetter("autofitminwidth").set("100");
            obj.set_taborder("5");
            ...
            obj = new Static("Static1", "absolute", "28", "71", "74", "21", null, null, this);
            obj.set_taborder("12");
            obj.set_text("사업장");
            ...
            obj = new Static("Static6", "absolute", "434", "71", "84", "21", null, null, this);
            obj.set_taborder("14");
            obj.set_text("분기구분");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbVAT_QUARTER", "absolute", "502", "71", "110", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("18");
            obj.set_text("매입처별 계산서 집계표");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("19");
            obj.set_text("홈 > 재무관리>세무회계>부가세신고>매입처별 계산서 집계표");
            ...
            obj = new Static("Static90", "absolute", "8", "107", "154", "21", null, null, this);
            obj.set_taborder("32");
            obj.set_text("계산서 매입자료");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static03", "absolute", "8", null, "466", "21", null, "125", this);
            obj.set_taborder("34");
            obj.set_text("과세기간 종료일 다음달 11일까지 전송된 전자계산서 외 발급분");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static08", "absolute", "502", null, "466", "21", null, "125", this);
            obj.set_taborder("35");
            obj.set_text("과세기간 종료일 다음달 11일까지 전송된 전자계산서 발급분");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static09", "absolute", "1012", "562", "80", "30", null, null, this);
            obj.set_taborder("36");
            obj.set_text("30");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
        ...
        // User Script
        this.addIncludeScript("TXMC0040.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("TXMC0040.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("TXMC0040.xfdl", function() {
        /***************************************************************************************************
         * # Program: 	TXMC0040       매입처별계산서집계표
         * 
        ...
        this.fn_Search = function (obj) {
        	...
        	this.fnc_DatasetClear("dsTA_VAT109_D,dsTA_VAT109_H1,dsTA_VAT109_H2");
        	
        	var sMethodName  = "SEARCH00";
        	var sInDataSet   = "";
        	var sOutDataSet  = "dsTA_VAT109_H1=dsTA_VAT109_H1 ";
        ...
        this.fn_Print = function (obj) {
        	...
        	var reportfile = "/txm/TXMC0040R01.jrf";
        	...
        	dataref[0].type			= "TRAN";
        	dataref[0].svcUrl 		= "/core/erp/txm/TXMC0040_PRINT00.do";
        	dataref[0].inDataset 	= ""
        	dataref[0].outDataset 	= "dsTA_VAT109_D=dsTA_VAT109_D dsTA_VAT109_H1=dsTA_VAT109_H1 dsTA_VAT109_H2=dsTA_VAT109_H2 dsTA_VAT109_H3=dsTA_VAT109_H3 dsVA_VATBRANCH=dsVA_VATBRANCH"
        ...
        this.fn_PostProcess = function (sMethodName) {
        	...
        	if (sMethodName == "SEARCH00") {
        		this.dsTA_VAT109_D.set_keystring("G:BILL_TYPECD");	
        		this.grdTA_VAT109_D.setFocus();
        ...
        this.loadIncludeScript("TXMC0040.xfdl");
