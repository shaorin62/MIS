(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("PRPA0010P01.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("PRPA0010P01.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("PRPA0010P01.xfdl", function() {
        /***************************************************************************************************
        ...
        this.sCUST_CODE = this.parent.sCUST_CODE;
        this.sYEARMON = this.parent.sYEARMON
        ...
        this.fn_CreateArgument = function (sKind) {
        	...
        	if (sKind == "SEARCH10") {
        		...
        		sReturnString += " YEARMON=" + this.fnc_Quote(this.sYEARMON);
        ...
        this.loadIncludeScript("PRPA0010P01.xfdl");
