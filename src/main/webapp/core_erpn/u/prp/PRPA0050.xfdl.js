    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("PRPA0050");
                this.set_titletext("제작실적집계표(팀별)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"YEARMON\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"MEDA_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"MEDA_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"CNT\" type=\"STRING\" size=\"256\"/><Column id=\"ESTI_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"DEND_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"SUJU_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"NESU_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"NESU_RATE\" type=\"STRING\" size=\"256\"/><Column id=\"STAT_FLAG\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("2");
            obj.set_text("제작실적집계표(팀별)");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("3");
            obj.set_text("홈 > 제작시스템>결산관리>결산관리>제작실적집계표(팀별)");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell style=\"background: ;\" text=\"팀명\"/><Cell col=\"1\" style=\"background: ;\" text=\"제작내용\"/><Cell col=\"2\" style=\"background: ;\" text=\"건수\"/><Cell col=\"3\" style=\"background: ;\" text=\"견적액\"/><Cell col=\"4\" style=\"background: ;\" text=\"청구액\"/><Cell col=\"5\" style=\"background: ;\" text=\"정산액\"/><Cell col=\"6\" style=\"background: ;\" text=\"내수액\"/><Cell col=\"7\" style=\"background: ;\" text=\"내수율(%)\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:DEPT_NAME\" suppress=\"1\"/><Cell col=\"1\" displaytype=\"text\" style=\"background:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');background2:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');\" text=\"bind:MEDA_NAME\"/><Cell col=\"2\" displaytype=\"text\" style=\"background:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');background2:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');\" text=\"bind:CNT\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;background:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');background2:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');\" text=\"bind:ESTI_AMTX\" expr=\"expr:nexacro.round(ESTI_AMTX/STAT_FLAG)\" mask=\"#,###\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;background:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');background2:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');\" text=\"bind:DEND_AMTX\" expr=\"expr:nexacro.round(DEND_AMTX/STAT_FLAG)\" mask=\"#,###\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;background:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');background2:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');\" text=\"bind:SUJU_AMTX\" expr=\"expr:nexacro.round(SUJU_AMTX/STAT_FLAG)\" mask=\"#,###\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;background:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');background2:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');\" text=\"bind:NESU_AMTX\" expr=\"expr:nexacro.round(NESU_AMTX/STAT_FLAG)\" mask=\"#,###\"/><Cell col=\"7\" displaytype=\"text\" style=\"align:right;background:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');background2:EXPR(MEDA_NAME == '소 계' ? '#e8fedc':'white');\" text=\"bind:NESU_RATE\" expr=\"expr:NESU_RATE + ' %'\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static10", "absolute", "559", "71", "66", "21", null, null, this);
            obj.set_taborder("115");
            obj.set_text("금액 단위");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRSTAT_FLAG", "absolute", "632", "71", "80", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdoDEPT_CODE", "absolute", "368", "71", "172", "21", null, null, this);
            this.addChild(obj.name, obj);
            var rdoDEPT_CODE_innerdataset = new Dataset("rdoDEPT_CODE_innerdataset", this.rdoDEPT_CODE);
            rdoDEPT_CODE_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">0</Col><Col id=\"datacolumn\">기획팀 별</Col></Row><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">제작팀 별</Col></Row></Rows>");
            obj.set_innerdataset(rdoDEPT_CODE_innerdataset);
            ...
            obj = new Static("Static16", "absolute", "326", "71", "37", "21", null, null, this);
        ...
        // User Script
        this.addIncludeScript("PRPA0050.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("PRPA0050.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("PRPA0050.xfdl", function() {
        /***************************************************************************************************
         * # Program: 	PRPA0050 제작실적집계표 (팀별)
         * 
        ...
        this.fn_Search = function()
        {
        	...
        	//제작팀 
        	}else if(this.rdoDEPT_CODE.index == 1){
        		if (!this.fn_SearchItemCheck()) return;
        		this.fnc_DatasetClear("dsPD_REPORT");
        ...
        this.fn_Print = function (obj) {
            ...
            //기획팀 별
        	if(this.rdoDEPT_CODE.index == 0){
        		var reportfile 	= "/prp/PRPA0050R01.jrf";
        		var dataref 	= new Array();
        		var params 		= "";
        	
        		dataref[0] 				= new Object();
        		dataref[0].type 		= "TRAN";
        		dataref[0].svcUrl 		= "/core/erp/prp/PRPA0050_PRINT00.do";
        		dataref[0].inDataset 	= ""
        	...
        	//제작팀 
        		...
        		var reportfile 	= "/prp/PRPA0050R02.jrf";
        		var dataref 	= new Array();
        		var params 		= "";
        		
        		dataref[0] 				= new Object();
        		dataref[0].type 		= "TRAN";
        		dataref[0].svcUrl 		= "/core/erp/prp/PRPA0050_PRINT01.do";
        		dataref[0].inDataset 	= ""
        		dataref[0].outDataset 	= "dsPD_REPORT=dsPD_REPORT dsPD_YEARMN=dsPD_YEARMN";
        ...
        this.fn_CreateArgument = function (sKind) {
        	...
        	}else if (sKind == "PRINT00" || sKind == "PRINT01") {
        ...
        this.rdoDEPT_CODE_onitemchanged = function(obj,e)
        {
        	this.fn_Search();	
        }
        ...
        this.grdPD_REPORT_oncelldblclick = function(obj,e)
        {
        	...
        	var sDEPT_CODE = this.dsPD_REPORT.getColumn(e.row, "DEPT_CODE");
        	...
        	//제작 상세 내역 팝업 생성
        	 var sOpenStyle  = "modeless=false";   //Open Sytle(되도록 Modal 사용)
        		...
        		this.fnc_OpenPopup("PRPA0010P02", "prp::PRPA0010P02.xfdl", {sMEDA_CODE : sMEDA_CODE, sYEAR_MONT1 : sYEAR_MONT1, sYEAR_MONT2 : sYEAR_MONT2, sDEPT_CODE : sDEPT_CODE, sDEPT_FLAG : sDEPT_FLAG}, sOpenStyle, "fn_Dialoge_After");	
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.rdoDEPT_CODE.addEventHandler("onitemchanged", this.rdoDEPT_CODE_onitemchanged, this);

        };

        this.loadIncludeScript("PRPA0050.xfdl");
