    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("PRPA0040");
                this.set_titletext("제작실적집계표(광고주 매체별분류)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"YEARMON\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"MEDA_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"MEDA_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"CNT\" type=\"STRING\" size=\"256\"/><Column id=\"ESTI_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"DEND_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"SUJU_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"NESU_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"NESU_RATE\" type=\"STRING\" size=\"256\"/><Column id=\"STAT_FLAG\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);

            obj = new Dataset("dsCombo", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"DSNAME\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"CODEID\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"HEADFLAG\" size=\"256\" prop=\"default\" type=\"STRING\"/></ColumnInfo><Rows><Row><Col id=\"CODEID\">CLAS_CODE</Col><Col id=\"DSNAME\">dsSHRCLAS_CODE</Col><Col id=\"HEADFLAG\">ALL</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("2");
            obj.set_text("제작실적집계표(광고주 매체별분류)");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("3");
            obj.set_text("홈 > 제작시스템>결산관리>결산관리>제작실적집계표(광고주 매체별분류)");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"180\"/><Column size=\"250\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"74\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell style=\"background: ;\" text=\"광고주\"/><Cell col=\"1\" style=\"background: ;\" text=\"제작내용\"/><Cell col=\"2\" style=\"background: ;\" text=\"건수\"/><Cell col=\"3\" style=\"background: ;\" text=\"견적액\"/><Cell col=\"4\" style=\"background: ;\" text=\"청구액\"/><Cell col=\"5\" style=\"background: ;\" text=\"정산액\"/><Cell col=\"6\" style=\"background: ;\" text=\"내수액\"/><Cell col=\"7\" style=\"background: ;\" text=\"내수율(%)\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:CUST_NAME\" suppress=\"1\"/><Cell col=\"1\" displaytype=\"text\" text=\"bind:MEDA_NAME\"/><Cell col=\"2\" displaytype=\"text\" text=\"bind:CNT\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:ESTI_AMTX\" expr=\"expr:nexacro.round(ESTI_AMTX/STAT_FLAG)\" mask=\"#,###\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"bind:DEND_AMTX\" expr=\"expr:nexacro.round(DEND_AMTX/STAT_FLAG)\" mask=\"#,###\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SUJU_AMTX\" expr=\"expr:nexacro.round(SUJU_AMTX/STAT_FLAG)\" mask=\"#,###\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" text=\"bind:NESU_AMTX\" expr=\"expr:nexacro.round(NESU_AMTX/STAT_FLAG)\" mask=\"#,###\"/><Cell col=\"7\" displaytype=\"text\" style=\"align:right;\" text=\"bind:NESU_RATE\" expr=\"expr:NESU_RATE + ' %'\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static10", "absolute", "834", "71", "66", "21", null, null, this);
            obj.set_taborder("115");
            obj.set_text("금액 단위");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRSTAT_FLAG", "absolute", "907", "71", "80", "22", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static3", "absolute", "318", "71", "83", "21", null, null, this);
            ...
            obj = new Edit("edtSHRCUST_CODE", "absolute", "373", "71", "80", "21", null, null, this);
            ...
            obj = new Static("imgHelpSHRCUST_NAME", "absolute", "455", "71", "21", "21", null, null, this);
            obj.set_taborder("121");
            obj.set_cssclass("sytHelpPopup");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRCUST_NAME", "absolute", "478", "71", "130", "21", null, null, this);
            ...
            obj = new Static("imgSearchMEDA_CODE", "absolute", "638", "71", "94", "21", null, null, this);
            ...
            obj = new Combo("cmbSHRMEDA_CODE", "absolute", "706", "71", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 1187, 717, this,
            	//-- Layout function
            	function(p) {
            		p.set_titletext("제작실적집계표(광고주 매체별분류)");
        ...
        // User Script
        this.addIncludeScript("PRPA0040.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("PRPA0040.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("PRPA0040.xfdl", function() {
        /***************************************************************************************************
         * # Program: 	PRPA0040 제작실적집계표 (광고주 매체별분류)
         * 
        ...
        this.fn_Print = function (obj) {
        	...
        	var reportfile 	= "/prp/PRPA0040R01.jrf";
            var dataref 	= new Array();
            var params 		= "";
            
        	dataref[0] 				= new Object();
        	dataref[0].type 		= "TRAN";
        	dataref[0].svcUrl 		= "/core/erp/prp/PRPA0040_PRINT00.do";
        	dataref[0].inDataset 	= ""
        ...
        this.grdPD_REPORT_oncelldblclick = function(obj,e)
        {
        	...
        	var sCUST_CODE = this.dsPD_REPORT.getColumn(e.row, "CUST_CODE");
        	var sYEARMON = this.dsPD_REPORT.getColumn(e.row, "YEARMON");
        	...
        	//제작 상세 내역 팝업 생성
        	 var sOpenStyle  = "modeless=false";   //Open Sytle(되도록 Modal 사용)
        		...
        		this.fnc_OpenPopup("PRPA0010P01", "prp::PRPA0010P01.xfdl", {sMEDA_CODE : sMEDA_CODE, sYEAR_MONT1 : sYEAR_MONT1, sYEAR_MONT2 : sYEAR_MONT2, sCUST_CODE : sCUST_CODE, sYEARMON : sYEARMON}, sOpenStyle, "fn_Dialoge_After");	
        }
        ...
        this.loadIncludeScript("PRPA0040.xfdl");
