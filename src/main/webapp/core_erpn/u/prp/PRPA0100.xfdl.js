    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("PRPA0100");
                this.set_titletext("제작실적집계표(제작건별 실적)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CUST_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CLAS_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"JOBN_NUMB\" type=\"STRING\" size=\"256\"/><Column id=\"JOBN_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"ITEM_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"OUTS_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"OUTS_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"SUJU_AMTX\" type=\"STRING\" size=\"256\"/><Column id=\"COMM_SION\" type=\"STRING\" size=\"256\"/><Column id=\"DEND_AMTX\" type=\"STRING\" size=\"256\"/><Column id=\"STAT_FLAG\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"0\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"0\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell style=\"background: ;\" text=\"광고주명\"/><Cell col=\"1\" style=\"background: ;\" text=\"메체종류\"/><Cell col=\"2\" style=\"background: ;\" text=\"제작번호\"/><Cell col=\"3\" style=\"background: ;\" text=\"제작건명\"/><Cell col=\"4\" style=\"background: ;\" text=\"제작사코드\"/><Cell col=\"5\" style=\"background: ;\" text=\"제작사명\"/><Cell col=\"6\" style=\"background: ;\" text=\"제작내용\"/><Cell col=\"7\" text=\"청구액\"/><Cell col=\"8\" style=\"background: ;\" text=\"정산액\"/><Cell col=\"9\" style=\"background: ;\" text=\"내수액\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:CUST_NAME\" suppress=\"1\" suppressalign=\"middle\"/><Cell col=\"1\" displaytype=\"text\" text=\"bind:CLAS_NAME\"/><Cell col=\"2\" displaytype=\"text\" text=\"bind:JOBN_NUMB\" suppress=\"1\" suppressalign=\"middle\"/><Cell col=\"3\" displaytype=\"text\" text=\"bind:JOBN_NAME\" suppress=\"1\" suppressalign=\"middle\"/><Cell col=\"4\" displaytype=\"text\" text=\"bind:OUTS_CODE\"/><Cell col=\"5\" displaytype=\"text\" text=\"bind:OUTS_NAME\" suppress=\"1\" suppressalign=\"middle,over\"/><Cell col=\"6\" displaytype=\"text\" text=\"bind:ITEM_NAME\"/><Cell col=\"7\" displaytype=\"number\" style=\"align:right;\" text=\"bind:DEND_AMTX\" expr=\"expr:nexacro.round(DEND_AMTX/STAT_FLAG)\"/><Cell col=\"8\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SUJU_AMTX\" expr=\"expr:nexacro.round(SUJU_AMTX/STAT_FLAG)\"/><Cell col=\"9\" displaytype=\"number\" style=\"align:right;\" text=\"bind:COMM_SION\" expr=\"expr:nexacro.round(COMM_SION/STAT_FLAG)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("2");
            obj.set_text("제작실적집계표(제작건별 실적)");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("3");
            obj.set_text("홈 > 제작시스템>결산관리>결산관리>제작실적집계표(제작건별실적)");
            ...
            obj = new Static("imgSearchSTAT_FLAG01", "absolute", "350", "97", "60", "21", null, null, this);
            ...
            obj = new Edit("edtSHRCUST_CODE00", "absolute", "418", "97", "81", "21", null, null, this);
            ...
            obj = new Static("imgHelpSHRCUST_NAME00", "absolute", "501", "97", "22", "21", null, null, this);
            obj.set_taborder("153");
            obj.set_cssclass("sytHelpPopup");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRCUST_NAME00", "absolute", "524", "97", "119", "21", null, null, this);
            ...
            obj = new Layout("default", "", 1187, 717, this,
            	//-- Layout function
            	function(p) {
            		p.set_titletext("제작실적집계표(제작건별 실적)");
        ...
        // User Script
        this.addIncludeScript("PRPA0100.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("PRPA0100.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("PRPA0100.xfdl", function() {
        /***************************************************************************************************
        ...
        this.fn_Print = function (obj) {
        	...
        	var reportfile 	= "/prp/PRPA0100R01.jrf";
            var dataref 	= new Array();
            var params 		= "";
            
        	dataref[0] 				= new Object();
        	dataref[0].type 		= "TRAN";
        	dataref[0].svcUrl 		= "/core/erp/prp/PRPA0100_PRINT00.do";
        	dataref[0].inDataset 	= ""
        ...
        this.fn_CreateArgument = function (sKind) {
        	...
        	if (sKind == "SEARCH00") {
        		...
        		sReturnString += " CUST_CODE00=" + this.fnc_Quote(this.edtSHRCUST_CODE00.value); 	//광고주코드
        		sReturnString += " CUST_NAME00=" + this.fnc_Quote(this.edtSHRCUST_NAME00.value); 	//광고주명명
        ...
        this.fn_HelpDialogeSHRCUST_CODE00 = function(obj,e)
        {
        	var arrParam = new Array();

        	// 조회조건 - 광고주명
        	if ((obj.name == 'imgHelpSHRCUST_NAME00') || (obj.name == 'edtSHRCUST_NAME00')) {

        		arrParam[0] = 'PDM0001';                                 //Popup ID
        		arrParam[1] = '';                                        //조건구분에 대응되는 조회조건 값
        		arrParam[2] = this.fnc_Trim(this.edtSHRCUST_NAME00.value); //콤보조건구분에 대응되는 조회 조건 값
        		arrParam[3] = 'N';                                       //사용 여부 구분 포함 여부 값
        		arrParam[4] = 'edtSHRCUST_NAME00';                         //현재 포커스 Componect명
        		arrParam[5] = 'edtSHRCUST_CODE00,edtSHRCUST_NAME00';         //초기화 및 결과 Mapping Column
        		arrParam[6] = '0,1';                                     //Mapping Column Index
        ...
        this.on_initEvent = function()
        {
            ...
            this.imgSearchSTAT_FLAG01.addEventHandler("onclick", this.imgSearchTitle1_onclick, this);
            this.edtSHRCUST_CODE00.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            this.imgHelpSHRCUST_NAME00.addEventHandler("onclick", this.fn_HelpDialogeSHRCUST_CODE00, this);
            this.edtSHRCUST_NAME00.addEventHandler("onkillfocus", this.fn_HelpDialogeSHRCUST_CODE00, this);

        };

        this.loadIncludeScript("PRPA0100.xfdl");
