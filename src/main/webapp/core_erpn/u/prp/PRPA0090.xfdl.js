    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("PRPA0090");
                this.set_titletext("제작실적집계표(외주처별 개인별 상세)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"YEAR_MONT\" type=\"STRING\" size=\"256\"/><Column id=\"OUTS_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"OUTS_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"CUST_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"JOBN_NUMB\" type=\"STRING\" size=\"256\"/><Column id=\"JOBN_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"SUJU_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"SUJU_VATX\" type=\"FLOAT\" size=\"256\"/><Column id=\"SUMX_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"STAT_FLAG\" type=\"STRING\" size=\"256\"/><Column id=\"SOSO_AMTX\" type=\"STRING\" size=\"256\"/><Column id=\"JUMI_AMTX\" type=\"STRING\" size=\"256\"/><Column id=\"SUMX_AMTX2\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdPD_REPORT_USER", "absolute", "8", "154", null, null, "25", "0", this);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"0\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"200\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell style=\"background: ;\" text=\"제작업체코드\"/><Cell col=\"1\" style=\"background: ;\" text=\"제작업체\"/><Cell col=\"2\" style=\"background: ;\" text=\"제작번호\"/><Cell col=\"3\" style=\"background: ;\" text=\"제작명\"/><Cell col=\"4\" style=\"background: ;\" text=\"제작비\"/><Cell col=\"5\" style=\"background: ;\" text=\"소득세\"/><Cell col=\"6\" style=\"background: ;\" text=\"주민세\"/><Cell col=\"7\" style=\"background: ;\" text=\"합계\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:OUTS_CODE\"/><Cell col=\"1\" displaytype=\"text\" text=\"bind:OUTS_NAME\" suppress=\"1\" suppressalign=\"middle\"/><Cell col=\"2\" displaytype=\"text\" text=\"bind:JOBN_NUMB\"/><Cell col=\"3\" displaytype=\"text\" text=\"bind:JOBN_NAME\" style=\"align:center;background:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');background2:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;background:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');background2:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');\" text=\"bind:SUJU_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(SUJU_AMTX/STAT_FLAG)\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;background:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');background2:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');\" text=\"bind:SOSO_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(SOSO_AMTX/STAT_FLAG)\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;background:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');background2:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');\" text=\"bind:JUMI_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(JUMI_AMTX/STAT_FLAG)\"/><Cell col=\"7\" displaytype=\"number\" style=\"align:right;background:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');background2:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');\" text=\"bind:SUMX_AMTX2\" mask=\"#,###\" expr=\"expr:nexacro.round(SUMX_AMTX2/STAT_FLAG)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"0\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"200\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell style=\"background: ;\" text=\"제작업체코드\"/><Cell col=\"1\" style=\"background: ;\" text=\"제작업체\"/><Cell col=\"2\" style=\"background: ;\" text=\"제작번호\"/><Cell col=\"3\" style=\"background: ;\" text=\"제작명\"/><Cell col=\"4\" style=\"background: ;\" text=\"제작비\"/><Cell col=\"5\" style=\"background: ;\" text=\"부가세\"/><Cell col=\"6\" style=\"background: ;\" text=\"합계\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:OUTS_CODE\"/><Cell col=\"1\" displaytype=\"text\" text=\"bind:OUTS_NAME\" suppress=\"1\" suppressalign=\"middle\"/><Cell col=\"2\" displaytype=\"text\" text=\"bind:JOBN_NUMB\"/><Cell col=\"3\" displaytype=\"text\" text=\"bind:JOBN_NAME\" style=\"align:center;background:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');background2:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;background:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');background2:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');\" text=\"bind:SUJU_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(SUJU_AMTX/STAT_FLAG)\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;background:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');background2:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');\" text=\"bind:SUJU_VATX\" mask=\"#,###\" expr=\"expr:nexacro.round(SUJU_VATX/STAT_FLAG)\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;background:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');background2:EXPR(JOBN_NAME == '소계' ? '#e8fedc':'white');\" text=\"bind:SUMX_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(SUMX_AMTX/STAT_FLAG)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("2");
            obj.set_text("제작실적집계표(외주처별 개인별 상세)");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("3");
            obj.set_text("홈 > 제작시스템>결산관리>결산관리>제작실적집계표(외주처별 개인별 상세)");
            ...
            obj = new Static("Static10", "absolute", "800", "71", "65", "21", null, null, this);
            obj.set_taborder("115");
            obj.set_text("금액 단위");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRSTAT_FLAG", "absolute", "873", "71", "80", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdoCITY_CODE", "absolute", "608", "71", "172", "21", null, null, this);
            this.addChild(obj.name, obj);
            var rdoCITY_CODE_innerdataset = new Dataset("rdoCITY_CODE_innerdataset", this.rdoCITY_CODE);
            rdoCITY_CODE_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\"/><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">법인</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">개인</Col></Row></Rows>");
            obj.set_innerdataset(rdoCITY_CODE_innerdataset);
            ...
            obj = new Static("Static14", "absolute", "566", "71", "37", "21", null, null, this);
            ...
            obj = new Layout("default", "", 1187, 717, this,
            	//-- Layout function
            	function(p) {
            		p.set_titletext("제작실적집계표(외주처별 개인별 상세)");
        ...
        // User Script
        this.addIncludeScript("PRPA0090.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("PRPA0090.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("PRPA0090.xfdl", function() {
        /***************************************************************************************************
         * # Program: 	PRPA0080 제작실적집계표 (외주처별 개인별 상세)
         * 
        ...
        this.fn_Print = function (obj) {
        	...
        	var reportfile 	= "/prp/PRPA0090R01.jrf";
            var dataref 	= new Array();
            var params 		= "";
            
            if(this.rdoCITY_CODE.index == 2){
        		reportfile 	= "/prp/PRPA0090R02.jrf";
        	}
            
        	dataref[0] 				= new Object();
        	dataref[0].type 		= "TRAN";
        	dataref[0].svcUrl 		= "/core/erp/prp/PRPA0090_PRINT00.do";
        	dataref[0].inDataset 	= ""
        ...
        this.rdoCITY_CODE_onitemchanged = function(obj,e)
        {
        		//전체
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdPD_REPORT_USER.addEventHandler("onexpanddown", this.fn_HelpDialoge, this);
            ...
            this.rdoCITY_CODE.addEventHandler("onitemchanged", this.rdoCITY_CODE_onitemchanged, this);
        ...
        this.loadIncludeScript("PRPA0090.xfdl");
