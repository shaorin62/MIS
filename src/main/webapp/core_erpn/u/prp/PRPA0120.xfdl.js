(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"0\"/><Column size=\"188\"/><Column size=\"0\"/><Column size=\"190\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"183\"/><Column size=\"273\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell style=\"background: ;\" text=\"업종코드\"/><Cell col=\"1\" style=\"background: ;\" text=\"업종명\"/><Cell col=\"2\" style=\"background: ;\" text=\"업종상세코드\"/><Cell col=\"3\" style=\"background: ;\" text=\"업종상세\"/><Cell col=\"4\" style=\"background: ;\" text=\"업체\"/><Cell col=\"5\" style=\"background: ;\" text=\"제작번호\"/><Cell col=\"6\" style=\"background: ;\" text=\"제작건명\"/><Cell col=\"7\" style=\"background: ;\" text=\"청구금액\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:CLAS_CODE\"/><Cell col=\"1\" displaytype=\"text\" style=\"align:center;background:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');background2:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');\" text=\"bind:CLAS_NAME\" suppress=\"1\" suppressalign=\"middle\"/><Cell col=\"2\" displaytype=\"text\" style=\"align:center;background:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');background2:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');\" text=\"bind:ITEM_CODE\"/><Cell col=\"3\" displaytype=\"text\" style=\"align:center;background:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');background2:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');\" text=\"bind:ITEM_NAME\" suppress=\"1\" suppressalign=\"middle\"/><Cell col=\"4\" displaytype=\"text\" style=\"align:center;background:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');background2:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');\" text=\"bind:CUST_NAME\" suppress=\"2\" suppressalign=\"middle,over\"/><Cell col=\"5\" displaytype=\"text\" style=\"align:center;background:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');background2:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');\" text=\"bind:JOBN_NUMB\"/><Cell col=\"6\" displaytype=\"text\" style=\"align:center;background:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');background2:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');\" text=\"bind:JOBN_NAME\"/><Cell col=\"7\" displaytype=\"number\" style=\"align:right;background:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');background2:EXPR(CLAS_NAME == '총계' ? '#e8fedc':'white');\" text=\"bind:DEND_AMTX\" expr=\"expr:nexacro.round(DEND_AMTX/STAT_FLAG)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
