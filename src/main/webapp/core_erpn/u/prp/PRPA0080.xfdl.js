    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("PRPA0080");
                this.set_titletext("제작실적집계표(외주처별)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"YEARMON\" type=\"STRING\" size=\"256\"/><Column id=\"OUTS_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"OUTS_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"ITEM_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"HIGH_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"SUJU_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"SUJU_VATX\" type=\"FLOAT\" size=\"256\"/><Column id=\"SUMX_AMTX\" type=\"FLOAT\" size=\"256\"/><Column id=\"STAT_FLAG\" type=\"STRING\" size=\"256\"/><Column id=\"SOSO_AMTX\" type=\"STRING\" size=\"256\"/><Column id=\"JUMI_AMTX\" type=\"STRING\" size=\"256\"/><Column id=\"SUMX_AMTX2\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdPD_REPORT_USER", "absolute", "8", "154", null, null, "25", "15", this);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"140\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell style=\"background: ;\" text=\"제작업체\"/><Cell col=\"1\" style=\"background: ;\" text=\"업종내용\"/><Cell col=\"2\" style=\"background: ;\" text=\"제작비\"/><Cell col=\"3\" style=\"background: ;\" text=\"소득세\"/><Cell col=\"4\" style=\"background: ;\" text=\"주민세\"/><Cell col=\"5\" style=\"background: ;\" text=\"합계\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:OUTS_NAME\" suppress=\"1\" style=\"align:center;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\"/><Cell col=\"1\" displaytype=\"text\" text=\"bind:HIGH_NAME\" style=\"align:right;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\" text=\"bind:SUJU_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(SUJU_AMTX/STAT_FLAG)\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\" text=\"bind:SOSO_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(SOSO_AMTX/STAT_FLAG)\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\" text=\"bind:JUMI_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(JUMI_AMTX/STAT_FLAG)\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\" text=\"bind:SUMX_AMTX2\" mask=\"#,###\" expr=\"expr:nexacro.round(SUMX_AMTX2/STAT_FLAG)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("grdPD_REPORT", "absolute", "8", "154", null, null, "25", "15", this);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"140\"/><Column size=\"200\"/><Column size=\"250\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell style=\"background: ;\" text=\"제작업체\"/><Cell col=\"1\" style=\"background: ;\" text=\"업종내용\"/><Cell col=\"2\" style=\"background: ;\" text=\"제작비\"/><Cell col=\"3\" style=\"background: ;\" text=\"부가세\"/><Cell col=\"4\" style=\"background: ;\" text=\"합계\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:OUTS_NAME\" suppress=\"1\" style=\"align:center;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\"/><Cell col=\"1\" displaytype=\"text\" text=\"bind:HIGH_NAME\" style=\"align:right;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\" text=\"bind:SUJU_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(SUJU_AMTX/STAT_FLAG)\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\" text=\"bind:SUJU_VATX\" mask=\"#,###\" expr=\"expr:nexacro.round(SUJU_VATX/STAT_FLAG)\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;background:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');background2:EXPR(OUTS_NAME == '합계' ? '#e8fedc':'white');\" text=\"bind:SUMX_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(SUMX_AMTX/STAT_FLAG)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("2");
            obj.set_text("제작실적집계표(외주처)");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("3");
            obj.set_text("홈 > 제작시스템>결산관리>결산관리>제작실적집계표(외주처별)");
            ...
            obj = new Combo("cmbSHRHIGH_LEVL", "absolute", "418", "71", "120", "21", null, null, this);
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("PRPA0080.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("PRPA0080.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("PRPA0080.xfdl", function() {
        /***************************************************************************************************
        ...
        this.loadIncludeScript("PRPA0080.xfdl");
