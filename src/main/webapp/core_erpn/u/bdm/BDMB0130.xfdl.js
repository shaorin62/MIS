(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdTB_CPLDPT", "absolute", "8", "156", null, "275", "8", null, this);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"60\"/><Column size=\"164\"/><Column size=\"60\"/><Column size=\"164\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/></Columns><Rows><Row size=\"23\" band=\"head\"/><Row size=\"20\"/><Row size=\"23\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"부서코드\"/><Cell col=\"1\" text=\"부서명\"/><Cell col=\"2\" text=\"계정과목\"/><Cell col=\"3\" text=\"계정명\"/><Cell col=\"4\" text=\"기본예산\"/><Cell col=\"5\" text=\"추가예산\"/><Cell col=\"6\" text=\"총예산\"/><Cell col=\"7\" text=\"실적\"/><Cell col=\"8\" text=\"잔액\"/></Band><Band id=\"body\"><Cell edittype=\"none\" style=\"align:center;\" text=\"bind:DEPT_CODE\"/><Cell col=\"1\" edittype=\"none\" style=\"align:left;\" text=\"bind:DEPT_NAME\" expandshow=\"expr:dataset.getRowType(currow) == Dataset.ROWTYPE_INSERT? 'show' : 'hide'\" expandsize=\"20\" expandimage=\"URL('theme://imagesInbus\\imgHelpPopup.gif')\"/><Cell col=\"2\" edittype=\"none\" style=\"align:center;\" text=\"bind:ACCT_INTL\"/><Cell col=\"3\" edittype=\"none\" style=\"align:left;\" text=\"bind:ACCT_BFNM\" expandshow=\"expr:dataset.getRowType(currow) == Dataset.ROWTYPE_INSERT? 'show' : 'hide'\" expandsize=\"20\" expandimage=\"URL('theme://imagesInbus\\imgHelpPopup.gif')\"/><Cell col=\"4\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:BUDG_ATAL\" mask=\"#,###\"/><Cell col=\"5\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:BADD_ATAL\" mask=\"#,###\"/><Cell col=\"6\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:BTOT_ATAL\" mask=\"#,###\"/><Cell col=\"7\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:SLIP_ATAL\" mask=\"#,###\"/><Cell col=\"8\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:REMA_ATAL\" mask=\"#,###\"/></Band><Band id=\"summary\"><Cell colspan=\"4\" style=\"align:center;\" text=\"합계\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('BUDG_ATAL'), 0)\" mask=\"#,###\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('BADD_ATAL'), 0)\" mask=\"#,###\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('BTOT_ATAL'), 0)\" mask=\"#,###\"/><Cell col=\"7\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('SLIP_ATAL'), 0)\" mask=\"#,###\"/><Cell col=\"8\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('REMA_ATAL'), 0)\" mask=\"#,###\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stInformation2", "absolute", "8", "441", "240", "23", null, null, this);
            obj.set_text("* 00건이 조회 되었습니다.");
            obj.style.set_align("middle left");
            obj.set_cssclass("styFormSearchInfo");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staFormLocation", "absolute", null, "0", "555", "22", "16", null, this);
            obj.set_taborder("48");
            ...
            obj = new Div("Div0", "absolute", "8", "32", null, "25", "693", null, this);
            obj.set_taborder("77");
            obj.set_scrollbars("none");
            this.addChild(obj.name, obj);

            obj = new Static("Static04", "absolute", "16", "68", "75", "22", null, null, this);
            obj.set_taborder("78");
            obj.set_text("예산년도");
            ...
            obj = new Static("Static05", "absolute", "180", "68", "60", "22", null, null, this);
            obj.set_taborder("80");
            obj.set_text("회계단위");
            obj.set_cssclass("styFormSearchCapBe");
            obj.style.set_align("left middle");
            ...
            obj = new Static("Static06", "absolute", "16", "92", "75", "22", null, null, this);
            obj.set_taborder("84");
            obj.set_text("부서");
            ...
            obj = new Static("Static07", "absolute", "435", "92", "75", "22", null, null, this);
            obj.set_taborder("85");
            obj.set_text("계정과목");
            obj.set_cssclass("styFormSearchCap");
            obj.style.set_align("left middle");
            ...
            obj = new Edit("edtSHRACCT_INTL", "absolute", "510", "92", "108", "22", null, null, this);
            obj.set_taborder("86");
            obj.set_autoselect("true");
            obj.set_cssclass("styFormItemText");
            obj.set_enable("false");
            ...
            obj = new Edit("edtSHRACCT_BFNM00", "absolute", "642", "92", "187", "22", null, null, this);
            obj.set_taborder("87");
            obj.set_imemode("hangul");
            ...
            obj = new Static("Static08", "absolute", "435", "68", "75", "22", null, null, this);
            obj.set_taborder("88");
            obj.set_text("승인구분");
            obj.set_cssclass("styFormSearchCap");
            obj.style.set_align("left middle");
            ...
            obj = new Combo("cmbSHRAPPR_YSNO", "absolute", "510", "68", "131", "22", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("89");
            ...
            obj = new Static("imgHelpSHRACCT_BFNM", "absolute", "619", "92", "22", "22", null, null, this);
            obj.set_taborder("91");
            obj.set_cssclass("sytHelpPopup");
            obj.style.set_border("0 none #808080ff");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item2","edtSHRDEPT_CODE","value","dsTM_PROJXM","COND_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","edtSHRDEPT_NAME","value","dsTM_PROJXM","DEPT_NAME");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","edtSHRACCT_INTL","value","dsTM_PROJXM","COND_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item5","edtSHRACCT_BFNM00","value","dsTM_PROJXM","DEPT_NAME");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("BDMB0130.xfdl", "script::lib_script_common.xjs");
        this.registerScript("BDMB0130.xfdl", function() {
        ...
        this.sUSERLAVEL = '';
        this.sPACKAGENAME = 'BDMB0130'; //해당 Form에서 사용 할 Package 명
        ...
        this.fn_SaveItemCheck = function ()
        {
        	...
        	for (var i = 0; i < this.dsTB_CPLDPT.getRowCount(); i++) 
        	{
        		...
        		if (this.gfn_ToUpper(this.dsTB_CPLDPT.getRowType(this.dsTB_CPLDPT, i)) != "NORMAL") 
        		{
        ...
        this.fn_CreateArgument = function (sKind)
        {
        	...
        	{
        		var DEPT_CODE = this.dsTB_CPLDPT.getColumn(this.dsTB_CPLDPT.rowposition, 'DEPT_CODE');
        		var ACCT_INTL = this.dsTB_CPLDPT.getColumn(this.dsTB_CPLDPT.rowposition, 'ACCT_INTL');
        ...
        this.fn_PostProcess = function (sMethodName)
        {
        	...
        	else if (sMethodName == 'GetCommCode') 
        	{
        		...
        		arrParam[0] = "COMBO,cmbSHRAPPR_YSNO,dsAPPR_YSNO,0";
        ...
        this.fn_HelpDialoge = function (obj)
        {
        	...
        	switch (obj.name) 
        	{
        		case "imgHelpSHRDEPT_NAME":
        			...
        			sResponse = this.fnc_HelpDialoge(sSearchKind, sInputValue, sCommonGubn, this.edtSHRDEPT_NAME); //Popup Open
        		...
        		case "imgHelpSHRACCT_BFNM":
        			...
        			sResponse = this.fnc_HelpDialoge(sSearchKind, sInputValue, sCommonGubn, this.edtSHRACCT_BFNM); //Popup Open
        		...
        		case "grdTB_CPLDPT":
        			...
        			obj.updateToDataset();
        			var columnID = this.gfn_getColId(obj, obj.currentcell);
        			...
        			if (columnID == 'DEPT_NAME') 
        			{
        				...
        				sResponse = this.fnc_HelpDialoge(sSearchKind, sInputValue, sCommonGubn, obj); //Popup Open
        ...
        this.on_initEvent = function()
        {
            ...
            this.edtSHRACCT_BFNM00.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            this.edtSHRACCT_BFNM00.addEventHandler("onkillfocus", this.fn_CodeNameDisplay, this);
        ...
        this.loadIncludeScript("BDMB0130.xfdl");
