(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"120\" band=\"left\"/><Column size=\"80\" band=\"left\"/><Column size=\"200\" band=\"left\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"90\"/><Column size=\"109\"/></Columns><Rows><Row size=\"23\" band=\"head\"/><Row size=\"20\"/><Row size=\"23\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"처리일자\"/><Cell col=\"1\" text=\"부서코드\"/><Cell col=\"2\" text=\"부서명\"/><Cell col=\"3\" text=\"예산유형\"/><Cell col=\"4\" text=\"예산내용\"/><Cell col=\"5\" text=\"시작연월\"/><Cell col=\"6\" text=\"종료연월\"/><Cell col=\"7\" text=\"계정과목\"/><Cell col=\"8\" text=\"계정명\"/><Cell col=\"9\" text=\"예산금액\"/><Cell col=\"10\" text=\"품의번호\"/></Band><Band id=\"body\"><Cell displaytype=\"date\" edittype=\"none\" text=\"bind:REQU_DATE\" mask=\"yyyy-MM-dd\" editlimit=\"0\" calendardisplaynulltype=\"none\"/><Cell col=\"1\" style=\"align:center;\" text=\"bind:DEPT_CODE\" editlimit=\"0\"/><Cell col=\"2\" edittype=\"normal\" style=\"align:left;\" text=\"bind:DEPT_NAME\" editlimit=\"0\" expandshow=\"expr:dataset.getRowType(currow) == Dataset.ROWTYPE_INSERT? 'show' : 'hide'\" expandsize=\"20\" expandimage=\"URL('theme://imagesInbus\\imgHelpPopup.gif')\"/><Cell col=\"3\" displaytype=\"combo\" edittype=\"combo\" text=\"bind:BUDG_TYPE\" editlimit=\"0\" combodataset=\"dsBUDG_TYPE\" combocodecol=\"SUBCODE\" combodatacol=\"SUBNAME\"/><Cell col=\"4\" edittype=\"normal\" style=\"align:left;\" text=\"bind:REQU_REMK\" editlimit=\"0\"/><Cell col=\"5\" displaytype=\"text\" edittype=\"mask\" editfilter=\"none\" style=\"align:center;\" text=\"bind:BUDG_STYM\" mask=\"@@@@-@@\" editlimit=\"0\" calendardisplaynulltype=\"none\"/><Cell col=\"6\" displaytype=\"text\" edittype=\"mask\" editfilter=\"none\" style=\"align:center;\" text=\"bind:BUDG_ENYM\" mask=\"@@@@-@@\" editlimit=\"0\" calendardisplaynulltype=\"none\"/><Cell col=\"7\" style=\"align:center;\" text=\"bind:ACCT_INTL\" editlimit=\"0\"/><Cell col=\"8\" edittype=\"normal\" style=\"align:left;\" text=\"bind:ACCT_BFNM\" editlimit=\"0\" expandshow=\"expr:dataset.getRowType(currow) == Dataset.ROWTYPE_INSERT? 'show' : 'hide'\" expandsize=\"20\" expandimage=\"URL('theme://imagesInbus\\imgHelpPopup.gif')\"/><Cell col=\"9\" displaytype=\"number\" edittype=\"normal\" style=\"align:right;\" text=\"bind:BUDG_AMNT\" mask=\"#,###\" editlimit=\"0\"/><Cell col=\"10\" text=\"bind:REQU_NUMB\" mask=\"9999-999999-9999\"/></Band><Band id=\"summary\"><Cell colspan=\"5\" style=\"align:center;\" text=\"합계\"/><Cell col=\"5\" style=\"align:center;\"/><Cell col=\"6\" style=\"align:center;\"/><Cell col=\"7\" style=\"align:center;\"/><Cell col=\"8\" style=\"align:center;\"/><Cell col=\"9\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:nexacro.toNumber(dataset.getSum('BUDG_AMNT'), 0)\" mask=\"#,###\"/><Cell col=\"10\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("imgHelpSHRDEPT_NAME01", "absolute", "587", "92", "22", "22", null, null, this);
            obj.set_taborder("52");
            obj.set_cssclass("sytHelpPopup");
            obj.style.set_border("0 none #808080ff");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("BDMB0210.xfdl", "script::lib_script_common.xjs");
        this.registerScript("BDMB0210.xfdl", function() {
        ...
        this.sUSERLAVEL = '';
        this.sPACKAGENAME = 'BDMB0210'; //해당 Form에서 사용 할 Package 명
        ...
        this.fn_FormLoadSetting = function (obj,e)
        {
        	...
        	//this.fnc_GridKeyFieldDisable(this.grdTB_CPLREQ, "BUDG_TYPE", "edittype", "combo");

        	// fnc_GridKeyFieldDisable(grdTB_CPLREQ, "BUDG_STYM", "edittype", "mask");
        	// fnc_GridKeyFieldDisable(grdTB_CPLREQ, "BUDG_ENYM", "edittype", "mask");

        	this.calSHRBUDG_YMFR.set_value((this.fnc_SubStr(this.fnc_GetServerDateTime("date"), 0, 4) + '0101')); //조회 초기값
        	this.calSHRBUDG_YMTO.set_value(this.fnc_SubStr(this.fnc_GetServerDateTime("date"), 0, 8)); //조회 초기값
        ...
        this.fn_Delete = function (obj,e)
        {
        	...
        	if (this.dsTB_CPLREQ.getRowCount() > 0) 
        	{
        		...
        		{
        			this.dsTB_CPLREQ.deleteRow(this.dsTB_CPLREQ.rowposition);
        		}
        		// 삭제 여부 확인
        	}
        	else 
        ...
        {
        	this.fnc_DataSetCancel("dsTB_CPLREQ"); //취소 할 DataSet의 이름을 입력한다.
        ...
        this.fn_HotKey = function (obj,e)
        {
        	...
        	if (e.keycode == 13) 
        	{
        		if (e.fromobject instanceof this.grdTB_CPLREQ) 
        		{
        ...
        this.fn_SearchItemCheck = function ()
        {
        	...
        	{
        		this.fnc_Message("M1005", '예산기간');
        		this.calSHRBUDG_YMTO.setFocus();
        		return false;
        	}

        	if (this.calSHRBUDG_YMTO.value < this.calSHRBUDG_YMFR.value) 
        	{
        		this.fnc_Message("M1046", '예산기간 시작월은 종료일 이전이어야 합니다.');
        		this.calSHRBUDG_YMFR.setFocus();
        		return false;
        	}*/
        ...
        {
        	// 선택된 Row Count
        	var iSelectRowCount = this.fnc_SelectRowCount(this.grdTB_CPLREQ);
        ...
        this.fn_SaveItemCheck = function ()
        {
        	...
        	for (var i = 0; i < this.dsTB_CPLREQ.getRowCount(); i++) 
        	{
        		...
        		if (this.fnc_ToUpper(this.dsTB_CPLREQ.getRowType(this.dsTB_CPLREQ, i)) != "NORMAL") 
        		{
        ...
        this.fn_KeyFieldDisible = function (obj,e)
        {
        	...
        	if (this.fnc_ToUpper(this.dsTB_CPLREQ.getRowType(obj, e.newrow)) == "INSERT") 
        	{
        	}
        	else 
        	{
        ...
        this.fn_HelpDialoge = function (obj)
        {
        	...
        	switch (obj.name) 
        	{
        		...
        		case "grdTB_CPLREQ":
        			...
        			{
        				if (this.fnc_Length(this.fnc_Trim(dsObj.getColumn(nRow, 'BUDG_ENYM'))) < 1) 
        				{
        					this.fnc_Message("M1046", '종료연월을 먼저 입력해야 합니다.');
        					dsObj.setColumn(nRow, 'ACCT_INTL', '');
        					dsObj.setColumn(nRow, 'ACCT_BFNM', '');
        					dsObj.set_enableevent(true);
        					return;
        				}

        				var sACCT_YEAR = this.fnc_SubStr(this.fnc_GetServerDateTime(), 0, 4);

        				var BUDG_ENYM = this.fnc_SubStr(dsObj.getColumn(nRow, 'BUDG_ENYM'), 0, 4);
        				if (this.fnc_Length(this.fnc_Trim(BUDG_ENYM)) > 0) 
        				{
        					sACCT_YEAR = this.fnc_SubStr(BUDG_ENYM, 0, 4);
        				}
        ...
        this.fn_CodeNameDisplay = function (obj)
        {
        	...
        	if (!(obj instanceof this.grdTB_CPLREQ) && obj.value == obj.UserData) 
        	{
        		return;
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.imgHelpSHRDEPT_NAME01.addEventHandler("onclick", this.fn_HelpDialoge, this);

        };

        this.loadIncludeScript("BDMB0210.xfdl");
