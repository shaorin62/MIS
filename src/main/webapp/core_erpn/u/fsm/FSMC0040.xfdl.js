    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FSMC0040");
                this.set_titletext("불용자산현황");
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"70\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"170\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"102\"/><Column size=\"102\"/><Column size=\"102\"/><Column size=\"232\"/></Columns><Rows><Row size=\"39\" band=\"head\"/><Row size=\"26\"/><Row size=\"26\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"text\" text=\"변동구분\"/><Cell col=\"1\" displaytype=\"text\" text=\"자산분류\"/><Cell col=\"2\" displaytype=\"text\" text=\"품목(대분류)\"/><Cell col=\"3\" displaytype=\"text\" text=\"자산번호\"/><Cell col=\"4\" displaytype=\"text\" text=\"자산명\"/><Cell col=\"5\" displaytype=\"text\" text=\"부서\"/><Cell col=\"6\" displaytype=\"text\" text=\"변동일자\"/><Cell col=\"7\" displaytype=\"text\" text=\"취득가&#13;&#10;전월말잔액\"/><Cell col=\"8\" displaytype=\"text\" text=\"상각누계&#13;&#10;전월말잔액\"/><Cell col=\"9\" displaytype=\"text\" text=\"미상각&#13;&#10;전월말잔액\"/><Cell col=\"10\" displaytype=\"text\" text=\"적요\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" style=\"background: EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, 'default', 2, 'default',3,'#e6e6e6ff'));align: left;\" text=\"bind:ASCH_GUBN\" suppress=\"1\"/><Cell col=\"1\" displaytype=\"text\" style=\"background: EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, 'default', 2, '#d9f9aeff',3,'#e6e6e6ff'));align: left;\" text=\"bind:ASCL_NAME\" subsumtext=\"expr:fnc_Decode(getRowLevel(currow), 3, getColumn(currow - 3, 'ASCH_GUBN') + ' 총계 ')\" suppress=\"2\"/><Cell col=\"2\" displaytype=\"text\" style=\"background: EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));align: left;\" text=\"bind:LARG_NAME\" subsumtext=\"expr:fnc_Decode(getRowLevel(currow), 2, getColumn(currow -2, 'ASCL_NAME') + ' 소계 ')\" suppress=\"3\"/><Cell col=\"3\" displaytype=\"text\" style=\"align:center;background:EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:ASST_NUMB\" subsumtext=\"expr:fnc_Decode(getRowLevel(currow), 1, getColumn(currow - 1, 'LARG_NAME'') + ' 소계 ')\" mask=\"expr:ASST_NUMB.toString().length==0?&quot;&quot;:&quot;####-####-####&quot;\"/><Cell col=\"4\" displaytype=\"text\" style=\"background: EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));align: left;\" text=\"bind:ASST_NAME\" subsumtext=\" \"/><Cell col=\"5\" displaytype=\"text\" style=\"background: EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));align: left;\" text=\"bind:DEPT_NAME\" subsumtext=\" \"/><Cell col=\"6\" displaytype=\"text\" edittype=\"mask\" style=\"align: center;background: EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:CHNG_DATE\" subsumtext=\" \" mask=\"expr:CHNG_DATE.toString().length==0?&quot;&quot;:&quot;####-##-##&quot;\"/><Cell col=\"7\" displaytype=\"number\" style=\"align: right;background: EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:ACQU_ENDX\"/><Cell col=\"8\" displaytype=\"number\" style=\"align: right;background: EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:DPCT_ENDX\"/><Cell col=\"9\" displaytype=\"number\" style=\"align: right;background: EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:UNDP_BALE\"/><Cell col=\"10\" displaytype=\"text\" style=\"background: EXPR(fnc_Decode(getRowLevel(currow), 0, fnc_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));align: left;\" text=\"bind:DESC_REMK\" subsumtext=\" \"/></Band><Band id=\"summary\"><Cell colspan=\"7\" displaytype=\"text\" style=\"align: center;\" text=\"합    계\"/><Cell col=\"7\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:getCaseSum(&quot;getRowLevel(currow)==0&quot;, &quot;ACQU_ENDX&quot;, 0)\"/><Cell col=\"8\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:getCaseSum(&quot;getRowLevel(currow)==0&quot;, &quot;DPCT_ENDX&quot;, 0)\"/><Cell col=\"9\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:getCaseSum(&quot;getRowLevel(currow)==0&quot;, &quot;UNDP_BALE&quot;, 0)\"/><Cell col=\"10\" displaytype=\"text\" style=\"align: left;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("calSHRCHNG_DAT1", "absolute", "331", "71", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("1");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormSearchItemCalendar");

            obj = new Static("Static27", "absolute", "437", "71", "14", "21", null, null, this);
            obj.set_taborder("17");
            obj.set_text("~");
            this.addChild(obj.name, obj);

            obj = new Calendar("calSHRCHNG_DAT2", "absolute", "452", "71", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("2");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormSearchItemCalendar");

            obj = new Combo("cmbSHRASCH_GUBN", "absolute", "646", "71", "131", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("3");
            ...
            obj = new Edit("edtSHRASCL_NAME", "absolute", "236", "97", "316", "21", null, null, this);
            obj.set_taborder("5");
            ...
            obj = new Edit("edtSHRDEPT_NAME", "absolute", "236", "123", "316", "21", null, null, this);
            obj.set_taborder("9");
            obj.set_maxlength("100");
            obj.set_autoselect("true");
            obj.set_cssclass("styFormSearchItem");
            ...
            obj = new Edit("edtSHRCLSF_CODE", "absolute", "646", "97", "107", "21", null, null, this);
            obj.set_autoselect("true");
            obj.set_cssclass("styFormSearchItem");
            obj.set_enable("false");
            obj.set_tabstop("false");
            ...
            obj = new Static("Static01", "absolute", "266", "71", "76", "21", null, null, this);
            obj.set_taborder("20");
            obj.set_text("변동일자");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "581", "71", "76", "21", null, null, this);
            obj.set_taborder("21");
            obj.set_text("변동구분");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Static("Static00", "absolute", "581", "97", "76", "21", null, null, this);
            obj.set_taborder("22");
            obj.set_text("품목분류");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("imgHelpSHRCLSF_CODE", "absolute", "755", "97", "21", "21", null, null, this);
            obj.set_taborder("6");
            obj.set_cssclass("sytHelpPopup");
            obj.style.set_border("0 none #808080ff");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRCLSF_NAME", "absolute", "778", "97", "210", "21", null, null, this);
            obj.set_taborder("7");
            obj.set_maxlength("100");
            obj.set_autoselect("true");
            obj.set_cssclass("styFormSearchItem");
            ...
            obj = new Static("Static11", "absolute", "9", "69", "30", "67", null, null, this);
            obj.set_taborder("38");
            obj.set_text("w30");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
        ...
        // User Script
        this.addIncludeScript("FSMC0040.xfdl", "script::lib_script_common.xjs");
        this.registerScript("FSMC0040.xfdl", function() {
        /***************************************************************************************************
        ...
        ***************************************************************************************************/
        ...
        this.loadIncludeScript("FSMC0040.xfdl");
