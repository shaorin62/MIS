    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("FSMC0020");
                this.set_titletext("자산취득명세서");
            ...
            obj.set_taborder("10");
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"70\"/><Column size=\"90\"/><Column size=\"110\"/><Column size=\"100\"/><Column size=\"170\"/><Column size=\"100\"/><Column size=\"73\"/><Column size=\"99\"/><Column size=\"120\"/><Column size=\"232\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/><Row size=\"26\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"text\" text=\"변동구분\"/><Cell col=\"1\" displaytype=\"text\" text=\"자산분류\"/><Cell col=\"2\" displaytype=\"text\" text=\"품목(대분류)\"/><Cell col=\"3\" displaytype=\"text\" text=\"자산번호\"/><Cell col=\"4\" displaytype=\"text\" text=\"자산명\"/><Cell col=\"5\" displaytype=\"text\" text=\"부서\"/><Cell col=\"6\" displaytype=\"text\" text=\"변동일자\"/><Cell col=\"7\" displaytype=\"text\" text=\"취득금액\"/><Cell col=\"8\" displaytype=\"text\" text=\"전표번호\"/><Cell col=\"9\" displaytype=\"text\" text=\"적요\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" style=\"align: center;background: EXPR(gfn_Decode(getRowLevel(currow), 0, gfn_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, 'default', 2, 'default',3,'#e6e6e6ff'));\" text=\"bind:ASCH_GUBN\" suppress=\"1\"/><Cell col=\"1\" displaytype=\"text\" style=\"background: EXPR(gfn_Decode(getRowLevel(currow), 0, gfn_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, 'default', 2, '#d9f9aeff',3,'#e6e6e6ff'));align: left;\" text=\"bind:ASCL_NAME\" subsumtext=\"expr:comp.parent.fnc_Decode(dataset.getRowLevel(currow), 3, dataset.getColumn(currow - 3, 'ASCH_GUBN') + ' 총계 ')\" suppress=\"2\"/><Cell col=\"2\" displaytype=\"text\" style=\"align:left;background: ;\" text=\"bind:LARG_NAME\" subsumtext=\"expr:comp.parent.fnc_Decode(dataset.getRowLevel(currow), 2, dataset.getColumn(currow - 2, 'ASCL_NAME') + ' 소계 ')\" suppress=\"3\"/><Cell col=\"3\" displaytype=\"text\" style=\"align:center;background:EXPR(gfn_Decode(getRowLevel(currow), 0, gfn_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:ASST_NUMB\" subsumtext=\"expr:comp.parent.fnc_Decode(dataset.getRowLevel(currow), 1, dataset.getColumn(currow - 1, 'LARG_NAME') + ' 소계 ')\" mask=\"expr:ASST_NUMB.toString().length == 0 ? &quot;&quot; : &quot;####-####-####&quot;\"/><Cell col=\"4\" displaytype=\"text\" style=\"background: EXPR(gfn_Decode(getRowLevel(currow), 0, gfn_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));align: left;\" text=\"bind:ASST_NAME\" subsumtext=\" \"/><Cell col=\"5\" displaytype=\"text\" style=\"background: EXPR(gfn_Decode(getRowLevel(currow), 0, gfn_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));align: left;\" text=\"bind:DEPT_NAME\" subsumtext=\" \"/><Cell col=\"6\" displaytype=\"text\" edittype=\"none\" style=\"align: center;background: EXPR(gfn_Decode(getRowLevel(currow), 0, gfn_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:CHNG_DATE\" subsumtext=\" \" mask=\"expr:CHNG_DATE.toString().length == 0 ? &quot;&quot; : &quot;####-##-##&quot;\" calendardisplaynulltype=\"none\"/><Cell col=\"7\" displaytype=\"number\" style=\"align: right;background: EXPR(gfn_Decode(getRowLevel(currow), 0, gfn_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:CHNG_AMOT\"/><Cell col=\"8\" displaytype=\"text\" edittype=\"none\" style=\"align: center;background: EXPR(gfn_Decode(getRowLevel(currow), 0, gfn_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));\" text=\"bind:SLIP_NUMB\" subsumtext=\" \" mask=\"expr:SLIP_NUMB.toString().length == 0 ? &quot;&quot; : &quot;##-########-####&quot;\"/><Cell col=\"9\" displaytype=\"text\" style=\"background: EXPR(gfn_Decode(getRowLevel(currow), 0, gfn_Decode(expr_GetRowType(),'insert','#c3d5fdff','update','#fdd9c3ff','default'), 1, '#d7f1eeff', 2, '#d9f9aeff',3,'#e6e6e6ff'));align: left;\" text=\"bind:DESC_REMK\" subsumtext=\" \"/></Band><Band id=\"summary\"><Cell colspan=\"7\" displaytype=\"text\" style=\"align: center;\" text=\"합    계\"/><Cell col=\"7\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getCaseSum(&quot;dataset.getRowLevel(currow)==0&quot;, &quot;CHNG_AMOT&quot;, 0)\"/><Cell col=\"8\" displaytype=\"text\" style=\"align: left;\"/><Cell col=\"9\" displaytype=\"text\" style=\"align: left;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("calSHRCHNG_DAT1", "absolute", "326", "71", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("1");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormSearchItemCalendar");

            obj = new Static("Static27", "absolute", "429", "70", "16", "21", null, null, this);
            obj.set_taborder("18");
            obj.set_text("~");
            obj.style.set_align("center middle");
            this.addChild(obj.name, obj);

            obj = new Calendar("calSHRCHNG_DAT2", "absolute", "447", "71", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("2");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("styFormSearchItemCalendar");

            obj = new Combo("cmbSHRASCH_GUBN", "absolute", "645", "71", "130", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("3");
            ...
            obj = new Edit("edtSHRASCL_NAME", "absolute", "236", "97", "311", "21", null, null, this);
            obj.set_taborder("5");
            ...
            obj = new Edit("edtSHRDEPT_NAME", "absolute", "236", "123", "311", "21", null, null, this);
            obj.set_taborder("9");
            obj.set_maxlength("100");
            obj.set_autoselect("true");
            obj.set_cssclass("styFormSearchItem");
            ...
            obj = new Edit("edtSHRCLSF_CODE", "absolute", "645", "97", "107", "21", null, null, this);
            obj.set_autoselect("true");
            obj.set_cssclass("styFormSearchItem");
            obj.set_enable("false");
            obj.set_tabstop("false");
            ...
            obj = new Edit("edtSHRCLSF_NAME", "absolute", "777", "97", "210", "21", null, null, this);
            obj.set_taborder("7");
            obj.set_maxlength("100");
            obj.set_autoselect("true");
            obj.set_cssclass("styFormSearchItem");
            ...
            obj = new Static("Static01", "absolute", "261", "71", "76", "21", null, null, this);
            obj.set_taborder("22");
            obj.set_text("회계일자");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "576", "71", "76", "21", null, null, this);
            obj.set_taborder("23");
            obj.set_text("변동구분");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Static("Static00", "absolute", "576", "97", "76", "21", null, null, this);
            obj.set_taborder("24");
            obj.set_text("품목분류");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Static("Static03", "absolute", "28", "123", "83", "21", null, null, this);
            obj.set_taborder("25");
            obj.set_text("부서");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Static("imgHelpSHRASCL_CODE", "absolute", "213", "97", "21", "21", null, null, this);
            obj.set_taborder("4");
            obj.set_cssclass("sytHelpPopup");
            obj.style.set_border("0 none #808080ff");
            this.addChild(obj.name, obj);

            obj = new Static("imgHelpSHRDEPT_CODE", "absolute", "213", "123", "21", "21", null, null, this);
            obj.set_taborder("8");
            obj.set_cssclass("sytHelpPopup");
            obj.style.set_border("0 none #808080ff");
            this.addChild(obj.name, obj);

            obj = new Static("imgHelpSHRCLSF_CODE", "absolute", "754", "97", "21", "21", null, null, this);
            obj.set_taborder("6");
            obj.set_cssclass("sytHelpPopup");
            obj.style.set_border("0 none #808080ff");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("26");
            obj.set_text("자산취득명세서");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("27");
            obj.set_text("홈 > 자산관리 > 자산취득명세서");
            ...
            obj = new Static("Static10", "absolute", "0", "0", "8", "717", null, null, this);
            obj.set_taborder("36");
            obj.set_text("w\r\n8");
            ...
            obj = new Static("Static04", "absolute", "9", "61", "30", "67", null, null, this);
            obj.set_taborder("39");
            obj.set_text("w30");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static49", "absolute", "147", "144", "38", "10", null, null, this);
            obj.set_taborder("40");
            obj.set_text("h10");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static57", "absolute", "147", "118", "102", "5", null, null, this);
            obj.set_taborder("41");
            obj.set_text("h5");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static46", "absolute", "147", "92", "102", "5", null, null, this);
            obj.set_taborder("42");
            obj.set_text("h5");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static48", "absolute", "148", "61", "38", "10", null, null, this);
            obj.set_taborder("43");
            obj.set_text("h10");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static38", "absolute", "547", "61", "40", "93", null, null, this);
            obj.set_taborder("44");
            obj.set_text("w 40");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static09", "absolute", "573", "155", "80", "25", null, null, this);
            obj.set_taborder("45");
            obj.set_text("h 25");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
            ...
            obj = new Static("Static13", "absolute", "8", "174", "304", "6", null, null, this);
            obj.set_taborder("46");
            obj.set_text("h 6");
            obj.set_visible("false");
            obj.style.set_background("#fb7b7b7a");
        ...
        // User Script
        this.addIncludeScript("FSMC0020.xfdl", "script::lib_script_common.xjs");
        this.registerScript("FSMC0020.xfdl", function() {
        /***************************************************************************************************
         * # Program:	FSMC0020 자산취득명세서
         * 
        ...
        /*-------------------------------------+
         ...
         this.fn_PostProcess = function (sMethodName) {
        	...
        	if (sMethodName == "SEARCH00") {
        		...
        		this.fnc_Message("TMM018", this.dsFS_ASCHXM.getCaseCount("dataset.getRowLevel(currow)==0"));

        	} else if (sMethodName == "GetCommCode") {

        		var arrParam = new Array();
        			arrParam[0] = "COMBO,cmbSHRASST_GUBN,dsSHRASST_GUBN,0";
        			arrParam[1] = "COMBO,cmbSHRASCH_GUBN,dsSHRASCH_GUBN,0";
        ...
        */
        ...
        this.loadIncludeScript("FSMC0020.xfdl");
