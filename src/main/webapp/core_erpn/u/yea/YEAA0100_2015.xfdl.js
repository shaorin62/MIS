    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("YEAA0100_2015");
                this.set_titletext("의료비전산매체(2015)");
        ...
        // User Script
        this.addIncludeScript("YEAA0100_2015.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("YEAA0100_2015.xfdl", "script::lib_script_common_YEA.xjs");
        this.registerScript("YEAA0100_2015.xfdl", function() {
        /***************************************************************************************************
        ...
        this.sPACKAGENAME = 'YEAA0100_2015'; //해당 Form에서 사용 할 Package 명
        this.sFILE_NAME   = "";			//파일명
        ...
        this.loadIncludeScript("YEAA0100_2015.xfdl");
