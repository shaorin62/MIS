(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdPY_EMPAVG", "absolute", "8", "132", null, null, "8", "8", this);
        ...
        // User Script
        this.addIncludeScript("PAYJ0003.xfdl", "script::lib_script_common.xjs");
        this.registerScript("PAYJ0003.xfdl", function() {
        ...
        {
            this.dsPY_EMPAVG.addEventHandler("onrowposchanged", this.fn_KeyFieldDisible, this);
        ...
        this.loadIncludeScript("PAYJ0003.xfdl");
