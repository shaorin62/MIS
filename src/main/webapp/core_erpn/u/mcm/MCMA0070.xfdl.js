(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("imgSearchTitle1", "absolute", "620", "71", "63", "21", null, null, this);
            obj.set_text("사용구분");
            obj.set_cssclass("styFormSearchCap");
            obj.set_taborder("56");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRUSEX_YSNO", "absolute", "688", "71", "120", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtSHRBRND_NAME", "absolute", "426", "71", "150", "21", null, null, this);
            ...
            obj = new Static("Static10", "absolute", "418", "61", "8", "41", null, null, this);
        ...
        this.edtSHRBRND_NAME_onkeydown = function(obj,e)
        {
        	if(e.keycode == 13)
        	{
        		this.fn_Search();
        ...
        this.on_initEvent = function()
        {
            ...
            this.edtSHRBRND_NAME.addEventHandler("onkeydown", this.edtSHRBRND_NAME_onkeydown, this);
