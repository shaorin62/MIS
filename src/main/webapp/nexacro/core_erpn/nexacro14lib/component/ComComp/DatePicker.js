...
if (!nexacro.DatePicker) {
	...
	_pDatePicker.on_find_CurrentStyle_rtlimagemirroring = function (pseudo) {
		return;
		return this.parent._find_pseudo_obj("rtlimagemirroring", pseudo, "rtlimagemirroring") || this._find_pseudo_obj("rtlimagemirroring", pseudo, "rtlimagemirroring");
	};
	...
	_pDatePicker.on_apply_style_rtlimagemirroring = function (rtlimagemirroring) {
		...
		var control_elem = this.getElement();
		var body = this._body;
		if (control_elem && body && rtlimagemirroring) {
			control_elem.setElementImageMirror(rtlimagemirroring);
			body.on_apply_style_rtlimagemirroring(rtlimagemirroring);
		}
	};
