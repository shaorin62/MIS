(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01", "absolute", "144", "152", "101", "40", null, null, this);
            obj.set_taborder("58");
            ...
            obj = new Static("Static04", "absolute", "0", "236", "280", "24", null, null, this);
            obj.set_taborder("59");
            ...
            obj = new Static("Static28", "absolute", "0", "152", "129", "40", null, null, this);
            obj.set_taborder("60");
            ...
            obj = new Static("Static14", "absolute", "0", "213", "280", "24", null, null, this);
            obj.set_taborder("61");
            obj.set_text("[전체] 시스템 업그레이드 안내드립니다.");
            obj.set_usedecorate("true");
            obj.set_cssclass("sta_MF_text9");
        ...
        // User Script
        this.addIncludeScript("TC_NDS_1.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("TC_NDS_1.xfdl", "script::lib_script_dashboard.xjs");
        this.registerScript("TC_NDS_1.xfdl", function() {
         /***************************************************************************************************
        ...
        this.loadIncludeScript("TC_NDS_1.xfdl");
