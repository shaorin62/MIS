(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsDatabaseType", this);
            obj._setContents("<ColumnInfo><Column id=\"DBMS_TYCD\" type=\"STRING\" size=\"256\"/><Column id=\"DBMS_TYNM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DBMS_TYCD\">Oracle</Col><Col id=\"DBMS_TYNM\">ORACLE</Col></Row><Row><Col id=\"DBMS_TYCD\">Tibero</Col><Col id=\"DBMS_TYNM\">TIBERO</Col></Row><Row><Col id=\"DBMS_TYCD\">Tibero1</Col><Col id=\"DBMS_TYNM\">TIBERO1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            this.divLogin.addChild(obj.name, obj);
            obj = new Combo("cmbDBMS_TYPE", "absolute", "70", "141", "232", "33", null, null, this.divLogin);
            this.divLogin.addChild(obj.name, obj);
            obj.set_taborder("1");
            obj.set_value("1");
            obj.set_text("인사시스템");
            obj.style.set_buttonsize("16");
            obj.set_innerdataset("@dsDatabaseType");
            obj.set_codecolumn("DBMS_TYCD");
            obj.set_datacolumn("DBMS_TYNM");
            obj.set_index("0");
        ...
        // User Script
        this.addIncludeScript("comLogin_ds.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("comLogin_ds.xfdl", "script::lib_base64.xjs");
        this.registerScript("comLogin_ds.xfdl", function() {
        /***************************************************************************************************
        ...
        this.fn_Login = function() {
        	...
        	*/
        	...
        	var sArgument  = " USER_IDXX=" + this.base64Encode(this.divLogin.edtUSER_IDXX.value);
        		...
        		sArgument += " SYSTEM=" + this.base64Encode("HMS");
        	
        	application.GBL_DBTYPECD = this.divLogin.cmbDBMS_TYPE.value;
        ...
        this.divLogin_cmbDBMS_TYPE_onitemchanged = function(obj,e)
        {
        ...
        this.loadIncludeScript("comLogin_ds.xfdl");
