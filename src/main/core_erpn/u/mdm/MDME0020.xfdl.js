(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsMD_ODTRXH", this);
            ...
            obj = new Static("stInformation", "absolute", "8", "396", "425", "21", null, null, this);
        ...
        // User Script
        this.addIncludeScript("MDME0020.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("MDME0020.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("MDME0020.xfdl", function() {
        /***************************************************************************************************
        ...
        this.fn_Save = function (obj) {
        	...
        	if(this.fn_SaveItemCheck()){
        		...
        		var sInDataSet = "dsMD_ODTRXD=dsMD_ODTRXD:U";
        		var sOutDataSet = "";
        		var sArgument = this.fn_CreateArgument(sMethodName);
        ...
        this.fn_Print = function (obj) {
        	if (this.dsMD_ODTRXH.getRowCount() < 0) return this.fnc_Message("TMM011");
            if (this.dsMD_ODTRXH.rowposition < 0) return;

            this.fnc_DatasetClear("dsMD_TRANXH_RPT");
            this.fnc_DatasetClear("dsMD_TRANXD_RPT");

        	var reportfile 	= "/mdm/MDME0020R01.jrf";
            var dataref 	= new Array();
            var params 		= "";
            
        	dataref[0] 				= new Object();
        	dataref[0].type 		= "TRAN";
        	dataref[0].svcUrl 		= "/core/erp/mdm/MDME0020_PRINT00.do";
        	dataref[0].inDataset 	= ""
        ...
        this.fn_DeleteCheck = function (totalNum) {
        	...
        	var sQuestionText  = "거래번호 : ("+this.grdMD_ODTRXH.getCellText(this.grdMD_ODTRXH.currentrow, this.grdMD_ODTRXH.getBindCellIndex( "body", "TRTR_NUMB" )) + ")";
        ...
        this.fn_CreateArgument = function (sKind) {
        	...
        	if (sKind == "SEARCH00" || sKind == "SEARCH01") {
        		...
        		this.grdMD_ODTRXH.getCellText(this.grdMD_ODTRXH.currentrow, this.grdMD_ODTRXH.getBindCellIndex( "body", "TRTR_NUMB")))); //거래명세서(헤더)번호
        		...
        		this.fnc_Quote(this.dsMD_ODTRXH.getColumn(this.dsMD_ODTRXH.rowposition, "MEDX_FLAG")); //매체구분
        		sReturnString += " YEAR_MNTH=" + 
        		this.fnc_Quote(this.dsMD_ODTRXH.getColumn(this.dsMD_ODTRXH.rowposition, "YEAR_MNTH")); //년월
        		sReturnString += " TRTR_NUMB=" + 
        		this.fnc_Quote(this.dsMD_ODTRXH.getColumn(this.dsMD_ODTRXH.rowposition, "TRTR_NUMB")); //헤더의 거래명세서번호
        	}
        ...
        this.grdMD_ODTRXH_onheadclick = function(obj,e)
        {
        	if (e.cell == 0) {
        		...
        		this.grdMD_ODTRXH.setCellProperty("Head", 0, "expr", isAllChecked);
        	}
        }
        ...
        this.grdMD_ODTRXD_onheadclick = function(obj,e)
        {
        	if (e.cell == 0) {
        		...
        		this.grdMD_ODTRXD.setCellProperty("Head", 0, "expr", isAllChecked);
        	}
        }
        ...
        this.grdMD_ODTRXH_onkeyup = function(obj,e)
        {
        ...
        {
            this.dsMD_ODMDXM.addEventHandler("oncolumnchanged", this.dsMD_CTMDXM_oncolumnchanged, this);
            ...
            this.grdMD_ODTRXH.addEventHandler("onkeyup", this.grdMD_ODTRXH_onkeyup, this);
        ...
        this.loadIncludeScript("MDME0020.xfdl");
