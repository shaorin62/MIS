(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edtSHRBRND_NAME", "absolute", "103", "41", "103", "21", null, null, this);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"94\"/><Column size=\"144\"/><Column size=\"85\"/><Column size=\"169\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"광고주코드\"/><Cell col=\"1\" text=\"광고주명\"/><Cell col=\"2\" text=\"브랜드코드\"/><Cell col=\"3\" text=\"브랜드명\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"bind:CUST_CODE\"/><Cell col=\"1\" displaytype=\"normal\" edittype=\"none\" editfilter=\"number\" style=\"align: ;\" text=\"bind:CUST_NAME\" editlimit=\"6\" editdisplay=\"edit\"/><Cell col=\"2\" style=\"align: ;\" text=\"bind:BRND_CODE\" editlimit=\"0\"/><Cell col=\"3\" edittype=\"none\" style=\"align: ;\" text=\"bind:BRND_NAME\" editlimit=\"0\" expandshow=\"hide\" expandsize=\"23\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("MDMB0010P02.xfdl", "script::lib_script_common.xjs");
        this.registerScript("MDMB0010P02.xfdl", function() {
        /***************************************************************************************************
        ...
        this.on_initEvent = function()
        {
            ...
            this.edtSHRBRND_NAME.addEventHandler("onkeydown", this.edtSearchText_OnKeyDown, this);
        ...
        this.loadIncludeScript("MDMB0010P02.xfdl");
