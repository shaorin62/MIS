    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("MDMB0010P03");
                this.set_titletext("매체조회팝업");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CUST_CODE\" size=\"255\" prop=\"default\" type=\"STRING\"/><Column id=\"CUST_NAME\" size=\"255\" prop=\"default\" type=\"STRING\"/><Column id=\"RMED_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"RMED_NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Edit("edtSHRRMED_NAME", "absolute", "103", "41", "103", "21", null, null, this);
            ...
            obj = new Grid("grdMD_CUSTXM", "absolute", "15", "108", null, null, "15", "44", this);
            obj.set_taborder("19");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"94\"/><Column size=\"144\"/><Column size=\"85\"/><Column size=\"169\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"매체사코드\"/><Cell col=\"1\" text=\"매체사명\"/><Cell col=\"2\" text=\"매체코드\"/><Cell col=\"3\" text=\"매체명\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"bind:CUST_CODE\"/><Cell col=\"1\" displaytype=\"normal\" edittype=\"none\" editfilter=\"number\" style=\"align: ;\" text=\"bind:CUST_NAME\" editlimit=\"6\" editdisplay=\"edit\"/><Cell col=\"2\" style=\"align: ;\" text=\"bind:RMED_CODE\" editlimit=\"0\"/><Cell col=\"3\" edittype=\"none\" style=\"align: ;\" text=\"bind:RMED_NAME\" editlimit=\"0\" expandshow=\"hide\" expandsize=\"23\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("MDMB0010P03.xfdl", "script::lib_script_common.xjs");
        this.registerScript("MDMB0010P03.xfdl", function() {
        /***************************************************************************************************
         * # Program:	MDMB0010P03 매체조회팝업
         * 
        ...
        this.fn_Search = function (obj) {
        	...
        	this.fnc_DatasetClear('dsMD_CUSTXM'); // 조회 자료 초기화
        	...
        	this.grdMD_CUSTXM.setFocus(); //재 클릭 방지를 위해 Focus 이동
        }
        ...
        this.fn_CreateArgument = function (sKind) {
        	...
        	if (sKind == 'SEARCH00') {
        		...
        		sReturnString += " RMED_NAME=" + this.fnc_Quote(this.fnc_Trim(this.edtSHRRMED_NAME.value)); //브랜드
        ...
        this.fn_PostProcess = function (sMethodName) {
        	...
        	if (sMethodName == "SEARCH00") {
        		...
        		this.fnc_Message("TMM018", this.dsMD_CUSTXM.rowcount);
        ...
        this.fn_Confirm = function (obj,e) {
        	...
        	var cust_code = this.dsMD_CUSTXM.getColumn(this.dsMD_CUSTXM.rowposition,"CUST_CODE");
        	var cust_name = this.dsMD_CUSTXM.getColumn(this.dsMD_CUSTXM.rowposition,"CUST_NAME");
        	var rmed_code = this.dsMD_CUSTXM.getColumn(this.dsMD_CUSTXM.rowposition,"RMED_CODE");
        	var rmed_name = this.dsMD_CUSTXM.getColumn(this.dsMD_CUSTXM.rowposition,"RMED_NAME");
        	var key = this.parent.key;

        	this.opener.fn_CallBackP03(cust_code, cust_name, rmed_code, rmed_name, key);
        ...
        /*----------------+
         |  셀 더블클릭  |
         +----------------*/
        this.grdMD_CUSTXM_oncelldblclick = function(obj,e)
        {
        	this.fn_Confirm();
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdMD_CUSTXM.addEventHandler("onexpanddown", this.fn_HelpDialoge, this);
            this.grdMD_CUSTXM.addEventHandler("oncelldblclick", this.grdMD_CUSTXM_oncelldblclick, this);
            this.edtSHRCUST_NAME.addEventHandler("onkeydown", this.edtSearchText_OnKeyDown, this);

        };

        this.loadIncludeScript("MDMB0010P03.xfdl");
