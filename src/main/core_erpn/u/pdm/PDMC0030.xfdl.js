(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("imgSearchMEDA_CODE", "absolute", "29", "97", "95", "21", null, null, this);
            ...
            obj = new Static("imgSearchUSEX_TYPE", "absolute", "701", "97", "94", "21", null, null, this);
            obj.set_taborder("172");
            obj.set_text("제작용도");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRUSEX_TYPE", "absolute", "768", "97", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("173");
            obj.set_displaynulltext("전체");
            obj.set_cssclass("styFormSearchCombo");

            obj = new Static("imgSearchSTAT_FLAG", "absolute", "905", "97", "93", "21", null, null, this);
            obj.set_taborder("174");
            obj.set_text("진행상태");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRSTAT_FLAG", "absolute", "973", "97", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("cmbSHRMEDA_CODE", "absolute", "109", "97", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("176");
            obj.set_displaynulltext("전체");
            obj.set_cssclass("styFormSearchCombo");

            obj = new Combo("cmbSHRHIGH_LEVL", "absolute", "425", "97", "103", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdPD_ESTIMD02", "absolute", "10", "25", null, null, "753", "10", this.tabIndex.tabpage3);
            obj.set_taborder("41");
         ...
         *  화면 변수 선언부  *
         *********************/
        this.sBUTTONLIST 	= "TTFFTFTF"; //공통기능정의(버튼순으로 T or F)
