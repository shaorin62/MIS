(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("imgHelpSHRJOBN_NUMB", "absolute", "840", "71", "21", "21", null, null, this);
            obj.set_taborder("90");
            ...
            obj = new Static("imgSearchSTAT_FLAG", "absolute", "895", "97", "69", "22", null, null, this);
            obj.set_taborder("134");
            obj.set_text("진행상태");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRSTAT_FLAG", "absolute", "963", "97", "100", "22", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("imgSearchMEDA_CODE00", "absolute", "28", "97", "70", "21", null, null, this);
            ...
            obj = new Combo("cmbSHRHIGH_LEVL", "absolute", "414", "97", "103", "21", null, null, this);
            this.addChild(obj.name, obj);
         ...
         *  화면 변수 선언부  *
         *********************/
        this.sBUTTONLIST 	= "TTFTFTTT"; //공통기능정의(버튼순으로 T or F)
        ...
        {
        	if (this.dsPD_SUJUMH.getRowCount() < 1) return;
