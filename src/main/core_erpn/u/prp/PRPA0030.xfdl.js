    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("PRPA0030");
                this.set_titletext("제작실적집계표(매체별분류)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"YEARMON\" type=\"STRING\" size=\"256\"/><Column id=\"MEDA_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"CNT\" type=\"STRING\" size=\"256\"/><Column id=\"ESTI_AMTX\" type=\"STRING\" size=\"256\"/><Column id=\"DEND_AMTX\" type=\"STRING\" size=\"256\"/><Column id=\"SUJU_AMTX\" type=\"STRING\" size=\"256\"/><Column id=\"NESU_AMTX\" type=\"STRING\" size=\"256\"/><Column id=\"NESU_RATE\" type=\"STRING\" size=\"256\"/><Column id=\"MEDA_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"STAT_FLAG\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("2");
            obj.set_text("제작실적집계표(매체별분류)");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("3");
            obj.set_text("홈 > 제작시스템>결산관리>결산관리>제작실적집계표(매체별분류)");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"320\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell style=\"background: ;\" text=\"제작내용\"/><Cell col=\"1\" style=\"background: ;\" text=\"건수\"/><Cell col=\"2\" style=\"background: ;\" text=\"견적액\"/><Cell col=\"3\" style=\"background: ;\" text=\"청구액\"/><Cell col=\"4\" style=\"background: ;\" text=\"정산액\"/><Cell col=\"5\" style=\"background: ;\" text=\"내수액\"/><Cell col=\"6\" style=\"background: ;\" text=\"내수율(%)\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:MEDA_NAME\"/><Cell col=\"1\" displaytype=\"text\" style=\"align:right;\" text=\"bind:CNT\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"bind:ESTI_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(ESTI_AMTX/STAT_FLAG)\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:DEND_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(DEND_AMTX/STAT_FLAG)\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SUJU_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(SUJU_AMTX/STAT_FLAG)\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" text=\"bind:NESU_AMTX\" mask=\"#,###\" expr=\"expr:nexacro.round(NESU_AMTX/STAT_FLAG)\"/><Cell col=\"6\" displaytype=\"text\" style=\"align:right;\" text=\"bind:NESU_RATE\" expr=\"expr:NESU_RATE + ' %'\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("PRPA0030.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("PRPA0030.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("PRPA0030.xfdl", function() {
        /***************************************************************************************************
         * # Program: 	PRPA0030 제작실적집계표 (매체별분류)
         * 
        ...
        this.fn_Print = function (obj) {
        	...
        	var reportfile 	= "/prp/PRPA0030R01.jrf";
            var dataref 	= new Array();
            var params 		= "";
            
        	dataref[0] 				= new Object();
        	dataref[0].type 		= "TRAN";
        	dataref[0].svcUrl 		= "/core/erp/prp/PRPA0030_PRINT00.do";
        	dataref[0].inDataset 	= ""
        ...
        this.grdPD_REPORT_oncelldblclick = function(obj,e)
        {
        	...
        	//제작 상세 내역 팝업 생성
        	 var sOpenStyle  = "modeless=false";   //Open Sytle(되도록 Modal 사용)
        		...
        		this.fnc_OpenPopup("PRPA0010P01", "prp::PRPA0010P01.xfdl", {sMEDA_CODE : sMEDA_CODE, sYEAR_MONT1 : sYEAR_MONT1, sYEAR_MONT2 : sYEAR_MONT2}, sOpenStyle, "fn_Dialoge_After");	
        }
        ...
        this.loadIncludeScript("PRPA0030.xfdl");
