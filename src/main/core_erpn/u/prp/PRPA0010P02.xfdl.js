(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"JOBN_NUMB\" type=\"STRING\" size=\"256\"/><Column id=\"JOBN_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"MEDA_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"MEDA_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"ESTI_AMTX\" type=\"INT\" size=\"256\"/><Column id=\"DEND_AMTX\" type=\"INT\" size=\"256\"/><Column id=\"SUJU_AMTX\" type=\"INT\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"95\"/><Column size=\"181\"/><Column size=\"0\"/><Column size=\"113\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/><Row size=\"26\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"제작번호\"/><Cell col=\"1\" text=\"제작건명\"/><Cell col=\"2\" text=\"제작내용코드\"/><Cell col=\"3\" text=\"제작내용\"/><Cell col=\"4\" text=\"견적금액\"/><Cell col=\"5\" text=\"청구금액\"/><Cell col=\"6\" text=\"정산금액\"/></Band><Band id=\"body\"><Cell text=\"bind:JOBN_NUMB\"/><Cell col=\"1\" text=\"bind:JOBN_NAME\"/><Cell col=\"2\" text=\"bind:MEDA_CODE\"/><Cell col=\"3\" text=\"bind:MEDA_NAME\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"bind:ESTI_AMTX\" mask=\"#,###\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" text=\"bind:DEND_AMTX\" mask=\"#,###\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SUJU_AMTX\" mask=\"#,###\"/></Band><Band id=\"summary\"><Cell displaytype=\"text\"/><Cell col=\"1\" colspan=\"3\" style=\"align: center;\" text=\"합계\"/><Cell col=\"4\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getSum(&quot;ESTI_AMTX&quot;)\"/><Cell col=\"5\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getSum(&quot;DEND_AMTX&quot;)\"/><Cell col=\"6\" displaytype=\"number\" style=\"align: right;\" expr=\"expr:dataset.getSum(&quot;SUJU_AMTX&quot;)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("PRPA0010P02.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("PRPA0010P02.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("PRPA0010P02.xfdl", function() {
        /***************************************************************************************************
        ...
        this.sDEPT_CODE = this.parent.sDEPT_CODE;
        this.sDEPT_FLAG = this.parent.sDEPT_FLAG;
        ...
        this.fn_CreateArgument = function (sKind) {
        	...
        	if (sKind == "SEARCH20") {
        		...
        		sReturnString += " CUST_CODE=" + this.fnc_Quote(this.sCUST_CODE);
        		
        		//기획팀
        		if(this.sDEPT_FLAG == "0"){
        			sReturnString += " PLAN_DEPT=" + this.fnc_Quote(this.sDEPT_CODE);
        		//제작팀
        		}else if(this.sDEPT_FLAG == "1"){
        			sReturnString += " PROD_DEPT=" + this.fnc_Quote(this.sDEPT_CODE);
        		}
        ...
        this.loadIncludeScript("PRPA0010P02.xfdl");
