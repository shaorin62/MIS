    ...
    return function()
    {
        ...
        this.fn_CreateArgument = function (sKind) {
        	...
        	if (sKind == "SEARCH00") {
        		...
        		sReturnString += " CITY_CODE=" + this.fnc_Quote(this.rdoCITY_CODE.value); 			//법인/개인
        ...
        this.on_initEvent = function()
        {
            ...
            this.rdoCITY_CODE.addEventHandler("onitemchanged", this.rdoCUTY_CODE_onitemchanged, this);
