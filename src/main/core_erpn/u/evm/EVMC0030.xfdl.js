    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("EVMC0030");
                this.set_titletext("조직본인평가");
            ...
            obj = new Static("Static31", "absolute", "583", "71", "68", "21", null, null, this);
            obj.set_taborder("33");
            obj.set_text("사원번호");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdEV_DTEGXM", "absolute", "8", "128", null, null, "25", "15", this);
            ...
            obj = new Static("imgHelpSHREMPL_NUMB", "absolute", "734", "71", "21", "21", null, null, this);
            obj.set_taborder("113");
            obj.set_cssclass("sytHelpPopup");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHREMPL_NAME", "absolute", "757", "71", "100", "21", null, null, this);
            ...
            obj = new Static("Static03", "absolute", "303", "71", "68", "21", null, null, this);
        ...
        // User Script
        this.addIncludeScript("EVMC0030.xfdl", "script::lib_script_common.xjs");
        this.registerScript("EVMC0030.xfdl", function() {
        /***************************************************************************************************
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdEV_DTEGXM.addEventHandler("onexpanddown", this.fn_HelpDialoge, this);
            this.imgHelpSHREMPL_NUMB.addEventHandler("onclick", this.fn_HelpDialoge, this);
            this.imgHelpSHRDEPT_CODE.addEventHandler("onclick", this.fn_HelpDialoge, this);

        };

        this.loadIncludeScript("EVMC0030.xfdl");
