(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("9");
            obj.set_text("조직목표설정서등록");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("10");
            obj.set_text("홈 > 인사관리 > 조직평가");
            ...
            obj = new Grid("grdEV_DTEGXM", "absolute", "8", "128", null, null, "25", "156", this);
            obj.set_taborder("1");
            ...
            obj = new Static("Static31", "absolute", "311", "71", "68", "21", null, null, this);
            ...
            obj = new Static("Static11", "absolute", "319", null, "83", "21", null, "111", this);
            ...
            obj = new Edit("edtPRWK_CNTT", "absolute", "145", null, null, "21", "46", "85", this);
            obj.set_taborder("5");
            ...
            obj = new TextArea("txtPROB_CNTT", "absolute", "145", null, null, "56", "46", "24", this);
            obj.set_taborder("6");
            obj.set_imemode("hangul");
            ...
            obj = new Static("Static00", "absolute", "577", null, "83", "21", null, "111", this);
            obj.set_taborder("164");
            obj.set_text("평가지표");
            obj.set_cssclass("styFormSearchCapBe");
            this.addChild(obj.name, obj);

            obj = new Edit("edtEVBS_CNTT", "absolute", "657", null, null, "21", "46", "111", this);
            obj.set_taborder("4");
            obj.set_imemode("hangul");
            ...
            obj = new MaskEdit("medTAIP_RATE", "absolute", "402", null, "100", "21", null, "111", this);
            obj.set_taborder("3");
            obj.set_mask("###");
            obj.set_type("number");
            obj.set_maskchar(" ");
            ...
            obj = new Edit("edtSHRDEPT_CODE", "absolute", "352", "71", "80", "21", null, null, this);
            ...
            obj = new Static("imgHelpSHRDEPT_CODE", "absolute", "434", "71", "21", "21", null, null, this);
            obj.set_taborder("166");
            obj.set_cssclass("sytHelpPopup");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRDEPT_NAME", "absolute", "457", "71", "100", "21", null, null, this);
            obj.set_taborder("167");
            obj.set_cssclass("styFormSearchItem");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Static("stInformation1", "absolute", "646", "71", "302", "21", null, null, this);
            ...
            obj = new Static("Static01", "absolute", "601", "71", "43", "21", null, null, this);
            ...
            obj = new BindItem("item0","edtSEQN_NUMB","value","dsEV_DTEGXM","SEQN_NUMB");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","medTAIP_RATE","value","dsEV_DTEGXM","TAIP_RATE");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","edtEVBS_CNTT","value","dsEV_DTEGXM","EVBS_CNTT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","edtPRWK_CNTT","value","dsEV_DTEGXM","PRWK_CNTT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","txtPROB_CNTT","value","dsEV_DTEGXM","PROB_CNTT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("EVMC0010.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("EVMC0010.xfdl", "script::lib_script_ubireport.xjs");
        this.registerScript("EVMC0010.xfdl", function() {
        /***************************************************************************************************
        ...
        this.loadIncludeScript("EVMC0010.xfdl");
