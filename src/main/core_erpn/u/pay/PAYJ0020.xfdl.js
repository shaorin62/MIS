(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("PAYJ0020.xfdl", "script::lib_script_common.xjs");
        this.registerScript("PAYJ0020.xfdl", function() {

        /****************************************************************************************************
        /*
         * @explanation		평균인원실적를 관리한다.
         * @category	 	급여관리/평균인원실적
         * @author	   	고민주
         * @cdate	  		2016.08.02
         * @version 1.0		최초 작성
         * PAYJ0020.xml - <Created by Code Template generator>
         *
         *   Form Common Script                                                                             *
        ...
        this.loadIncludeScript("PAYJ0020.xfdl");
