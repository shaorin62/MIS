(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cmbCRET_FLAG", "absolute", null, "139", "108", "21", "134", null, this);
            this.addChild(obj.name, obj);
        ...
        this.fn_Save = function (obj) {
        	...
        	if(!this.fnc_Message("TMM140", "세금계산서 품목을 수정하시겠습니까?. ")){return ;};
