(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"NAME\" size=\"256\" prop=\"default\" type=\"STRING\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">A00A</Col><Col id=\"NAME\">전파</Col></Row><Row><Col id=\"CODE\">A00B</Col><Col id=\"NAME\">전파 외</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static10", "absolute", "666", "71", "71", "21", null, null, this);
            obj.set_taborder("242");
            obj.set_text("금액단위");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRMONY_UNIT", "absolute", "734", "71", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
        ...
        this.on_initEvent = function()
        {
            ...
            this.edtSHRMEDX_CDNM.addEventHandler("onkillfocus", this.fn_HelpDialoge, this);
