(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DSNAME\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"CODEID\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"HEADFLAG\" size=\"256\" prop=\"default\" type=\"STRING\"/><Column id=\"REMK\" size=\"256\" prop=\"default\" type=\"STRING\"/></ColumnInfo><Rows><Row><Col id=\"CODEID\">WODN_CODE</Col><Col id=\"DSNAME\">dsSHRWODN_CODE</Col><Col id=\"HEADFLAG\">ALL</Col><Col id=\"REMK\"/></Row><Row><Col id=\"DSNAME\">dsCADN_CODE</Col><Col id=\"CODEID\">CADN_CODE</Col><Col id=\"HEADFLAG\">EMPTY</Col><Col id=\"REMK\"/></Row></Rows>");
            ...
            obj = new Static("imgHelpSHRYEA_DEPT_CD", "absolute", "328", "71", "22", "21", null, null, this);
            ...
            obj = new Static("Image0", "absolute", "479", "71", "44", "21", null, null, this);
            obj.set_text("사원");
            obj.set_cssclass("styFormSearchCap");
            obj.style.set_align("left");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("imgHelpSHRYEA_EMP_NO", "absolute", "603", "71", "22", "21", null, null, this);
            obj.set_cssclass("sytHelpPopup");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Image1", "absolute", "756", "71", "60", "21", null, null, this);
            obj.set_text("재직구분");
            obj.set_cssclass("styFormSearchCap");
            obj.style.set_align("left");
            this.addChild(obj.name, obj);

            obj = new Combo("cmbSHRYEA_INOFFICE_CD", "absolute", "824", "71", "81", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj.set_url("yea::YEAA0060_2016.xfdl");
            this.addChild(obj.name, obj);
        ...
        this.loadPreloadList = function()
        {
            ...
            this._addPreloadList("fdl", "yea::YEAA0060_2016.xfdl");
        };
        
        // User Script
        this.addIncludeScript("YEAA0060.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("YEAA0060.xfdl", "script::lib_script_common_YEA.xjs");
        this.registerScript("YEAA0060.xfdl", function() {
        /***************************************************************************************************
        ...
        this.fn_PostProcess = function (sMethodName) {
        	if (sMethodName == "GetCommCode") {
        		...
        		arrParam[arrInt++]  = "GRID,div_Proc.grdYEA_INCDEC,dsCADN_CODE,YEA_PRC_STR002";
        ...
        this.fn_HelpDialoge = function (obj,sFromDs,sOldValue,sColumnID) {
        	...
        	if ((obj.name == "imgHelpSHRYEA_DEPT_CD") || (obj.name == "edtSHRYEA_DEPT_NM")) { // 부서정보조회SHR(Popup)
        		arrParam[0] = "TMM0004";
        		arrParam[1] = "";
        		arrParam[2] = this.fnc_Trim(this.edtSHRYEA_DEPT_NM.value);
        		arrParam[3] = "N";
        		arrParam[4] = "edtSHRYEA_DEPT_NM";
        		arrParam[5] = "edtSHRYEA_DEPT_CD,edtSHRYEA_DEPT_NM";
        		arrParam[6] = "0,1";

        	} else if ((obj.name == "imgHelpSHRYEA_EMP_NO") || (obj.name == "edtSHRYEA_EMP_NM")) { // 사원정보조회SHR(Popup)
        		arrParam[0] = "HRM0001";
        		arrParam[1] = "";
        		arrParam[2] = this.fnc_Trim(this.edtSHRYEA_EMP_NM.value);
        		arrParam[3] = "N";
        		arrParam[4] = "edtSHRYEA_EMP_NM";
        		arrParam[5] = "edtSHRYEA_EMP_NO,edtSHRYEA_EMP_NM";
        		arrParam[6] = "0,1";
        ...
        this.spnSHRYEA_STD_YY_onchanged = function(obj,e) {
        	if ( this.fnc_Trim(this.spnSHRYEA_STD_YY.value).substr(0, 4) != this.fnc_Trim(this.div_Proc.url).substr(this.fnc_Length(this.fnc_Trim(this.div_Proc.url)) - 9, 4) ) {
        		if ( this.fnc_Trim(this.spnSHRYEA_STD_YY.value).substr(0, 4) < "2016" ) { 
        			this.div_Proc.set_url("yea::YEAA0060_2015.xfdl");
        			...
        			this.div_Proc.set_url("yea::YEAA0060_2016.xfdl");
        		} else if ( this.fnc_Trim(this.spnSHRYEA_STD_YY.value).substr(0,4) > "2015" ) {
        			this.div_Proc.set_url("yea::YEAA0060_2016.xfdl");
        		}
        	}
        ...
        this.loadIncludeScript("YEAA0060.xfdl");
