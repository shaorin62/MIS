    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("YEAA0110");
                this.set_titletext("기부금전산매체");
            ...
            obj = new Static("st_FormTitle", "absolute", "8", "0", null, "29", "768", null, this);
            obj.set_text("기부금전산매체");
            ...
            obj = new Div("divButtonList", "absolute", "8", "35", "341", "21", null, null, this);
            obj.set_taborder("10");
            obj.set_text("");
            ...
            obj = new CheckBox("chkSHRYEA_CHEK_EMPL", "absolute", "114", "3", null, "15", "89", null, this.divButtonList);
            obj.set_taborder("2");
            obj.set_text("소급대상자만 조회");
            ...
            obj = new Edit("medSHRYEA_DEDUCTION_AMT", "absolute", "711", "71", "80", "21", null, null, this);
            obj.set_taborder("15");
            ...
            obj.set_url("yea::YEAA0110_2016.xfdl");
            this.addChild(obj.name, obj);

            obj = new Static("Image02", "absolute", "617", "71", "94", "21", null, null, this);
            obj.set_taborder("17");
            obj.set_text("기부금공제금");
            obj.set_cssclass("styFormSearchCapBe");
            obj.set_visible("false");
            ...
            obj = new Static("Image03", "absolute", "785", "71", "78", "21", null, null, this);
            obj.set_taborder("18");
            obj.set_text("만원이상");
            ...
            obj.set_taborder("34");
            obj.set_text("홈 > 급여관리 > 연말정산 > 기부금전산매체");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 341, 21, this.divButtonList,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("10");
            		p.set_text("");
        ...
        {
            this._addPreloadList("fdl", "yea::YEAA0110_2016.xfdl");
            this._addPreloadList("fdl", "common::comButtonType01.xfdl");
        };
        
        // User Script
        this.addIncludeScript("YEAA0110.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("YEAA0110.xfdl", "script::lib_script_common_YEA.xjs");
        this.registerScript("YEAA0110.xfdl", function() {
        /***************************************************************************************************
        ...
        this.on_initEvent = function()
        {
            ...
            this.medSHRYEA_DEDUCTION_AMT.addEventHandler("onkillfocus", this.fn_HelpDialoge, this);
            this.btn_favorite.addEventHandler("onclick", this.btn_favorite_onclick, this);
            this.cmbSHRYEA_BRANCH_CD.addEventHandler("onsetfocus", this.fn_EditFocus, this);

        };

        this.loadIncludeScript("YEAA0110.xfdl");
