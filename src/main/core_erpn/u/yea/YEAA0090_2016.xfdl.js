    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("연말정산전산매체(2016)");
        ...
        // User Script
        this.addIncludeScript("YEAA0090_2016.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("YEAA0090_2016.xfdl", "script::lib_script_common_YEA.xjs");
        this.registerScript("YEAA0090_2016.xfdl", function() {
        /***************************************************************************************************
        ...
        this.sPACKAGENAME = "YEAA0090_2016"; //해당 Form에서 사용 할 Package 명
        this.sFILE_NAME   = "";			//파일명
        ...
        this.loadIncludeScript("YEAA0090_2016.xfdl");
