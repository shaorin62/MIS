    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("YEAA0100");
                this.set_titletext("의료비전산매체");
            ...
            obj = new Div("divButtonList", "absolute", "8", "35", "125", "21", null, null, this);
            obj.set_taborder("4");
            obj.set_text("");
            ...
            obj = new Static("Image1", "absolute", "433", "71", "52", "21", null, null, this);
            obj.set_text("제출일");
            obj.set_cssclass("styFormSearchCapBe");
            obj.set_taborder("18");
            this.addChild(obj.name, obj);
            ...
            obj.set_async("true");
            obj.set_text("div_Proc");
            obj.set_url("yea::YEAA0100_2016.xfdl");
            this.addChild(obj.name, obj);

            obj = new Static("img_deduction", "absolute", "616", "71", "104", "21", null, null, this);
            obj.set_taborder("20");
            obj.set_text("의료비공제금액");
            obj.set_cssclass("styFormSearchCapBe");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("medSHRYEA_DEDUCTION_AMT", "absolute", "723", "71", "80", "21", null, null, this);
            obj.set_taborder("21");
            obj.set_type("number");
            obj.set_mask("####");
            obj.set_cssclass("styFormSearchItem");
            ...
            obj = new Static("sta_deduction", "absolute", "797", "71", "74", "21", null, null, this);
            obj.set_taborder("22");
            obj.set_text("만원이상");
            ...
            obj.set_taborder("38");
            obj.set_text("의료비전산매체");
            obj.set_cssclass("styFormTitle");
            this.addChild(obj.name, obj);

            obj = new Static("st_FormLocation", "absolute", null, "0", "640", "29", "25", null, this);
            obj.set_taborder("39");
            obj.set_text("홈 > 급여관리 > 연말정산 > 의료비전산매체");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 125, 21, this.divButtonList,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("4");
            		p.set_text("");
        ...
        {
            this._addPreloadList("fdl", "yea::YEAA0100_2016.xfdl");
            this._addPreloadList("fdl", "common::comButtonType01.xfdl");
        };
        
        // User Script
        this.addIncludeScript("YEAA0100.xfdl", "script::lib_script_common.xjs");
        this.addIncludeScript("YEAA0100.xfdl", "script::lib_script_common_YEA.xjs");
        this.registerScript("YEAA0100.xfdl", function() {
        /***************************************************************************************************
         * # Program: 	YEAA0100 의료비전산매체
         *
        ...
        this.sPACKAGENAME = 'YEAA0100'; //해당 Form에서 사용 할 Package 명
        this.sFILE_NAME   = "";			//파일명
        ...
        this.medSHRYEA_STD_YY_OnChanged = function(obj,e) {
        	if ( this.fnc_Trim(this.medSHRYEA_STD_YY.value).substr(0, 4) != this.fnc_Trim(this.div_Proc.url).substr(this.fnc_Length(this.fnc_Trim(this.div_Proc.url)) - 9, 4) ) {
        		if ( this.fnc_Trim(this.medSHRYEA_STD_YY.value).substr(0, 4) < "2016" ) { 
        			this.div_Proc.set_url("yea::YEAA0100_2015.xfdl");
        			...
        			this.div_Proc.set_url("yea::YEAA0100_2016.xfdl");
        		} else if ( this.fnc_Trim(this.medSHRYEA_STD_YY.value).substr(0,4) > "2015" ) {
        			this.div_Proc.set_url("yea::YEAA0100_2016.xfdl");
        		}
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.cmbSHRYEA_BRANCH_CD.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            ...
            this.medSHRYEA_DEDUCTION_AMT.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            this.btn_favorite.addEventHandler("onclick", this.btn_favorite_onclick, this);

        };

        this.loadIncludeScript("YEAA0100.xfdl");
