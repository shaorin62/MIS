    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("MCMA0090");
                this.set_titletext("매체계약서파일관리");
            ...
            obj = new Dataset("dsMD_CTFLXM", this);
            ...
            obj = new Grid("grdMD_CTFLXM", "absolute", "8", "128", null, null, "25", "15", this);
            ...
            obj.set_binddataset("dsMD_CTFLXM");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"25\" band=\"left\"/><Column size=\"180\"/><Column size=\"260\"/><Column size=\"140\"/><Column size=\"140\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" expr=\"0\"/><Cell col=\"1\" style=\"background:transparent;\" cssclass=\"Cellgrd_WF_essential\" text=\"파일번호\"/><Cell col=\"2\" style=\"background:transparent URL('theme://images/ico_grd_edit.png') left top;\" cssclass=\"Cellgrd_WF_essential\" text=\"파일명\"/><Cell col=\"3\" text=\"등록자\"/><Cell col=\"4\" text=\"등록일자\"/><Cell col=\"5\" text=\"파일업로드\"/><Cell col=\"6\" text=\"파일다운로드\"/></Band><Band id=\"body\"><Cell celltype=\"none\" displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:CHEK_FILD\"/><Cell col=\"1\" displaytype=\"number\" edittype=\"none\" style=\"font:9 굴림체;cursor:pointer;\" text=\"bind:FILE_NUMB\"/><Cell col=\"2\" displaytype=\"normal\" edittype=\"text\" text=\"bind:FILE_NAME\"/><Cell col=\"3\" text=\"bind:INST_USID\"/><Cell col=\"4\" text=\"bind:INST_DATE\"/><Cell col=\"5\" displaytype=\"button\" edittype=\"button\" style=\"cursor:hand;\" text=\"파일업로드\"/><Cell col=\"6\" displaytype=\"button\" edittype=\"button\" style=\"cursor:hand;\" text=\"파일다운로드\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("imgSearchTitle02", "absolute", "348", "70", "65", "22", null, null, this);
            ...
            obj = new Edit("edtSHRFILE_NAME", "absolute", "403", "70", "150", "22", null, null, this);
            ...
            obj = new Static("Static00", "absolute", "395", "61", "8", "41", null, null, this);
        ...
        // User Script
        this.addIncludeScript("MCMA0090.xfdl", "script::lib_script_common.xjs");
        this.registerScript("MCMA0090.xfdl", function() {
         /***************************************************************************************************
          * # Program : MCMA0090 매체계약서파일관리
         * 
        ...
        this.fn_Search = function (obj) {
        	...
        	this.fnc_DatasetClear("dsMD_CTFLXM");
        	var sMethodName = "SEARCH00";
        	var sInDataSet  = "";
        	var sOutDataSet = "dsMD_CTFLXM=dsMD_CTFLXM";
        	var sArgument   = this.fn_CreateArgument(sMethodName);
        	this.fnc_TransactionCall(this, this.sPACKAGENAME,sMethodName, sInDataSet, sOutDataSet, sArgument, "fn_CallBack");
        	this.grdMD_CTFLXM.setFocus();
        }
        ...
        this.fn_Input = function (obj) {
        	var iRow = this.dsMD_CTFLXM.insertRow(this.dsMD_CTFLXM.rowposition + 1);
        	this.dsMD_CTFLXM.set_rowposition(iRow);
        	this.dsMD_CTFLXM.setCellPos(this.fnc_GridColumnIndex(this.grdMD_CTFLXM, 0));
        	this.dsMD_CTFLXM.setFocus();
        }
        ...
        this.fn_Delete = function (obj) {
        	...
        	for(var i=0 ; i<this.dsMD_CTFLXM.rowcount ; i++){
        		if(this.dsMD_CTFLXM.getColumn(i,"CHEK_FILD") == '1'){totalNum ++;}
        	}
        	
        	if (this.fn_DeleteCheck(totalNum)) {
        		var rowCnt = this.dsMD_CTFLXM.rowcount;
        		for(var i=(rowCnt-1); i>=0; i--){
        			if(this.dsMD_CTFLXM.getColumn(i,"CHEK_FILD") == '1'){
        				this.dsMD_CTFLXM.deleteRow(i);
        			}
        		}
        	}
        }
        ...
        this.fn_Cancel = function (obj) {
        	...
        	this.fnc_DataSetCancel("dsMD_CTFLXM");
        	this.grdMD_CTFLXM.setFocus();
        ...
        this.fn_Save = function (obj) {
        	...
        	this.sKeyValue[0] = this.dsMD_CTFLXM.getColumn(this.dsMD_CTFLXM.rowposition,"FILE_NUMB");
        	var sMethodName = "SAVE00";
        	var sInDataSet = "dsMD_CTFLXM=dsMD_CTFLXM:U dsFL_ATTACH=dsFL_ATTACH:U";
        	var sOutDataSet = "";
        	var sArgument = this.fn_CreateArgument(sMethodName);
        	this.fnc_TransactionCall(this, this.sPACKAGENAME, sMethodName, sInDataSet, sOutDataSet, sArgument, "fn_CallBack");
        	this.grdMD_CTFLXM.setFocus();
        ...
        this.fn_FormUnloadCheckProcess = function(obj,e) {
        	 ...
        	 var sMessage = this.fnc_FormUnloadCheck("dsMD_CTFLXM", this);
        ...
        this.fn_SearchItemCheck = function () {
        	...
        	if (this.fnc_DatasetChangeCheck("dsMD_CTFLXM")) {
        ...
        this.fn_SaveItemCheck = function () {
        	if (!this.fnc_DatasetChangeCheck("dsMD_CTFLXM,dsFL_ATTACH")) {
        ...
        this.fn_DeleteCheck = function (totalNum) {
        	if (totalNum < 1) {
        		...
        		var grdMD_CTFLXM = this.grdMD_CTFLXM;
        		var sQuestionText  = "파일명 : ("+grdMD_CTFLXM.getCellText(grdMD_CTFLXM.currentrow, grdMD_CTFLXM.getBindCellIndex( "body", "FILE_NAME" )) + ")";
        ...
        this.fn_PostProcess = function (sMethodName) {
        	...
        	if (sMethodName == "SEARCH00") {
        		this.fnc_Information(this.stInformation1, this.dsMD_CTFLXM.getCaseCount("dataset.getRowLevel(currow)==0"), "SHR");
        		this.fnc_Message("TMM018", this.dsMD_CTFLXM.getCaseCount("dataset.getRowLevel(currow)==0"));
        ...
        /*----------------------+
         ...
         +----------------------*/
        var isAllChecked = 0;
        this.grdMD_CTFLXM_onheadclick = function(obj,e)
        {
        		if (e.cell == 0) {
        		var v_Colid = this.grdMD_CTFLXM.getCellProperty("body", e.cell, "text").replace("bind:", "");
        		isAllChecked = (isAllChecked ? 0 : 1);
        		
        		for (var i = 0; i < this.dsMD_CTFLXM.getRowCount(); i++) {
        			this.dsMD_CTFLXM.setColumn(i, v_Colid, isAllChecked);
        		}
        		this.dsMD_CTFLXM.setCellProperty("Head", 0, "expr", isAllChecked);
        	}
        }
        ...
        /*----------------+
         | 	 파일업로드  |
         +----------------*/
        this.grdMD_CTFLXM_oncellclick = function(obj,e)
        {	
        	if(this.grdMD_CTFLXM.getCellText(e.row,e.col)=="파일업로드") {
        	...
        	} else if(this.grdMD_CTFLXM.getCellText(e.row,e.col)=="파일다운로드") {
        		//다운로드 펑션
        		var filePath   = this.dsMD_CTFLXM.getColumn(e.row,"FILE_PATH");
        		var phyFileNm  = this.dsMD_CTFLXM.getColumn(e.row,"PFIL_NAME");
        		var realFileNm = this.dsMD_CTFLXM.getColumn(e.row,"LFIL_NAME");
        ...
        this.fn_CallFileUplodCallback = function(robjds,form) {
        	...
        	var objmainds =form.dsMD_CTFLXM;
        	
        	var objmaingrd = form.grdMD_CTFLXM;
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdMD_CTFLXM.addEventHandler("onheadclick", this.grdMD_CTFLXM_onheadclick, this);
            this.grdMD_CTFLXM.addEventHandler("oncellclick", this.grdMD_CTFLXM_oncellclick, this);
        ...
        this.loadIncludeScript("MCMA0090.xfdl");
