    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HRMD0100");
                this.set_titletext("근속현황(직위별/성별)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"SECT_CODE\" type=\"string\" size=\"32\" prop=\"\"/><Column id=\"SECT_NAME\" type=\"string\" size=\"32\" prop=\"\"/><Column id=\"DEPT_CODE\" type=\"string\" size=\"32\" prop=\"\"/><Column id=\"DEPT_NAME\" type=\"string\" size=\"32\" prop=\"\"/><Column id=\"GNDR_CODE\" type=\"string\" size=\"32\" prop=\"\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"100\"/><Column size=\"100\"/><Column size=\"70\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell text=\"소속\"/><Cell col=\"1\" text=\"부서\"/><Cell col=\"2\" text=\"성별\"/></Band><Band id=\"body\" style=\"cellbackground: ;\"><Cell style=\"align:left;background: ;\" text=\"bind:SECT_NAME\" suppress=\"2\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:DEPT_NAME\" suppress=\"1\"/><Cell col=\"2\" style=\"align:center;\" text=\"bind:GNDR_CODE\"/><Cell col=\"3\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("imgSearchTitle4", "absolute", "28", "71", "63", "21", null, null, this);
            obj.set_text("기준일");
        ...
        // User Script
        this.addIncludeScript("HRMD0100.xfdl", "script::lib_script_common.xjs");
        this.registerScript("HRMD0100.xfdl", function() {
        /***************************************************************************************************
         * # Program:   HRMD0100 근속현황(직급별/성별)
         *
        ...
        this.fn_PostProcess = function (sMethodName) {
        	...
        	if (sMethodName == "SEARCH00") {
        		...
        		this.dsTM_CODEXD.setColumn(nRow, "EXPD_NAME", "총계");
        		...
        		var aParams = new Array();
        			...
        			aParams[3] = 'GNDR_CODE == "남자"&GNDR_CODE == "여자"&'; // expr 조건
        ...
        this.loadIncludeScript("HRMD0100.xfdl");
