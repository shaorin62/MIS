    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HRMB0010P01");
                this.set_scrollbars("none");
                this.set_titletext("인사정보 이미지 상세보기");
            ...
            obj = new Static("Static06", "absolute", null, "8", "15", "461", "0", null, this);
            obj.set_taborder("12");
            obj.set_text("w\r\n15");
            obj.set_cssclass("sta_GID_box");
            obj.set_visible("false");
        ...
        // User Script
        this.addIncludeScript("HRMB0010P01.xfdl", "script::lib_script_common.xjs");
        this.registerScript("HRMB0010P01.xfdl", function() {
        /***************************************************************************************************
         * # Program: 	HRMB0010P01 인사정보 이미지 상세보기
         * 
         * # Modification Information
         * -------------------------------------------------------------------------------------------------
         *   Date			Modifier	Comment
         * -------------------------------------------------------------------------------------------------
         *   2016.08.31		안윤준		Initial Created.
         *   
         * -------------------------------------------------------------------------------------------------
        ...
        this.fn_ImageStretch = function () {
        	...
        	if (this.imgASST_PHOTO.stretch == "fit") {
        		this.btnASST_PHOTO.set_text("화면에맞게");
        		this.imgASST_PHOTO.set_stretch("none");

        	} else {
        		this.btnASST_PHOTO.set_text("원본이미지");
        ...
        this.loadIncludeScript("HRMB0010P01.xfdl");
