    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HRMA0020");
                this.set_titletext("조직개편기초등록");
            ...
            obj = new Dataset("dsTM_SIMUXM", this);
            obj._setContents("<ColumnInfo><Column id=\"SMUL_SEQN\" size=\"10\" type=\"STRING\"/><Column id=\"SMUL_NAME\" size=\"50\" type=\"STRING\"/><Column id=\"APLY_DATE\" size=\"8\" type=\"STRING\"/><Column id=\"REMK_500X\" size=\"500\" type=\"STRING\"/><Column id=\"COYS_YSNO\" size=\"1\" type=\"STRING\"/><Column id=\"FILE_IDXX\" size=\"100\" type=\"STRING\"/><Column id=\"FILE_PATH\" size=\"256\" type=\"STRING\"/><Column id=\"PFIL_NAME\" size=\"256\" type=\"STRING\"/><Column id=\"LFIL_NAME\" size=\"256\" type=\"STRING\"/><Column id=\"EXTN_NAME\" size=\"256\" type=\"STRING\"/><Column id=\"DRFR_EMNR\" type=\"STRING\" size=\"256\"/><Column id=\"DRFR_DTCD\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Grid("grdTM_SIMUXM", "absolute", "8", "132", null, null, "25", "15", this);
            obj.set_selecttype("row");
            obj.set_autoenter("TRUE");
            obj.set_binddataset("dsTM_SIMUXM");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"95\"/><Column size=\"170\"/><Column size=\"268\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"65\"/></Columns><Rows><Row size=\"29\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell style=\"background: ;\" cssclass=\"Cellgrd_WF_essential\" text=\"적용일\"/><Cell col=\"1\" style=\"background: ;\" cssclass=\"Cellgrd_WF_essential\" text=\"조직개편명\"/><Cell col=\"2\" style=\"backgroundimage: ;\" cssclass=\"Cellgrd_WF_edit\" text=\"비고\"/><Cell col=\"3\" style=\"background: ;\" text=\"업로드\"/><Cell col=\"4\" style=\"background: ;\" text=\"다운로드\"/><Cell col=\"5\" style=\"background: ;\" text=\"확정여부\"/></Band><Band id=\"body\"><Cell displaytype=\"date\" edittype=\"date\" text=\"bind:APLY_DATE\" calendardisplaynulltype=\"none\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"expr:COYS_YSNO == &quot;1&quot; ? &quot;none&quot; : &quot;text&quot;\" style=\"align:left;\" text=\"bind:SMUL_NAME\" editlimit=\"50\" editlengthunit=\"ascii\"/><Cell col=\"2\" displaytype=\"text\" edittype=\"expr:COYS_YSNO == &quot;1&quot; ? &quot;none&quot; : &quot;text&quot;\" style=\"align:left;\" text=\"bind:REMK_500X\" editlimit=\"500\" editlengthunit=\"ascii\"/><Cell col=\"3\" displaytype=\"expr:COYS_YSNO == &quot;1&quot; ? &quot;none&quot; : &quot;button&quot;\" text=\"expr:COYS_YSNO == &quot;1&quot; ? &quot;&quot; : &quot;업로드&quot;\"/><Cell col=\"4\" displaytype=\"expr:PFIL_NAME == &quot;&quot; ? &quot;none&quot; : &quot;button&quot;\" text=\"expr:PFIL_NAME == &quot;&quot; ? &quot;&quot; : &quot;다운로드&quot;\"/><Cell col=\"5\" displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:COYS_YSNO\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("imgSearchTitle01", "absolute", "28", "70", "74", "22", null, null, this);
            obj.set_taborder("12");
            obj.set_text("조직개편명");
            ...
            obj.set_taborder("17");
            obj.set_text("인사관리>조직관리>조직개편기초등록");
            ...
            obj = new Edit("edtSHRSMUL_NAME", "absolute", "109", "70", "200", "22", null, null, this);
            obj.set_taborder("28");
        ...
        // User Script
        this.addIncludeScript("HRMA0020.xfdl", "script::lib_script_common.xjs");
        this.registerScript("HRMA0020.xfdl", function() {
        /***************************************************************************************************
        ...
        this.grdTM_SIMUXM_oncellclick = function(obj,e) {
        ...
        {
            this.dsTM_SIMUXM.addEventHandler("onrowposchanged", this.fn_KeyFieldDisible, this);
            this.dsTM_SIMUXM.addEventHandler("oncolumnchanged", this.dsTM_SIMUXM_oncolumnchanged, this);
            this.addEventHandler("onkeydown", this.fn_HotKey, this);
            this.addEventHandler("onload", this.fn_FormLoadSetting, this);
            this.addEventHandler("onclose", this.fn_FormUnloadProcess, this);
            this.addEventHandler("onbeforeclose", this.fn_FormUnloadCheckProcess, this);
            this.grdTM_SIMUXM.addEventHandler("onexpandup", this.fn_HelpDialoge, this);
            this.grdTM_SIMUXM.addEventHandler("oncellclick", this.grdTM_SIMUXM_oncellclick, this);
            this.btn_favorite.addEventHandler("onclick", this.btn_favorite_onclick, this);
            this.edtSHRSMUL_NAME.addEventHandler("onsetfocus", this.fn_EditFocus, this);

        };

        this.loadIncludeScript("HRMA0020.xfdl");
