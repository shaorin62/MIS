    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HRMC0170");
                this.set_titletext("장기근속현황");
            ...
            obj = new Static("imgSearchTitle0", "absolute", "28", "71", "73", "21", null, null, this);
            obj.set_text("조회일자");
            ...
            obj = new Static("imgSearchTitle4", "absolute", "224", "71", "46", "21", null, null, this);
            obj.set_taborder("42");
            obj.set_text("부서");
            ...
            obj = new Edit("edtSHRDEPT_CODE", "absolute", "266", "71", "80", "21", null, null, this);
            obj.set_taborder("43");
            ...
            obj = new Static("imgHelpSHRDEPT_CODE", "absolute", "348", "71", "21", "21", null, null, this);
            obj.set_taborder("44");
            obj.set_cssclass("sytHelpPopup");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHRDEPT_NAME", "absolute", "371", "71", "100", "21", null, null, this);
            obj.set_taborder("45");
            obj.set_autoselect("true");
            obj.set_cssclass("styFormSearchItem");
            obj.set_visible("true");
            ...
            obj = new Static("imgSearchTitle3", "absolute", "500", "71", "46", "21", null, null, this);
            obj.set_taborder("46");
            obj.set_text("사원");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHREMPL_NUMB", "absolute", "542", "71", "80", "21", null, null, this);
            obj.set_taborder("47");
            ...
            obj = new Static("imgHelpSHREMPL_NUMB", "absolute", "624", "71", "22", "21", null, null, this);
            obj.set_taborder("48");
            obj.set_cssclass("sytHelpPopup");
            obj.style.set_align("top");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSHREMPL_NAME", "absolute", "647", "71", "100", "21", null, null, this);
            obj.set_taborder("49");
            ...
            obj = new Static("Image02", "absolute", "777", "71", "120", "21", null, null, this);
            obj.set_taborder("50");
            obj.set_text("장기근속대상여부");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new CheckBox("chkSHRCWRK_YCNT", "absolute", "898", "71", "19", "21", null, null, this);
            obj.set_taborder("51");
            obj.set_value("0");
            obj.set_truevalue("1");
            ...
            obj = new Grid("grdHR_MASTXM", "absolute", "8", "127", null, null, "25", "15", this);
            ...
            obj._setContents("<Formats><Format id=\"Default\"><Columns><Column size=\"100\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"85\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"120\"/></Columns><Rows><Row size=\"39\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell text=\"사원번호\"/><Cell col=\"1\" text=\"성명\"/><Cell col=\"2\" text=\"소속\"/><Cell col=\"3\" text=\"부서\"/><Cell col=\"4\" text=\"직위\"/><Cell col=\"5\" text=\"직급\"/><Cell col=\"6\" text=\"그룹입사일\"/><Cell col=\"7\" text=\"당사입사일&#13;&#10;(정규직전환일)\"/><Cell col=\"8\" text=\"기준일\"/><Cell col=\"9\" text=\"근속년수\"/><Cell col=\"10\" text=\"근속일수\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" style=\"align:center;\" text=\"bind:EMPL_NUMB\"/><Cell col=\"1\" displaytype=\"text\" text=\"bind:EMPL_NAME\"/><Cell col=\"2\" displaytype=\"text\" style=\"align:left;\" text=\"bind:SECT_NAME\"/><Cell col=\"3\" displaytype=\"text\" style=\"align:left;\" text=\"bind:DEPT_NAME\"/><Cell col=\"4\" displaytype=\"text\" style=\"align:left;\" text=\"bind:OPOS_NAME\"/><Cell col=\"5\" displaytype=\"text\" style=\"align:left;\" text=\"bind:CPOS_NAME\"/><Cell col=\"6\" displaytype=\"date\" style=\"align:center;\" text=\"bind:PCOP_JCDT\" calendardisplaynulltype=\"none\"/><Cell col=\"7\" displaytype=\"date\" style=\"align:center;\" text=\"bind:ENCO_DATE\" calendardisplaynulltype=\"none\"/><Cell col=\"8\" displaytype=\"date\" style=\"align:center;\" text=\"bind:STDS_DATE\" calendardisplaynulltype=\"none\"/><Cell col=\"9\" displaytype=\"text\" style=\"align:center;\" text=\"bind:CWRK_YCNT\"/><Cell col=\"10\" displaytype=\"text\" style=\"align:left;\" text=\"bind:CWRK_DCNT\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("HRMC0170.xfdl", "script::lib_script_common.xjs");
        this.registerScript("HRMC0170.xfdl", function() {
        /***************************************************************************************************
        ...
        this.on_initEvent = function()
        {
            ...
            this.chkSHRCWRK_YCNT.addEventHandler("onsetfocus", this.fn_EditFocus, this);
            this.btn_favorite.addEventHandler("onclick", this.btn_favorite_onclick, this);

        };

        this.loadIncludeScript("HRMC0170.xfdl");
