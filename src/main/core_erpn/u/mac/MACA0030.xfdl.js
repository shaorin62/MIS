(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static08", "absolute", null, "113", "64", "21", "350", null, this);
            obj.set_taborder("139");
            obj.set_text("청구일자");
            obj.set_cssclass("styFormSearchCap");
            this.addChild(obj.name, obj);

            obj = new Calendar("calDEND_DATE", "absolute", null, "113", "100", "21", "243", null, this);
            this.addChild(obj.name, obj);
