CREATE OR REPLACE FUNCTION UWZ.SF_GET_BUDG_APPR_AMNT
...
/******************************************************************************
   NAME    :  SF_GET_BUDG_APPR_AMNT
   PURPOSE :  예산에 대한 전표내역 사용 예산합계(승인 자료만)
   REVISIONS:
